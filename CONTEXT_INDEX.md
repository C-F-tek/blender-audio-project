...
- Code/text+code deltas require real brokered file-read evidence: `runtime_file_refs` proves paths only; GPU1 must consume a successful native `runtime_file_window` result before emitting a grounded diff.
