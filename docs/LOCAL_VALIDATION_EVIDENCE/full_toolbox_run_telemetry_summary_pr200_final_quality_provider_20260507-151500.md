...
- `tool-catalog-complete` passed=`True` event_count=`2` heap_event_count=`43`

## Line-count CSV

- Seen: `True`
- Path: `docs/LOCAL_VALIDATION_EVIDENCE/python_line_count_20260507-151414.csv`
- Total lines: `120795`
...
- `total_build_report_seconds`: `28.078`
- `markdown_scan_seconds`: `20.81`
- `file_discovery_seconds`: `6.536`
- `python_inventory_seconds`: `0.367`
- `path_index_seconds`: `0.334`
