...
- Broker runtime tool executions: `14`
...
- Usage observed: `{'count': 4, 'executed': 4, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.175}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Allowed args: `['input']`
- Usage observed: `{'count': 2, 'executed': 2, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 2.03}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Usage observed: `{'count': 2, 'executed': 2, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.893}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Usage observed: `{'count': 2, 'executed': 2, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 1.608}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Allowed args: `[]`
- Usage observed: `{'count': 6, 'executed': 6, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 3.91}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Usage observed: `{'count': 8, 'executed': 8, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.385}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Allowed args: `[]`
- Usage observed: `{'count': 2, 'executed': 2, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.092}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_usage_telemetry_pr200_final_quality_provider_20260507-151500.json` role=`observed_runtime_tool_usage_report` exists=`True` sha256=`b99281a0254a63dd9b71bf25bf58f1ba1f3c971585154a60ea5ed443a2181098`
