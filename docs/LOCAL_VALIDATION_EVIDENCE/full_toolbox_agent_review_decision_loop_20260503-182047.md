...
### `output/patch_specs/full_toolbox_20260503-182047_agent_review_patch_plan.json`
...
- `output/patch_specs/full_toolbox_20260503-182047_agent_review_patch_plan.json` exists=`True` size=`415269` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/repository_change_proposals.json` exists=`True` size=`7325` suffix=`.json` preview_chars=`1500`
...
| `high` | `md_mentions_missing_python_path` | `.aider.chat.his
```

### `output/validation/repository_consistency_map_smoke_full_toolbox_20260503-182047.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `382`
- SHA-256: `cf4ceecc0c6dd88d6dabcd391f1c9de222fe24d903de4c5b01f15276dd66d35e`
- Content included: `True`
- Content truncated: `False`
...
- Workers requested: `12`
- Elapsed seconds: `0.014`
- Finding count: `1680`
- Markdown reference count: `35607`
- Markdown Python command count: `1260`
- Provider execution performed: `False`
- Patch application performed: `False`
...
### `output/validation/python_line_count_all_python_files_20260503-182047.md`

- Role: `explicit_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `18052`
- SHA-256: `fbf75d5dd6d79689dd3574b8b523266c8f0097e53a2264be068495ffd45e86df`
- Content included: `True`
- Content truncated: `True`
...
- CSV: docs/LOCAL_VALIDATION_EVIDENCE/python_line_count_20260503-182313.csv
- File count: 315
- Total Python lines: 92025
...
| 610 | `Tools/ai/build_agent_review_patch_plan.py` |
...
### `output/patch_specs/full_toolbox_20260503-182047_agent_review_patch_plan.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `17550`
- SHA-256: `f7fdd107252a4fe9c94ea3c0c5d2184c666ac5ff477a13005ebc5efedbb3a58e`
- Content included: `True`
- Content truncated: `True`
...
- `orchestrator`: `output/ai_pipeline/full_toolbox_20260503-182047_bridge_orchestrator.json`
- `evidence`: `output/ai_pipeline/agent_review_evidence_sufficiency.json`
- `gpu_report`: `output/ai_pipeline/full_toolbox_20260503-182047_deterministic_recommendations.json`
...
- Target files: `['docs/LOCAL_AI_TASKS/full-toolbox-0-to-10-semi-automatic-procedure.md']`
- Rationale: Repository consistency mapper reported high `md_mentions_missing_powershell_path` at `docs/LOCAL_AI_TASKS/full-toolbox-0-to-10-semi-automatic-procedure.md:775` targeting `validate_after_patch.ps1`.
- Strategy: Build a focused patch plan for `md_mentions_missing_powershell_path` using 
```
  ...
  "npu_audits": [
    ...
    },
    {
      ...
      "command": [
        ...
        "--npu-notes-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-182047_checkpoints\\round_012_npu_async_audit_npu_notes.md",
        "--npu-metadata-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-182047_checkpoints\\round_012_npu_async_audit_metadata.json",
        "--timeout-seconds",
        "420",
        "--max-context-chars",
        "2000",
      ...
      "npu_lane_mode_at_launch": "slow",
      "npu_effective_auditor_every_rounds_at_launch": 4,
      "finished_at": "2026-05-03T18:31:29",
      "returncode": 0,
      "stdout_tail": "{\n  \"passed\": true,\n  \"output\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_pipeline\\\\full_toolbox_20260503-182047_checkpoints\\\\round_012_npu_async_audit.json\",\n  \"markdown\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_pipeline\\\\full_toolbox_20260503-182047_checkpoints\\\\round_012_npu_async_audit.md\",\n  \"npu_python\": \"C:\\\\Users\\\\carmi\\\\blender\\\\venvs\\\\blender-npu-ai\\\\Scripts\\\\python.exe\",\n  \"npu_python_exists\": true,\n  \"provider_execution_requested\": true,\n  \"provider_load_attempted\": true,\n  \"provider_execution_succeeded\": true,\n  \"provider_empty_response\": false,\n  \"dependency_missing\": false,\n  \"patch_application_performed\": false,\n  \"non_blocking\": true,\n  \"classification\": \"usable_audit_text\",\n  \"runtime_tool_context_seen\": false,\n  \"runtime_tool_context_report_count\": 0,\n  \"tool_request_count\": 0,\n  \"valid_tool_request_count\": 0,\n  \"invalid_tool_request_count\": 0,\n  \"npu_deterministic_tool_fallback_used\": false,\n  \"npu_deterministic_tool_fallback_count\": 0,\n  \"gpu_review_blocked\": false\n}\n",
      "stderr_tail": "",
      "classification": "usable_audit_text",
      "provider_execution_requested": true,
      "
  ...
  "npu_audits": [
    ...
    },
    {
      ...
      "command": [
        ...
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-182047_checkpoints\\round_008_npu_async_audit.json",
        "--markdown-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-18
```
      ...
      "tool_requests": [
        {
          "id": "fallback_python_syntax",
          "tool": "check_python_syntax",
          "reason": "Deterministic fallback after provider emitted no valid tool_requests:
```
...
- Suffix: `.md`
- Size bytes: `1648`
- SHA-256: `aa2aa86c5aa7881324f68813e5f347f517dc6431cfcefa90f7b6c0582dc25803`
- Content included: `True`
- Content truncated: `False`
...
- Generated at: `2026-05-03T18:46:14`
- Profile: `core`
- Apply mode: `manual_review_only`
- Proposal count: `1`
