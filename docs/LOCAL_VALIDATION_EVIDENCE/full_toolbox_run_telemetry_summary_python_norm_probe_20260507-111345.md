...
- Seen: `True`
- Path: `docs/LOCAL_VALIDATION_EVIDENCE/python_line_count_20260507-111411.csv`
- Total lines: `118775`
...
- `total_build_report_seconds`: `83.057`
- `markdown_scan_seconds`: `57.804`
- `file_discovery_seconds`: `10.935`
- `python_inventory_seconds`: `7.891`
- `path_index_seconds`: `6.393`
