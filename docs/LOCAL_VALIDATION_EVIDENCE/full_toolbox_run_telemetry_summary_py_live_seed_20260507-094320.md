...
- `gpu1-request` passed=`True` event_count=`1` heap_event_count=`24`
- `broker-results` passed=`True` event_count=`3` heap_event_count=`31`
- `npu-support` passed=`True` event_count=`1` heap_event_count=`32`

## Line-count CSV

- Seen: `True`
- Path: `docs/LOCAL_VALIDATION_EVIDENCE/python_line_count_20260507-093407.csv`
- Total lines: `118322`
...
- `total_build_report_seconds`: `80.562`
- `markdown_scan_seconds`: `58.892`
- `file_discovery_seconds`: `9.974`
- `python_inventory_seconds`: `6.164`
- `path_index_seconds`: `5.495`
- `findings_build_seconds`: `0.037`
...
- `consistency_052` `md_powershell` `medium` -> `['AI_PATCH_BUNDLE_TECHNICAL_GOTCHAS.md']`
- `consistency_053` `md_powershell` `medium` -> `['AI_PATCH_BUNDLE_TECHNICAL_GOTCHAS.md']`
- `consistency_054` `md_powershell` `medium` -> `['CHATGPT/chatgpt-session-problems-and-robust-fixes-2026-05-04.md']`
- `consistency_055` `md_powershell` `medium` -> `['docs/AUTO_PUSH_GENERATED_ARTIFACTS.md']`
- `consistency_056` `md_powershell` `medium` -> `['docs/LOCAL_AI_TASKS/current-operational-state-2026-05-05.md']`
- `consistency_057` `md_powershell` `medium` -> `['docs/LOCAL_AI_TASKS/current-operational-state-2026-05-05.md']`
- `consistency_058` `md_powershell` `medium` -> `['docs/LOCAL_AI_TASKS/full-run-tutto-su-tutto/01-startup-params-quality-supervisor.md']`
...
- `consistency_052` `md_powershell` review=`True` -> `['AI_PATCH_BUNDLE_TECHNICAL_GOTCHAS.md']`
- `consistency_053` `md_powershell` review=`True` -> `['AI_PATCH_BUNDLE_TECHNICAL_GOTCHAS.md']`
- `consistency_054` `md_powershell` review=`True` -> `['CHATGPT/chatgpt-session-problems-and-robust-fixes-2026-05-04.md']`
- `consistency_055` `md_powershell` review=`True` -> `['docs/AUTO_PUSH_GENERATED_ARTIFACTS.md']`
- `consistency_056` `md_powershell` review=`True` -> `['docs/LOCAL_AI_TASKS/current-operational-state-2026-05-05.md']`
- `consistency_057` `md_powershell` review=`True` -> `['docs/LOCAL_AI_TASKS/current-operational-state-2026-05-05.md']`
- `consistency_058` `md_powershell` review=`True` -> `['docs/LOCAL_AI_TASKS/full-run-tutto-su-tutto/01-startup-params-quality-supervisor.md']`
