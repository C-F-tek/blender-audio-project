...
- Generated at: `2026-05-07T10:49:58`
...
- `output/ai_pipeline/full_memory_tool_regeneration_md_loop_effective_20260507-104917_agent_memory_inventory.json` exists=`True` size=`13528` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_md_loop_effective_20260507-104917_agnostic_tool_inventory.json` exists=`True` size=`906552` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_persistent_memory_status.json` exists=`True` size=`1779` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_operational_memory_status.json` exists=`True` size=`1705` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_memory_routing_policy.json` exists=`True` size=`8943` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_runtime_tool_broker.json` exists=`True` size=`97588` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_md_loop_effective_20260507-104917_transient_request_context.json` exists=`True` size=`9294` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_python_line_count.json` exists=`True` size=`3210` suffix=`.json` preview_chars=`1500`
- `output/analysis/full_memory_tool_regeneration_md_loop_effective_20260507-104917_code_interpreter.json` exists=`True` size=`1914109` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_python_syntax.json` exists=`True` size=`76897` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_validation_report_contract.json` exists=`True` size=`3597` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_workflow.json` exists=`True` size=`5211` suffix=`.json` preview_chars=`1500`
...
- Suffix: `.md`
- Size bytes: `1298`
- SHA-256: `5656bf69f8a7a16f6423ebc74a6dee4ecab822234559d78358610d5c637347ca`
- Content included: `True`
- Content truncated: `False`
...
```json
{
  "record_count": 120,
  "kind_counts": {
    "operational_context": 120
  },
  "role_counts": {
    "runtime_planner_note": 90,
    "doctor_tool": 30
  }
}
```
...
- Suffix: `.md`
- Size bytes: `3687`
- SHA-256: `36944b545a5fba038fbb602338a90055f99e87c3950d5e4bf54c6476e43e2325`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- profile: `full_refactor`
- broker_request_written: `output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917_tool_requests.json`
- provider_execution_performed: `False`
- patch_application_performed: `False`
- sqlite_write_performed: `False`
- persistent_memory_write_performed: `False`
...
- Suffix: `.md`
- Size bytes: `9144`
- SHA-256: `8254a8b8e6bcc7639548152746a1b1080dcab33a995df8d845229f87b21ae4b2`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- dry_run: `False`
- request_file: `output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917_tool_requests.json`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/persistent_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/persistent_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/persistent_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/persistent_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/persistent_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/persistent_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_remember_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_remember_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_remember_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/operational_memory_remember_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/agent_memory_inventory_agent_memory_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/agent_memory_inventory_agent_memory_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/agnostic_tool_inventory_agent_agnostic_tool_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/agnostic_tool_inventory_agent_agnostic_tool_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/transient_request_context_agent_transient_request_context.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/transient_request_context_agent_transient_request_context.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/python_line_count_inventory_python_line_count.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/python_line_count_inventory_python_line_count.md', 'csv_output': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/python_line_count_inventory_python_line_count.csv'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/code_interpreter_report_code_interpreter_report.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/code_interpreter_report_code_interpreter_report.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/refactor_duplication_audit_refactor_duplication_audit.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/refactor_duplication_audit_refactor_duplication_audit.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/python_syntax_check_python_syntax.json'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/gpu_contract_smoke_gpu_planner_json_contract_smoke.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/gpu_contract_smoke_gpu_planner_json_contract_smoke.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_md_loop_effective_20260507-104917/validation_report_contract_validation_report_contract.json'}`
...
- Suffix: `.md`
- Size bytes: `1862`
- SHA-256: `10a67063aeed6cc4f07284648b966194bcaf0011318f348379f81d191367a29f`
- Content included: `True`
- Content truncated: `False`
...
- `output/ai_pipeline/full_memory_tool_regeneration_md_loop_effective_20260507-104917_agent_memory_inventory.json` kind=`agent_memory_inventory` passed=`True` error=``
- `output/ai_pipeline/full_memory_tool_regeneration_md_loop_effective_20260507-104917_agnostic_tool_inventory.json` kind=`agent_agnostic_tool_inventory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_persistent_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_operational_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_memory_routing_policy.json` kind=`agent_memory_routing_policy` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_md_loop_effective_20260507-104917_runtime_tool_broker.json` kind=`agent_runtime_tool_broker` passed=`True` error=``
...
- Suffix: `.md`
- Size bytes: `1810`
- SHA-256: `3c6e538acaef6d75d4c71f6a5b77d9d3a800e7db7d28acbb43871d167a3eed1a`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- CSV: `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_md_loop_effective_20260507-104917.csv`
- File count: `638`
- Total lines: `118629`
- Provider execution performed: `False`
- Patch application performed: `False`
...
- Suffix: `.sqlite`
- Size bytes: `565248`
- SHA-256: `5578d955eababe59fa674f58187f4bb0f3cc69dd33b8eb8f80c7ac5c64669ce2`
