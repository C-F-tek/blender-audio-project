...
- Generated at: `2026-05-07T11:16:44`
...
### `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_usage_telemetry_python_norm_probe_20260507-111345.json`
...
### `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_capability_manifest_python_norm_probe_20260507-111345.json`
...
### `output/analysis/shared_toolbox_ai_to_ai_final_summary_python_norm_probe_20260507-111345.json`
...
- Peer mesh product blockers: `[]`
- Errors: `['ollama: probe failed']`
- Warnings: `['patch_plan: max_patch_plans is accepted for compatibility/telemetry but does not truncate patch plans; patch_plan_count may be lower than available_patch_plan_count only through guardrail rejection', 'max_patch_plans is accepted for compatibility/telemetry but does not truncate patch plans; patch_plan_count may be lower than available_patch_plan_count only through guardrail rejection', 'round 2: invalid tool requests: ["tool_requests[0].tool not allowlisted: \'build_agent_review_patch_plan.py\'"]', 'npu: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'npu: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'npu: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'npu: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder', 'ollama: known workload report not selected: known_workload_report_missing_from_selected_output_folder']`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/accelerator_control/full0to10_accelerator_control.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/accelerator_control/full0to10_accelerator_telemetry.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/effective_use/full0to10_effective_use_optimization.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/effective_use/full0to10_effective_use_summary.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/effective_use/full0to10_effective_use_tool_telemetry.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/effective_use/full0to10_provider_hardening_contracts.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_command_plan.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_execution_bridge.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_execution_bridge_telemetry.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_real_run_gate.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_workload_output_paths.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/full0to10_provider_dry_run_steps.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/full0to10_provider_expected_telemetry_contract.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/full0to10_provider_invocation_plan.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/full0to10_provider_workload_report_contract.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/accelerator_control/full0to10_accelerator_control.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/accelerator_control/full0to10_accelerator_telemetry.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/full0to10_provider_governor.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/full0to10_provider_governor_telemetry.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/full0to10_provider_run_permit.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/accelerator_control/full0to10_accelerator_control.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/accelerator_control/full0to10_accelerator_telemetry.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/full0to10_provider_governor.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/full0to10_provider_governor_telemetry.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/full0to10_provider_run_permit.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/full0to10_provider_dry_run_steps.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/full0to10_provider_expected_telemetry_contract.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/full0to10_provider_invocation_plan.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/full0to10_provider_workload_report_contract.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/accelerator_control/full0to10_accelerator_control.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/accelerator_control/full0to10_accelerator_telemetry.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/full0to10_provider_governor.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/full0to10_provider_governor_telemetry.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/full0to10_provider_run_permit.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/quality_gate/full0to10_quality_gate.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/track_inputs/full0to10_track_input_contract.json`
...
### `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/track_inputs/full0to10_track_input_template.json`
...
### `output/validation/gpu0_companion_tool_requests_python_norm_probe_20260507-111345.json`
...
### `output/validation/gpu0_companion_worker_workload_python_norm_probe_20260507-111345.json`
...
### `output/validation/runtime_tool_bootstrap_requests_python_norm_probe_20260507-111345.json`
...
### `output/validation/runtime_tool_broker_full_toolbox_python_norm_probe_20260507-111345.json`
...
### `output/ai_pipeline/gpu0_peer_support_parallel_python_norm_probe_20260507-111345/round_001_gpu0_peer_support.json`
...
### `output/ai_pipeline/gpu0_peer_support_parallel_python_norm_probe_20260507-111345/round_002_gpu0_peer_support.json`
...
- `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_usage_telemetry_python_norm_probe_20260507-111345.json` exists=`True` size=`19135` suffix=`.json` preview_chars=`1500`
- `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_capability_manifest_python_norm_probe_20260507-111345.json` exists=`True` size=`15892` suffix=`.json` preview_chars=`1500`
...
- `output/analysis/shared_toolbox_ai_to_ai_final_summary_python_norm_probe_20260507-111345.json` exists=`True` size=`1555827` suffix=`.json` preview_chars=`1500`
...
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/accelerator_control/full0to10_accelerator_control.json` exists=`True` size=`11413` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/accelerator_control/full0to10_accelerator_telemetry.json` exists=`True` size=`686` suffix=`.json` preview_chars=`657`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/effective_use/full0to10_effective_use_optimization.json` exists=`True` size=`1196` suffix=`.json` preview_chars=`1168`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/effective_use/full0to10_effective_use_summary.json` exists=`True` size=`18286` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/effective_use/full0to10_effective_use_tool_telemetry.json` exists=`True` size=`1379` suffix=`.json` preview_chars=`1324`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/effective_use/full0to10_provider_hardening_contracts.json` exists=`True` size=`7541` suffix=`.json` preview_chars=`1500`
...
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_command_plan.json` exists=`True` size=`1504` suffix=`.json` preview_chars=`1455`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_execution_bridge.json` exists=`True` size=`44991` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_execution_bridge_telemetry.json` exists=`True` size=`1216` suffix=`.json` preview_chars=`1171`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_real_run_gate.json` exists=`True` size=`2029` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/full0to10_provider_workload_output_paths.json` exists=`True` size=`1691` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/full0to10_provider_dry_run_steps.json` exists=`True` size=`1736` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/full0to10_provider_expected_telemetry_contract.json` exists=`True` size=`1085` suffix=`.json` preview_chars=`1043`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/full0to10_provider_invocation_plan.json` exists=`True` size=`34008` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/full0to10_provider_workload_report_contract.json` exists=`True` size=`1198` suffix=`.json` preview_chars=`1162`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/accelerator_control/full0to10_accelerator_control.json` exists=`True` size=`11413` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/accelerator_control/full0to10_accelerator_telemetry.json` exists=`True` size=`686` suffix=`.json` preview_chars=`657`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/full0to10_provider_governor.json` exists=`True` size=`25287` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/full0to10_provider_governor_telemetry.json` exists=`True` size=`1441` suffix=`.json` preview_chars=`1384`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_execution_bridge/provider_invocation_plan/provider_governor/full0to10_provider_run_permit.json` exists=`True` size=`2841` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/accelerator_control/full0to10_accelerator_control.json` exists=`True` size=`11413` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/accelerator_control/full0to10_accelerator_telemetry.json` exists=`True` size=`686` suffix=`.json` preview_chars=`657`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/full0to10_provider_governor.json` exists=`True` size=`25134` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/full0to10_provider_governor_telemetry.json` exists=`True` size=`1441` suffix=`.json` preview_chars=`1384`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_governor/full0to10_provider_run_permit.json` exists=`True` size=`2841` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/full0to10_provider_dry_run_steps.json` exists=`True` size=`1736` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/full0to10_provider_expected_telemetry_contract.json` exists=`True` size=`1085` suffix=`.json` preview_chars=`1043`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/full0to10_provider_invocation_plan.json` exists=`True` size=`33826` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/full0to10_provider_workload_report_contract.json` exists=`True` size=`1198` suffix=`.json` preview_chars=`1162`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/accelerator_control/full0to10_accelerator_control.json` exists=`True` size=`11413` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/accelerator_control/full0to10_accelerator_telemetry.json` exists=`True` size=`686` suffix=`.json` preview_chars=`657`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/full0to10_provider_governor.json` exists=`True` size=`25209` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/full0to10_provider_governor_telemetry.json` exists=`True` size=`1441` suffix=`.json` preview_chars=`1384`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/provider_invocation_plan/provider_governor/full0to10_provider_run_permit.json` exists=`True` size=`2841` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/quality_gate/full0to10_quality_gate.json` exists=`True` size=`3621` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/track_inputs/full0to10_track_input_contract.json` exists=`True` size=`7275` suffix=`.json` preview_chars=`1500`
- `output/validation/full0to10_final_tool_product_python_norm_probe_20260507-111345/track_inputs/full0to10_track_input_template.json` exists=`True` size=`1056` suffix=`.json` preview_chars=`1024`
- `output/validation/full_memory_tool_regeneration_python_norm_probe_20260507-111345_memory_routing_policy.json` exists=`True` size=`8943` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_python_norm_probe_20260507-111345_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_python_norm_probe_20260507-111345_operational_memory_status.json` exists=`True` size=`1705` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_python_norm_probe_20260507-111345_persistent_memory_status.json` exists=`True` size=`1781` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_python_norm_probe_20260507-111345_python_line_count.json` exists=`True` size=`3210` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_python_norm_probe_20260507-111345_python_syntax.json` exists=`True` size=`76897` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_python_norm_probe_20260507-111345_runtime_tool_broker.json` exists=`True` size=`98456` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_python_norm_probe_20260507-111345_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_python_norm_probe_20260507-111345_validation_report_contract.json` exists=`True` size=`3597` suffix=`.json` preview_chars=`1500`
...
- `output/validation/gpu0_companion_tool_requests_python_norm_probe_20260507-111345.json` exists=`True` size=`1562` suffix=`.json` preview_chars=`1500`
- `output/validation/gpu0_companion_worker_workload_python_norm_probe_20260507-111345.json` exists=`True` size=`1721` suffix=`.json` preview_chars=`1500`
...
- `output/validation/runtime_tool_bootstrap_requests_python_norm_probe_20260507-111345.json` exists=`True` size=`1268` suffix=`.json` preview_chars=`1234`
- `output/validation/runtime_tool_broker_full_toolbox_python_norm_probe_20260507-111345.json` exists=`True` size=`27395` suffix=`.json` preview_chars=`1500`
- `output/analysis/full_memory_tool_regeneration_python_norm_probe_20260507-111345_code_interpreter.json` exists=`True` size=`1915407` suffix=`.json` preview_chars=`1500`
...
- `output/ai_pipeline/full_memory_tool_regeneration_python_norm_probe_20260507-111345_agent_memory_inventory.json` exists=`True` size=`13556` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_python_norm_probe_20260507-111345_agnostic_tool_inventory.json` exists=`True` size=`907276` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_python_norm_probe_20260507-111345_transient_request_context.json` exists=`True` size=`9294` suffix=`.json` preview_chars=`1500`
...
- `output/ai_pipeline/gpu0_peer_support_parallel_python_norm_probe_20260507-111345/round_001_gpu0_peer_support.json` exists=`True` size=`1732` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/gpu0_peer_support_parallel_python_norm_probe_20260507-111345/round_002_gpu0_peer_support.json` exists=`True` size=`1733` suffix=`.json` preview_chars=`1500`
...
- Target files: `['CHATGPT/chatgpt-session-problems-and-robust-fixes-2026-05-04.md']`
- Rationale: Repository consistency mapper reported high `md_mentions_missing_powershell_path` at `CHATGPT/chatgpt-session-problems-and-robust-fixes-2026-05-04.md:29` targeting `run_patch_bundle.ps1`.
- Strategy: Build a focused patch plan for `md_mentions_missing_powershell_path` using mapper evidence `CHATGPT/chatgpt-session-problems-and-robust-fixes-2026-05-04.md:29`. Target `CHATGPT/chatgpt-session-problems-and-robust-fixes-2026-05-04.md` and resolve `run_patch_bundle.ps1` without formatting-only e
```
...
### `output/validation/python_line_count_full_toolbox_python_norm_probe_20260507-111345.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1762`
- SHA-256: `c65ddf982927e93d1d482b839a052f12ccc3dad65a0a8e4936bb8274b2dc438a`
- Content included: `True`
- Content truncated: `False`
...
### `output/validation/gpu_planner_json_contract_smoke_full_toolbox_python_norm_probe_20260507-111345.md`
...
### `output/validation/npu_provider_environment_full_toolbox_python_norm_probe_20260507-111345.md`
...
### `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_usage_telemetry_python_norm_probe_20260507-111345.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `2578`
- SHA-256: `5ac6458a7cb49378e81664079ac75428b56c45ddc52072b7e582097cf7f8e251`
- Content included: `True`
- Content truncated: `False`
...
### `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_capability_manifest_python_norm_probe_20260507-111345.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `7671`
- SHA-256: `9afd2c2dc8c654b5552d76342b7be250b247e2810a14b6f4a590f36f0a404fce`
- Content included: `True`
- Content truncated: `False`
...
- `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_usage_telemetry_python_norm_probe_20260507-111345.json` role=`observed_runtime_tool_usage_report` exists=`True` sha256=`f4a6f4a755c637e3b712e98b5bbd755590b3fefa573069a0e0843f4cebba5781`
...
### `output/analysis/shared_toolbox_ai_to_ai_final_summary_python_norm_probe_20260507-111345.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `497497`
- SHA-256: `d922f43ecf1a9d53654525d80698c058127b5cbbc52726766d1b9af7f8469e5e`
- Content included: `True`
- Content truncated: `True`
...
- `output/ai_pipeline/full_toolbox_python_norm_probe_20260507-111345_orchestrator.json` kind=`agent_gpu_npu_parallel_orchestrator` passed=`True` source=`None` source_classification=`None` provider_execution_performed=`True` collaboration_visibility=`None` peer_mesh=`False` npu_support=`False` errors=`[]`
...
- `output/validation/gpu1_primary_advisory_python_norm_probe_20260507-111345.json` kind=`gpu1_primary_advisory` passed=`True` source=`None` source_classification=`None` provider_execution_performed=`True` collaboration_visibility=`None` peer_mesh=`False` npu_support=`False` errors=`[]`
- `output/validation/gpu0_peer_response_python_norm_probe_20260507-111345.json` kind=`gpu0_peer_response` passed=`True` source=`None` source_classification=`None` provider_execution_performed=`True` collaboration_visibility=`None` peer_mesh=`False` npu_support=`False` errors=`[]`
- `output/validation/gpu0_peer_runtime_tool_broker_python_norm_probe_20260507-111345.json` kind=`agent_runtime_tool_broker` passed=`True` source=`gpu0_peer_companion` source_classification=`gpu0_peer_companion` provider_execution_performed=`False` collaboration_visibility=`None` peer_mesh=`False` npu_support=`False` errors=`[]`
- `output/validation/npu_micro_runtime_tool_broker_python_norm_probe_20260507-111345.json` kind=`agent_runtime_tool_broker` passed=`True` source=`None` source_classification=`None` provider_execution_performed=`False` collaboration_visibility=`None` peer_mesh=`False` npu_support=`False` errors=`[]`
- `output/validation/ai_peer_exchange_python_norm_probe_20260507-111345.json` kind=`ai_peer_exchange` passed=`True` source=`None` source_classification=`None` provider_execution_performed=`True` collaboration_visibility=`True` peer_mesh=`True` npu_support=`True` errors=`[]`
- `output/validation/ai_peer_exchange_contract_python_norm_probe_20260507-111345.json` kind=`ai_peer_exchange_contract` passed=`True` source=`None` source_classification=`None` provider_execution_performed=`True` collaboration_visibility=`None` peer_mesh=`False` npu_support=`False` errors=`[]`
- `output/validation/provider_runtime_heap_live_signals_init_python_norm_probe_20260507-111345.json` kind=`provider_runtime_heap_live_signals` passed=`True` source=`None` source_classification=`None` provider_execution_performed=`None` collaboration_visibility=`None` peer_mesh=`False` npu_support=`False` errors=`[]`
- `output/validation/provider_runtime_heap_live_signals_gpu1_request_python_norm_probe_20260507-111345.json` kind=`provider_runtime_heap_live_signals` passed=`True` source=`None` source_classification=`None` provider_execution_performed=`None` collaboration_visibility=`None` peer_mesh=`False` npu_support=`False` errors=`[]`
- `output/validation/provider_runtime_heap_live_signals_broker_results_python_norm_probe_20260507-111345.json` kind=`provider_runtime_heap_live_signals` passed=`True` source=`None` source_classification=`None` provider_execution_performed=`None` collaboration_visibility=`None` peer_mesh=`False` npu_support=`False` errors=`[]`

## Patch plan summary

- Seen: `True`
- Source: `output/patch_specs/full_toolbox_python_norm_probe_20260507-111345_agent_review_patch_plan.json`
- Patch plan count: `20`
...
- output/ai_pipeline/full_toolbox_python_norm_probe_20260507-111345_agent_review_decision_loop.json exists=True json_ok=True kind=agent_review_decision_loop passed=True
- output/patch_specs/full_toolbox_python_norm_probe_20260507-111345_agent_review_patch_plan.json exists=True json_ok=True kind=agent_review_patch_plan passed=True
- output/ai_pipeline/full_toolbox_python_norm_probe_20260507-111345_deterministic_recommendations.json exists=True json_ok=True kind=deterministic_recommendation_synthesizer passed=True
- output/ai_pipeline/full_toolbox_python_norm_probe_20260507-111345_bridge_orchestrator.json exists=True json_ok=True kind=deterministic_recommendation_patch_plan_bridge_orchestrator passed=True
- output/ai_pipeline/full_toolbox_python_norm_probe_20260507-111345_orchestrator.json exists=True json_ok=True kind=agent_gpu_npu_parallel_orchestrator passed=True
- output/ai_pipeline/full_toolbox_python_norm_probe_20260507-111345_parallel_gpu.json exists=True json_ok=True kind=agent_gpu_deep_planning_supervised passed=True
...
- output/analysis/repository_consistency_map_full_toolbox_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=repository_consistency_map passed=True
- output/validation/repository_consistency_map_smoke_full_toolbox_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=repository_consistency_map_smoke passed=True
- output/analysis/code_interpreter_full_toolbox_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=code_interpreter_report passed=True
- output/validation/python_line_count_full_toolbox_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=python_line_count_csv passed=True
- output/validation/python_syntax_full_toolbox_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=python_syntax passed=True
- output/validation/gpu_planner_json_contract_smoke_full_toolbox_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=gpu_planner_json_contract_smoke passed=True
- output/validation/deterministic_recommendation_synthesizer_smoke_full_toolbox_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=deterministic_recommendation_synthesizer_smoke passed=True
- output/validation/agent_review_decision_loop_smoke_full_toolbox_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=agent_review_decision_loop_smoke passed=True
- output/validation/npu_provider_environment_full_toolbox_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=npu_provider_environment passed=True
- output/validation/gpu1_primary_advisory_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=gpu1_primary_advisory passed=True
- output/validation/gpu0_peer_task_packet_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=gpu0_peer_task_packet passed=True
- output/validation/gpu0_peer_response_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=gpu0_peer_response passed=True
- output/validation/gpu0_tool_requests_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=gpu0_peer_tool_requests passed=None
- output/validation/gpu0_peer_runtime_tool_broker_python_norm_probe_20260507-111345.json exists=True json_ok=True kind=agent_runtime_tool_broker passed=True
- output/validation/npu_micro_peer_assistant_pyt
```
...
- Suffix: `.json`
- Size bytes: `2097751`
- SHA-256: `dfcc3b8c7988be231c0f41df049274653fa22f92259a0b80c52ee744880f05ae`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "code_interpreter_report",
  "generated_at": "2026-05-07T11:14:15",
...
- Suffix: `.json`
- Size bytes: `1915407`
- SHA-256: `a27770f91e7b2204ce699ecc46082f17762d1add8e327df1a52886f2bb87906f`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "code_interpreter_report",
  "generated_at": "2026-05-07T11:13:59",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
...
- Suffix: `.md`
- Size bytes: `7350`
- SHA-256: `3e0ceb8e2e34bd55dd3f9ca885fbd9f557b613381c996a890f57617959f2077e`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.json`
- Size bytes: `3941`
- SHA-256: `8f7e2591d55fef3af320605fe15f841ea902f8301dfcd99e94ca7d8bb165a10b`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  ...
  "manual_review_required": true,
  "inputs": {
    "gpu_report": "output/ai_pipeline/full_toolbox_python_norm_probe_20260507-111345_parallel_gpu.json"
  },
  "source_summary": {
    "kind": "agent_gpu_deep_planning_supervised",
    "passed": true,
  ...
  "valid_recommendation_output_count": 1,
  "rounds": [
    {
      "round": 1,
