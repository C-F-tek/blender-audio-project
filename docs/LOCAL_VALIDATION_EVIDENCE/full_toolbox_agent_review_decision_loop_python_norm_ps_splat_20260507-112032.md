...
- Generated at: `2026-05-07T11:23:28`
...
### `output/validation/openvino_hardware_governance_full_toolbox_python_norm_ps_splat_20260507-112032.md`
...
### `output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/full0to10_final_tool_product.md`

- Role: `explicit_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `6623`
- SHA-256: `7264ab25f09f164e24184a564e3ea09f4fb403475037181f3956cc2c244621c8`
- Content included: `True`
- Content truncated: `False`
...
Build the final local AI product for stamp python_norm_ps_splat_20260507-112032 from the live provider mesh, runtime broker evidence, telemetry, patch specs and validation bundle.
...
- `effective_use_summary` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/effective_use/full0to10_effective_use_summary.json`
- `quality_product` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/effective_use/full0to10_effective_use_quality_product.md`
- `provider_hardening` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/effective_use/full0to10_provider_hardening_contracts.json`
- `tool_telemetry` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/effective_use/full0to10_effective_use_tool_telemetry.json`
- `optimization` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/effective_use/full0to10_effective_use_optimization.json`
- `quality_gate` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/quality_gate/full0to10_quality_gate.json`
- `accelerator_control` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/accelerator_control/full0to10_accelerator_control.json`
- `provider_governor` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_governor/full0to10_provider_governor.json`
- `provider_run_permit` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_governor/full0to10_provider_run_permit.json`
- `provider_invocation_plan` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_invocation_plan/full0to10_provider_invocation_plan.json`
- `provider_workload_report_contract` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_invocation_plan/full0to10_provider_workload_report_contract.json`
- `provider_expected_telemetry_contract` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_invocation_plan/full0to10_provider_expected_telemetry_contract.json`
- `provider_execution_bridge` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_execution_bridge/full0to10_provider_execution_bridge.json`
- `provider_real_run_gate` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_execution_bridge/full0to10_provider_real_run_gate.json`
- `provider_command_plan` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_execution_bridge/full0to10_provider_command_plan.json`
- `provider_workload_output_paths` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_execution_bridge/full0to10_provider_workload_output_paths.json`
- `track_input_contract` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/track_inputs/full0to10_track_input_contract.json`
- `track_input_template` exists=`True` path=`output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/track_inputs/full0to10_track_input_template.json`
...
- report `output/ai_pipeline/full_toolbox_python_norm_ps_splat_20260507-112032_orchestrator.json` exists=`True`
- report `output/ai_pipeline/full_toolbox_python_norm_ps_splat_20260507-112032_parallel_gpu.json` exists=`True`
- report `output/analysis/gpu_npu_run_sync_full_toolbox_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `output/validation/provider_evidence_contract_full_toolbox_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `output/validation/ai_peer_exchange_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `output/validation/ai_peer_exchange_contract_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `output/validation/provider_runtime_heap_from_peer_reports_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `docs/LOCAL_VALIDATION_EVIDENCE/provider_runtime_heap_telemetry_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `output/ai_runtime_heap/python_norm_ps_splat_20260507-112032/snapshot.json` exists=`True`
- report `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_usage_telemetry_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_capability_manifest_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `output/validation/runtime_tool_broker_full_toolbox_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `output/validation/gpu0_peer_runtime_tool_broker_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `output/validation/npu_micro_runtime_tool_broker_python_norm_ps_splat_20260507-112032.json` exists=`True`
- report `output/ai_pipeline/full_toolbox_python_norm_ps_splat_20260507-112032_deterministic_recommendations.json` exists=`True`
- report `output/ai_pipeline/full_toolbox_python_norm_ps_splat_20260507-112032_agent_review_decision_loop.json` exists=`True`
- report `output/patch_specs/full_toolbox_python_norm_ps_splat_20260507-112032_agent_review_patch_plan.json` exists=`True`
...
### `output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/README.md`

- Role: `explicit_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `609`
- SHA-256: `ad893b9d2b10adb946c3ab2d7045e5505b50d44fea2490d79c1b9c3d57987bd6`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- Product markdown: `output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/full0to10_final_tool_product.md`
- Track input contract: `output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/track_inputs/full0to10_track_input_contract.json`
- Provider execution bridge: `output/validation/full0to10_final_tool_product_python_norm_ps_splat_20260507-112032/provider_execution_bridge/full0to10_provider_execution_bridge.json`
...
- Suffix: `.json`
- Size bytes: `3883`
- SHA-256: `3f230173e147f599bf8877443951fb7e7a27078a7dfc89a7ed9c140a1364c53a`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  ...
  "generated_at": "2026-05-07T11:22:28",
  ...
  "inputs": {
    ...
    "context_reports": [
      {
        "path": "output/analysis/repository_consistency_map_full_toolbox_python_norm_ps_splat_20260507-112032.json",
        "exists": true,
        "kind": "repository_consistency_map",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/repository_consistency_map_smoke_full_toolbox_python_norm_ps_splat_20260507-112032.json",
        "exists": true,
        "kind": "repository_consistency_map_smoke",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/analysis/code_interpreter_full_toolbox_python_norm_ps_splat_20260507-112032.json",
        "exists": true,
        "kind": "code_interpreter_report",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/python_line_count_full_toolbox_python_norm_ps_splat_20260507-112032.json",
        "exists": true,
        "kind": "python_line_count_csv",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/python_syntax_full_toolbox_python_norm_ps_splat_20260507-112032.json",
        "exists": true,
        "kind": "python_syntax",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/openvino_hardware_governance_full_toolbox_python_norm_ps_splat_20260507-112032.json",
        "exists": true,
        "kind": "openvino_hardware_governance_report",
        "passed": true,
        "error": "",
...
- Suffix: `.json`
- Size bytes: `1244`
- SHA-256: `9f615ecb2deb98f4250f1ec22cdd9cdaff6cd038d551a7d4034141716c93f22d`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  "schema_version": 1,
  "kind": "deterministic_recommendation_patch_plan_bridge_orchestrator",
  "generated_at": "2026-05-07T11:23:15",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "patch_application_performed": false,
  "source_writes_performed": false,
  "gpu_output": "output/ai_pipeline/full_toolbox_python_norm_ps_splat_20260507-112032_deterministic_recommendations.json",
...
- Suffix: `.json`
- Size bytes: `3391`
- SHA-256: `ea157385600776b6b85c2469d539845e1802a06a005cc8e0d1f3c99b5f7170a0`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  ...
  "recommendations": [
    {
      ...
      "risk": "low",
      "validation_commands": [
        "grep -E 'patch_plan_count|manual_review_required|provider_execution_performed' docs/AGENT_REVIEW_CODE_PATCH_PLAN/part-002.md"
      ],
      "stop_conditions": [
  ...
  "inputs": {
    ...
    "orchestrator": "C:/Users/carmi/blender/blender-audio-project/output/ai_pipeline/full_toolbox_python_norm_ps_splat_20260507-112032_orchestrator.json",
...
- Suffix: `.json`
- Size bytes: `66980`
- SHA-256: `50e071f3dfba59f9cf6eb5e54153a2fda3d4fdf34be97809d5e860bfc2a5c23b`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  ...
  "orchestrator_runtime_tool_bootstrap": {
    ...
    "command": [
      ...
      ".",
      "--request-file",
      "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_runtime_tools\\python_norm_ps_splat_20260507-112032\\round_000\\round_000_tool_requests.json",
      "--tool-output-dir",
      "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_runtime_tools\\python_norm_ps_splat_20260507-112032\\round_000",
      "--timeout-seconds",
      "300",
      "--output",
      "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_runtime_tools\\python_norm_ps_splat_20260507-112032\\round_000\\round_000_runtime_tool_broker.json",
      "--markdown-output",
      "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_runtime_tools\\python_norm_ps_splat_20260507-112032\\round_000\\round_000_runtime_tool_broker.md"
    ],
    "returncode": 0,
    "stdout_tail": "{\n  \"passed\": true,\n  \"output\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_runtime_tools\\\\python_norm_ps_splat_20260507-112032\\\\round_000\\\\round_000_runtime_tool_broker.json\",\n  \"markdown\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_runtime_tools\\\\python_norm_ps_splat_20260507-112032\\\\round_000\\\\round_000_runtime_tool_broker.md\",\n  \"tool_request_count\": 7,\n  \"tool_execution_count\": 7,\n  \"blocked_tool_count\": 0,\n  \"failed_tool_count\": 0,\n  \"provider_execution_performed\": false,\n  \"patch_application_performed\": false,\n  \"sqlite_write_performed\": false,\n  \"persistent_memory_write_performed\": false,\n  \"persistent_memory_write_count\": 0,\n  \"operational_sqlite_write_performed\": false,\n  \"operational_sqlite_write_count\": 0,\n  \"operational_memory_clear_count\": 0\n}\n",
    "stderr_tail": "",
    "error": "",
    "request_file": "output/ai_runtime_tools/python_norm_ps_splat_20260507-112032/round_000/round_000_tool_requests.json",
    "broker_output": "output/ai_runtime_tools/python_norm_ps_splat_20260507-112032/round_000/round_000_runtime_tool_broker.json",
    "broker_markdown": "output/ai_runtime_tools/python_norm_ps_splat_20260507-112032/round_000/round_000_runtime_tool_broker.md",
    ...
    "tool_results": [
      {
        ...
        "warnings": [],
        "outputs": {
          "json_report": "output/ai_runtime_tools/python_norm_ps_splat_20260507-112032/round_000/orchestrator_bootstrap_tool_inventory_agent_agnostic_tool_inventory.json",
          "markdown_report": "output/ai_runtime_tools/python_norm_ps_splat_20260507-112032/round_000/orchestrator_bootstrap_tool_inventory_agent_agnostic_tool_inventory.md"
        },
        "summary": {
        ...
        "command": [
          ...
          ".",
          "--output",
          "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_runtime_tools\\python_norm_ps_splat_20260507-112032\\round_000\\orchestrator_bootstrap_tool_inventory_agent_agnostic_tool_inventory.json",
          "--markdown-output",
          "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_runtime_tools\\python_norm_ps_splat_20260507-112032\\round_000\\orchestrator_bootstrap_tool_inventory_agent_agnostic_tool_inventory.md"
        ],
        "stdout_tail": "{\n  \"passed\": true,\n  \"output\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_runtime_tools\\\\python_norm_ps_splat_20260507-112032\\\\round_000\\\\orchestrator_bootstrap_tool_inventory_agent_agnostic_tool_inventory.json\",\n  \"markdown\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_runtime_tools\\\\python_norm_ps_splat_20260507-112032\\\\round_000\\\\orchestrator_bootstrap_tool_inventory_agent_agnostic_tool_inventory.md\",\n  \"tool_count\": 598,\n  \"provider_execution_performed\": false,\n  \"patch_application_performed\": false\n}\n",
        "stderr_tail": ""
      },
      {
        ...
        "warnings": [],
        "outputs": {
          "json_report": "output/ai_runtime_tools/python_norm_ps_splat_20260507-112032/round_000/orchestrator_bootstrap_memory_inventory_agent_memory_inventory.json",
          "markdown_report": "output/ai_runtime_tools/python_norm_ps_splat_20260507-112032/round_000/orchestrator_bootstrap_memory_inventory_agent_memory_inventory.md"
        },
        "summary": {
        ...
        "command": [
          ...
          "--output",
          "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_runtime_tools\\python_norm_ps_splat_20260507-112032\\round_000\\orchestrator_bootstrap_memory_inventory_agent_memory_inventory.json",
          "--markdown-output",
          "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_runtime_tools\\python_norm_ps_splat_20260507-112032\\round_000\\orchestrator_bootstrap_memory_inventory_agent_memory_inventory.md"
        ],
        "stdout_tail": "{\n  \"passed\": true,\n  \"output\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_runtime_tools\\\\python_norm_ps_splat_20260507-112032\\\\round_000\\\\orchestrator_bootstrap_memory_inventory_agent_memory_inventory.json\",\n  \"markdown\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_runtime_tools\\\\python_norm_ps_splat_20260507-112032\\\\round_000\\\\orchestrator_bootstrap_memory_inventory_agent_memory_inventory.md\",\n  \"record_count\": 101,\n  \"memory_db_exists\": true,\n  \"provider_execution_performed\": false,\n  \"patch_application_performed\": false\n}\n",
        "stderr_tail": ""
      },
      {
        ...
        "warnings": [],
        "outputs": {
          "json_report": "output/ai_runtime_tools/python_norm_ps_splat_20260507-112032/round_000/orchestrator_bootstrap_persistent_memory_status_runtime_sqlite_memory.json",
          "markdown_report": "output/ai_runtime_tools/python_norm_ps_splat_20260507-112032/round_000/orchestrator_bootstrap_persistent_memory_status_runtime_sqlite_memory.md"
        },
        "summary": {
...
- Suffix: `.json`
- Size bytes: `16425`
- SHA-256: `119980b2b7048a0027ff04001c6796325fd84d6ab73e6d80922b7fc200089a65`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "agent_gpu_deep_planning_supervised",
  "generated_at": "2026-05-07T11:23:00",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "rounds": [
    ...
    },
    {
      ...
      "live_context_refresh_performed": true,
      "response_chars": 1185,
      "raw_response_preview": "{\n  \"summary\": \"The repository contains documentation for AGENT_REVIEW_CODE_PATCH_PLAN, including a README and part-002.md. The smoke validator checks specific expectations related to code patch plans and manual review requirements.\",\n  \"confidence\": \"medium\",\n  \"recommendations\": [\n    {\n      \"id\": \"rec_summarize_evidence_bundle\",\n      \"area\": \"doc_code\",\n      \"status\": \"ready_for_patch_plan\",\n      \"target_files\": [\n        \"docs/AGENT_REVIEW_CODE_PATCH_PLAN/part-002.md\"\n      ],\n      \"rationale\": \"The existing evidence bundle builder should summarize code patch-plan and docs follow-up reports in a compact style.\",\n      \"proposed_strategy\": \"Update the evidence bundle builder to include recommended summary fields for code plans and edit proposals.\",\n      \"risk\": \"low\",\n      \"validation_commands\": [\n        \"grep -E 'patch_plan_count|manual_review_required|provider_execution_performed' docs/AGENT_REVIEW_CODE_PATCH_PLAN/part-002.md\"\n      ],\n      \"stop_conditions\": [\n        \"Ensure all recommended fields are included in the summary.\"\n      ]\n    }\n  ],\n  \"tool_requests\": [],\n  \"missing_evidence\": [],\n  \"next_best_action\": \"build_agent_review_patch_plan.py\"\n}",
      "parsed_response": {
        "summary": "The repository contains documentation for AGENT_REVIEW_CODE_PATCH_PLAN, including a README and part-002.md. The smoke validator checks specific expectations related to code patch plans and manual review requirements.",
        "confidence": "medium",
        "recommendations": [
  ...
  "guardrails": {
    ...
    "runtime_tool_broker_requires_enable_runtime_tool
```
...
- Suffix: `.json`
- Size bytes: `1733`
- SHA-256: `87462ce76cc8d24a4b327edd6c0dd0d3c0d2c254ee85288d562cec45d183a256`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  "schema_version": 2,
  "kind": "openvino_gpu0_secondary_workload",
  "generated_at": "2026-05-07T11:22:36",
  ...
  "openvino_gpu0_sustained_iterations_performed": 8524,
  ...
  "elapsed_seconds": 1.957565,
  "compile_seconds": 0.035109,
  "inference_seconds": 1.000104,
...
### `output/ai_pipeline/gpu0_peer_support_parallel_python_norm_ps_splat_20260507-112032/round_000_gpu0_peer_support.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1010`
- SHA-256: `6d56afff76ac2279c533bf690d69d43c581e5e0674d1d7d18f3a9f690e10d4b6`
- Content included: `True`
- Content truncated: `False`
...
### `output/validation/full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_workflow.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `3502`
- SHA-256: `2cf053c2231ec88eccf78cca389b22564516b1f293a2831ee1ab3e24a4b4878d`
- Content included: `True`
- Content truncated: `False`
...
- `.\output\ai_pipeline\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_agent_memory_inventory.md`
- `.\output\ai_pipeline\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_agnostic_tool_inventory.md`
- `.\output\validation\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_persistent_memory_status.md`
- `.\output\validation\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_operational_memory_status.md`
- `.\output\validation\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_memory_routing_policy.md`
- `.\output\validation\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_runtime_tool_broker.md`
- `.\output\ai_pipeline\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_transient_request_context.md`
- `.\output\validation\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_python_line_count.md`
- `.\docs/LOCAL_VALIDATION_EVIDENCE\full_memory_tool_regeneration_python_line_count_python_norm_ps_splat_20260507-112032.csv`
- `.\output\analysis\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_code_interpreter.md`
- `.\output\validation\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_runtime_tool_broker_smoke.md`
- `.\output\validation\full_memory_tool_regeneration_python_norm_ps_splat_20260507-112032_memory_routing_policy_smoke.md`

```

### `output/validation/gpu0_companion_contract_python_norm_ps_splat_20260507-112032.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `224`
- SHA-256: `0d8a4b3d743ba39d8e72c08ac7c564b057abdd312876d3e9154ab9822effc140`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- Selected report: `C:\Users\carmi\blender\blender-audio-project\output\validation\gpu0_companion_task_lane_python_norm_ps_splat_20260507-112032.json`
- Classifications: `[]`

```

### `output/validation/gpu0_companion_task_lane_python_norm_ps_splat_20260507-112032.md`
