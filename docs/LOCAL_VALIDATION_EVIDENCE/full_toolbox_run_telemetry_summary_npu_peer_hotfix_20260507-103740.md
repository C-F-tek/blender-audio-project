...
- Seen: `True`
- Path: `docs/LOCAL_VALIDATION_EVIDENCE/python_line_count_20260507-103803.csv`
- Total lines: `118629`
...
- `total_build_report_seconds`: `79.393`
- `markdown_scan_seconds`: `56.711`
- `file_discovery_seconds`: `9.983`
- `python_inventory_seconds`: `6.769`
- `path_index_seconds`: `5.903`
