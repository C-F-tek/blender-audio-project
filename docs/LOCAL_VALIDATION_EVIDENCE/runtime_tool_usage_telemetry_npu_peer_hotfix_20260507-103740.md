...
- `npu`: count=`3` executed=`3` failed=`0` elapsed=`0.0`
- `gpu0`: count=`3` executed=`3` failed=`0` elapsed=`0.0`

## By phase

- `npu_micro_runtime_tool_broker`: count=`3` executed=`3` failed=`0` elapsed=`0.0`
...
- `npu` `npu_micro_runtime_tool_broker` round=`1` tool=`check_python_syntax` status=`None` elapsed=`0.0`
- `npu` `npu_micro_runtime_tool_broker` round=`1` tool=`build_python_line_count_csv` status=`None` elapsed=`0.0`
- `npu` `npu_micro_runtime_tool_broker` round=`1` tool=`check_validation_report_contract` status=`None` elapsed=`0.0`
