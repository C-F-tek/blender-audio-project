...
- previous_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-190820_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-190820_recovered_220_chunk_0018.md`
- next_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-190820_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-190820_recovered_220_chunk_0020.md`
- summary_source: `ollama`

## Local chunk summary

**Scopo**: Generare un piano di patch per correggere riferimenti a script Python mancanti nei file Markdown.  
**Segnali principali**: `md_python_command_script_missing` elevato in vari documenti (`docs/LOCAL_AI_TASKS/...`, `docs/LOCAL_RUNS_TESTING_AND_EVIDENCE.md`,
