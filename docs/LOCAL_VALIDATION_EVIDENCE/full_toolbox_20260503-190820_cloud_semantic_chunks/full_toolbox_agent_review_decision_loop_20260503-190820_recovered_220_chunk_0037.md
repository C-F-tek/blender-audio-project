...
- previous_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-190820_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-190820_recovered_220_chunk_0036.md`
- next_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-190820_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-190820_recovered_220_chunk_0038.md`
- summary_source: `ollama`

## Local chunk summary

**Scopo**: Gestire errori di provider e attivare fallback automatici per garantire la continuità delle richieste di tool in un pipeline AI cloud.  
**Segnali principali**: `provider error`, `parse_error` (UnboundLocalError: raw
