...
- previous_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-190820_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-190820_recovered_220_chunk_0109.md`
- next_chunk_file: ``
- summary_source: `ollama`

## Local chunk summary

**Scopo**: definire la struttura di navigazione dei chunk di output e le politiche di inclusione degli artefatti per la generazione di patch.  
**Segnali principali**: i chunk sono collegati tramite `previous_chunk_id`/`next_chunk_id`; la ricerca ricorsiva è disabilitata (`enabled: false`), con limite di 120 file.  
**Guardrail / errori**: nessun errore riportato; la policy di inclusione limita a 24 artefatti e 24 000 caratter
