...
- previous_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-190820_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-190820_recovered_220_chunk_0041.md`
- next_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-190820_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-190820_recovered_220_chunk_0043.md`
- summary_source: `ollama`

## Local chunk summary

**Scopo**: Registro di artefatti generati dal pipeline di AI per la revisione e patching di un progetto Blender‑Audio.  
**Segnali principali**: 1) Bridge orchestrator (220 patch consigliate, GPU non eseguito); 2) Decision loop indica “manual_review_patch_plan” con 220 patch; 3) Patch plan in modalità “report_only_manual_review_patch_plan” con 220 patch pronte per revisione manuale.  
**Guardrail/erori**: Nessun errore riportato, ma “provider_execution_performed” e “patch_application_performed” sono false, indicando che l
