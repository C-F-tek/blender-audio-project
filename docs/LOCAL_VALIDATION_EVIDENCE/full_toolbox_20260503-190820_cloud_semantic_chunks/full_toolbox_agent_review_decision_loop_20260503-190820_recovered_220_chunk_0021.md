...
- previous_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-190820_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-190820_recovered_220_chunk_0020.md`
- next_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-190820_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-190820_recovered_220_chunk_0022.md`
- summary_source: `ollama`

## Local chunk summary

**Scopo**: Generare un piano di patch manuale per correggere errori di consistenza nei file Markdown, identificati dal mapper di consistenza.  
**Segnali principali**: `md_python_command_script_missing` in varie posizioni di documenti (`macro-local-validation-prototype-gate.md`, `open-pr-triage-2026-05-02.md`, ecc.), con rischio medio
