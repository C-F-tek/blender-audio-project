...
- Seen: `True`
- Path: `docs/LOCAL_VALIDATION_EVIDENCE/python_line_count_20260507-104959.csv`
- Total lines: `118629`
...
- `total_build_report_seconds`: `82.126`
- `markdown_scan_seconds`: `58.211`
- `file_discovery_seconds`: `10.06`
- `python_inventory_seconds`: `7.808`
- `path_index_seconds`: `6.001`
- `findings_build_seconds`: `0.045`
