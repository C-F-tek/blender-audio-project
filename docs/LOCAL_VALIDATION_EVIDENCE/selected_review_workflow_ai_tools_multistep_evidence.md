...
- Generated at: `2026-05-01T11:36:28`
...
- Routing: `{'advisory_lanes': ['ollama'], 'excluded_advisory_lanes': ['npu'], 'primary_advisory_provider': {'provider': 'ollama', 'compute_lane': 'gpu_cuda', 'role': 'primary_advisory', 'execution_mode': 'explicit_only', 'enabled_by_flag': '--use-primary-advisory-provider / -UsePrimaryAdvisoryProvider', 'provider_execution_performed': False}, 'trusted_context_files': [{'path': 'output/local_ai_runs/20260501_113602_selected-review-workflow-ai-tools-patch-specs/local_ai_prompt.md', 'lane': '', 'trusted': True, 'reason': 'not_a_tracked_workload_report', 'classification': ''}, {'path': 'docs/LOCAL_AI_TASKS/selected-review-workflow-ai-tools-patch-specs.md', 'lane': '', 'trusted': True, 'reason': 'not_a_tracked_workload_report', 'classification': ''}], 'excluded_context_files': []}`
