...
- Generated at: `2026-05-03T15:29:44`
...
### `output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-151613.json`
...
### `output/validation/agent_review_decision_loop_smoke_full_toolbox_20260503-151613.json`
...
### `output/validation/deterministic_recommendation_synthesizer_smoke_full_toolbox_20260503-151613.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy_smoke.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_operational_memory_status.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_persistent_memory_status.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_python_line_count.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker_smoke.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_validation_report_contract.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_workflow.json`
...
### `output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-151613.json`
...
### `output/validation/npu_provider_environment_full_toolbox_20260503-151613.json`
...
### `output/validation/python_line_count_full_toolbox_20260503-151613.json`
...
### `output/validation/python_syntax_full_toolbox_20260503-151613.json`
...
### `output/analysis/code_interpreter_full_toolbox_20260503-151613.json`
...
- Patch application performed: `False`
- Source writes performed: `False`
- Recommendation count: `142`

### `output/analysis/full_memory_tool_regeneration_20260503-151613_code_interpreter.json`
...
- Patch application performed: `False`
- Source writes performed: `False`
- Recommendation count: `123`

### `output/analysis/gpu_json_contract_replay_full_toolbox_20260503-151613.json`
...
### `output/analysis/gpu_npu_run_sync_full_toolbox_20260503-151613.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agent_memory_inventory.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agnostic_tool_inventory.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_transient_request_context.json`
...
### `output/ai_pipeline/full_toolbox_20260503-151613_agent_review_decision_loop.json`
...
### `output/ai_pipeline/full_toolbox_20260503-151613_bridge_orchestrator.json`
...
### `output/ai_pipeline/full_toolbox_20260503-151613_deterministic_recommendations.json`
...
### `output/ai_pipeline/full_toolbox_20260503-151613_orchestrator.json`
...
### `output/ai_pipeline/full_toolbox_20260503-151613_parallel_gpu.json`
...
- `output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-151613.json` exists=`True` size=`484321` suffix=`.json` preview_chars=`1500`
- `output/validation/agent_review_decision_loop_smoke_full_toolbox_20260503-151613.json` exists=`True` size=`1447` suffix=`.json` preview_chars=`1420`
- `output/validation/deterministic_recommendation_synthesizer_smoke_full_toolbox_20260503-151613.json` exists=`True` size=`5177` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy.json` exists=`True` size=`8893` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_operational_memory_status.json` exists=`True` size=`1743` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_persistent_memory_status.json` exists=`True` size=`1779` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_python_line_count.json` exists=`True` size=`3171` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json` exists=`True` size=`36024` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json` exists=`True` size=`98090` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_validation_report_contract.json` exists=`True` size=`3417` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-151613_workflow.json` exists=`True` size=`4913` suffix=`.json` preview_chars=`1500`
- `output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-151613.json` exists=`True` size=`7152` suffix=`.json` preview_chars=`1500`
- `output/validation/npu_provider_environment_full_toolbox_20260503-151613.json` exists=`True` size=`1745` suffix=`.json` preview_chars=`1500`
- `output/validation/python_line_count_full_toolbox_20260503-151613.json` exists=`True` size=`3141` suffix=`.json` preview_chars=`1500`
- `output/validation/python_syntax_full_toolbox_20260503-151613.json` exists=`True` size=`36024` suffix=`.json` preview_chars=`1500`
- `output/analysis/code_interpreter_full_toolbox_20260503-151613.json` exists=`True` size=`1347069` suffix=`.json` preview_chars=`1500`
- `output/analysis/full_memory_tool_regeneration_20260503-151613_code_interpreter.json` exists=`True` size=`1164865` suffix=`.json` preview_chars=`1500`
- `output/analysis/gpu_json_contract_replay_full_toolbox_20260503-151613.json` exists=`True` size=`22814` suffix=`.json` preview_chars=`1500`
- `output/analysis/gpu_npu_run_sync_full_toolbox_20260503-151613.json` exists=`True` size=`2534` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agent_memory_inventory.json` exists=`True` size=`14596` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agnostic_tool_inventory.json` exists=`True` size=`492183` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_transient_request_context.json` exists=`True` size=`9176` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_toolbox_20260503-151613_agent_review_decision_loop.json` exists=`True` size=`2597` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_toolbox_20260503-151613_bridge_orchestrator.json` exists=`True` size=`25455` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_toolbox_20260503-151613_deterministic_recommendations.json` exists=`True` size=`103104` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_toolbox_20260503-151613_orchestrator.json` exists=`True` size=`34787` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_toolbox_20260503-151613_parallel_gpu.json` exists=`True` size=`93490` suffix=`.json` preview_chars=`1500`
...
### `output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-151613.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `134623`
- SHA-256: `61487eac427d86f4aae37ba95c67f724be4f0ac921a7a1a2351f8f6af0beab77`
- Content included: `True`
- Content truncated: `True`
...
- output/validation/shared_toolbox_python_syntax_20260503-151613.json: optional report missing
- output/analysis/shared_toolbox_code_interpreter_20260503-151613.json: optional report missing
- output/validation/shared_toolbox_gpu_contract_smoke_20260503-151613.json: optional report missing
- output/validation/shared_toolbox_gpu_routing_20260503-151613.json: optional report missing
- output/validation/shared_toolbox_npu_execution_20260503-151613.json: optional report missing
- output/validation/shared_toolbox_npu_contract_20260503-151613.json: optional report missing
- output/validation/npu_provider_environment_shared_toolbox_20260503-151613.json: optional report missing
- output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-151613_orchestrator.json: optional report missing
- output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-151613_gpu.json: optional report missing
- output/analysis/shared_toolbox_gpu_npu_sync_20260503-151613.json: optional report missing
- output/analysis/shared_toolbox_gpu_contract_replay_20260503-151613.json: optional report missing
- output/analysis/shared_toolbox_code_interpreter_20260503-151613.md: optional artifact missing
- output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-151613_orchestrator.md: optional artifact missing
- output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-151613_gpu.md: optional artifact missing
- output/analysis/shared_toolbox_gpu_npu_sync_20260503-151613.md: optional artifact missing
- output/analysis/shared_toolbox_gpu_contract_replay_20260503-151613.md: optional artifact missing
- output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-151613.md: optional artifact missing
...
- Enabled: `True`
- Discovered reports: `29`
- Discovered artifacts: `25`

## Chunked large JSON/Markdown files

- output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-151613.json lines=345 chunks=2 chunk_size=200
  - output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-151613.json#L1-L200 -> next: output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-151613.json#L201-L345
  - output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-151613.json#L201-L345 -> next: END
- output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy.json lines=244 chunks=2 chunk_size=200
  - output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy.json#L1-L200 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy.json#L201-L244
  - output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy.json#L201-L244 -> next: END
- output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json lines=1557 chunks=8 chunk_size=200
  - output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L1-L200 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L201-L400
  - output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L201-L400 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L401-L600
  - output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L401-L600 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L601-L800
  - output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L601-L800 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L801-L1000
  - output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L801-L1000 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L1001-L1200
  - output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L1001-L1200 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L1201-L1400
  - output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L1201-L1400 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L1401-L1557
  - output/validation/full_memory_tool_regeneration_20260503-151613_python_syntax.json#L1401-L1557 -> next: END
- output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json lines=1195 chunks=6 chunk_size=200
  - output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L1-L200 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L201-L400
  - output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L201-L400 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L401-L600
  - output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L401-L600 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L601-L800
  - output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L601-L800 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L801-L1000
  - output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L801-L1000 -> next: output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L1001-L1195
  - output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json#L1001-L1195 -> next: END
- output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-151613.json lines=214 chunks=2 chunk_size=200
  - output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-151613.json#L1-L200 -> next: output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-151613.json#L201-L214
  - output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-151613.json#L201-L214 -> next: END
- output/validation/python_syntax_full_toolbox_20260503-151613.json lines=1557 chunks=8 chunk_size=200
  - output/validation/python_syntax_full_toolbox_20260503-151613.json#L1-L200 -> next: output/validation/python_syntax_full_toolbox_20260503-151613.json#L201-L400
  - output/validation/python_syntax_full_toolbox_20260503-151613.json#L201-L400 -> next: output/validation/python_syntax_full_toolbox_20260503-151613.json#L401-L600
  - output/validation/python_syntax_full_toolbox_20260503-151613.json#L401-L600 -> next: output/validation/python_syntax_full_toolbox_20260503-151613.json#L601-L800
  - output/validation/python_syntax_full_toolbox_20260503-151613.json#L601-L800 -> next: output/validation/python_syntax_full_toolbox_20260503-151613.json#L801-L1000
  - output/validation/python_syntax_full_toolbox_20260503-151613.json#L801-L1000 -> next: output/validation/python_syntax_full_toolbox_20260503-151613.json#L1001-L1200
  - output/validation/python_syntax_full_toolbox_20260503-151613.json#L1001-L1200 -> next: output/validation/python_syntax_full_toolbox_20260503-151613.json#L1201-L1400
  - output/validation/python_syntax_full_toolbox_20260503-151613.json#L1201-L1400 -> next: output/validation/python_syntax_full_toolbox_20260503-151613.json#L1401-L1557
  - output/validation/python_syntax_full_toolbox_20260503-151613.json#L1401-L1557 -> next: END
- output/analysis/code_interpreter_full_toolbox_20260503-151613.json lines=51808 chunks=260 chunk_size=200
  - output/analysis/code_interpreter_full_toolbox_20260503-151613.json#L1-L200 -> next: output/analysis/code_interpreter_full_toolbox_20260503-151613.json#L201-L400
  - output/analysis/code_interpreter_full_toolbox_20260503-151613.json#L201-L400 -> next: output/analysis/code_interpreter_full_toolbox_20260503-151613.json#L401-L600
  - output/analysis/code_interpreter_full_toolbox_20260503-151613.json#L401-L600 -> next: output/analysis/code_interpreter_full_toolbox_20260503-151613.json#L601-L800
  - output/analysis/code_interpreter_full_toolbox_20260503-151613.json#L601-L800 -> next: output/analysis/code_interpreter_full_toolbox_20260503-151613.json#L801-L1000
  - output/analysis/code_interpreter_full_toolbox_20260503-151613.json#L801-L1000
```
...
- Suffix: `.json`
- Size bytes: `1347069`
- SHA-256: `e49c65988831eccef226f33f5d5a3e1b90e09c9dac84fedd8797206db6df6ede`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "code_interpreter_report",
  "generated_at": "2026-05-03T15:16:30",
  ...
  "file_count": 261,
  "parsed_file_count": 261,
  "total_lines": 72252,
  "total_functions": 2540,
  "total_classes": 92,
  "total_risk_signals": 53,
  "total_todos": 21,
  "top_imports": [
    {
      "module": "Tools",
...
### `output/analysis/code_interpreter_full_toolbox_20260503-151613.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `7079`
- SHA-256: `9917b1bb7591ad6b06d5a4d77c9f28307430a25a1ce8587095e01bdf38994a00`
- Content included: `True`
- Content truncated: `False`
...
- `code_static_022` `Tools/ai/agent_runtime_sqlite_memory.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_023` `Tools/ai/agent_runtime_tool_broker.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected, static risk calls detected
- `code_static_024` `Tools/ai/agent_state.py` risk `medium`: medium-size Python module
- `code_static_025` `Tools/ai/analyze_gpu_npu_run_sync.py` risk `medium`: complex functions detected
- `code_static_026` `Tools/ai/build_agent_agnostic_tool_inventory.py` risk `medium`: medium-size Python module, complex functions detected
- `code_static_027` `Tools/ai/build_agent_memory_inventory.py` risk `medium`: large functions detected
- `code_static_028` `Tools/ai/build_agent_review_code_patch_plan.py` risk `medium`: medium-size Python module
- `code_static_029` `Tools/ai/build_agent_review_evidence_sufficiency.py` risk `medium`: medium-size Python module
- `code_static_030` `Tools/ai/build_agent_review_patch_plan.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_031` `Tools/ai/build_ai_context_pack.py` risk `medium`: medium-size Python module, complex functions detected
- `code_static_032` `Tools/ai/build_code_interpreter_report.py` risk `medium`: medium-size Python module, TODO/FIXME markers detected
- `code_static_033` `Tools/ai/build_deterministic_recommendations.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_034` `Tools/ai/build_dry_run_matrix_evidence_bundle.py` risk `medium`: complex functions detected
- `code_static_035` `Tools/ai/build_full_context_golden_proposals.py` risk `medium`: large functions detected
- `code_static_036` `Tools/ai/build_github_evidence_bundle.py` risk `medium`: large functions detected
- `code_static_037` `Tools/ai/build_local_ai_enrichment_plan.py` risk `medium`: large functions detected
- `code_static_038` `Tools/ai/build_music_intermediates.py` risk `medium`: large functions detected, complex functions detected
- `code_static_039` `Tools/ai/build_patch_specs_from_proposals.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_040` `Tools/ai/build_refactor_duplication_audit.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
...
- Suffix: `.json`
- Size bytes: `1164865`
- SHA-256: `c66549eba99bb8249d2943ccb2b9cd546e798efc273ea6a30f8c7cc2f77b5402`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "code_interpreter_report",
  "generated_at": "2026-05-03T15:16:20",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "apply_mode": "report_only_static_code_interpreter",
  "file_count": 219,
  "parsed_file_count": 219,
  "total_lines": 61647,
  "total_functions": 2259,
  "total_classes": 70,
  "total_risk_signals": 41,
  "total_todos": 21,
  "top_imports": [
    {
      "module": "Tools",
  ...
  "recommendations": [
    ...
    {
      "id": "code_static_010",
      "target_file": "Tools/ai/build_agent_review_evidence_sufficiency.py",
      "risk": "medium",
      "status": "candidate_for_manual_review",
      "reasons": [
        "medium-size Python module"
...
### `output/analysis/full_memory_tool_regeneration_20260503-151613_code_interpreter.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `7340`
- SHA-256: `bb56c2232ec4b4280a9c9caa2fde92b346f4531ec614a98a82dad0cca5e3025d`
- Content included: `True`
- Content truncated: `False`
...
- `Tools/ai/build_ai_context_pack.py` — `579` lines, risk `medium`
- `Tools/ai/run_pipeline_dry_run_matrix.py` — `573` lines, risk `medium`
- `Tools/ai/build_agent_review_patch_plan.py` — `570` lines, risk `medium`
...
- `code_static_010` `Tools/ai/build_agent_review_evidence_sufficiency.py` risk `medium`: medium-size Python module
- `code_static_011` `Tools/ai/build_agent_review_patch_plan.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_012` `Tools/ai/build_ai_context_pack.py` risk `medium`: medium-size Python module, complex functions detected
- `code_static_013` `Tools/ai/build_code_interpreter_report.py` risk `medium`: medium-size Python module, TODO/FIXME markers detected
- `code_static_014` `Tools/ai/build_deterministic_recommendations.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_015` `Tools/ai/build_dry_run_matrix_evidence_bundle.py` risk `medium`: complex functions detected
- `code_static_016` `Tools/ai/build_full_context_golden_proposals.py` risk `medium`: large functions detected
- `code_static_017` `Tools/ai/build_github_evidence_bundle.py` risk `medium`: large functions detected
- `code_static_018` `Tools/ai/build_local_ai_enrichment_plan.py` risk `medium`: large functions detected
- `code_static_019` `Tools/ai/build_music_intermediates.py` risk `medium`: large functions detected, complex functions detected
- `code_static_020` `Tools/ai/build_patch_specs_from_proposals.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_021` `Tools/ai/build_refactor_duplication_audit.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_022` `Tools/ai/build_repository_change_proposals.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_023` `Tools/ai/build_selective_execution_plan.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_024` `Tools/ai/build_shared_toolbox_ai_to_ai_bundle.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_025` `Tools/ai/build_workload_quality_lane_routing.py` risk `medium`: complex functions detected
- `code_static_026` `Tools/ai/check_local_resource_lanes.py` risk `medium`: complex functions detected
- `code_static_027` `Tools/ai/check_npu_provider_environment.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_028` `Tools/ai/github_evidence_bundle_artifacts.py` risk `medium`: complex functions detected
- `code_static_029` `Tools/ai/gpu_planner_json_contract.py` risk `medium`: complex functions detected
- `code_static_030` `Tools/ai/model_json.py` risk `medium`: complex functions detected
- `code_static_031` `Tools/ai/pipeline/preflight.py` risk `medium`: complex functions detected
- `code_static_032` `Tools/ai/pipeline/remediation.py` risk `medium`: large functions detected, complex functions detected, TODO/FIXME markers detected
- `code_static_033` `Tools/ai/pipeline/steps.py` risk `medium`: large functions detected
- `code_static_034` `Tools/ai/promote_patch_spec_draft.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_035` `Tools/ai/refine_megalithic_review_signals.py` risk `medium`: medium-size Python module
- `code_static_036` `Tools/ai/review_wave_entrypoints.py` risk `medium`: large functions detected, complex functions detected
- `code_static_037` `Tools/ai/run_agent_gpu_deep_planning_review.py` risk `high`: large Python module, large functions detected, complex functions detected
- `code_static_038` `Tools/ai/run_agent_gpu_deep_planning_supervised.py` risk `high`: large Python module, large functions detected, complex functions detected, static risk calls detected
- `code_static_039` `Tools/ai/run_agent_gpu_npu_parallel_orchestrator.py` risk `high`: large Python module, large functions detected, complex functions detected, static risk calls detected
- `code_static_040` `Tools/ai/run_agent_review_decision_loop.py` risk `medium`: large functions detected, complex functions detected
...
- Suffix: `.json`
- Size bytes: `22814`
- SHA-256: `91b4bd8f8ac452e81e258a942ffcceae34a1ba8d5ea7bf6333728c110173ee12`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "gpu_planner_json_contract_replay",
  "generated_at": "2026-05-03T15:29:42",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "manual_review_required": true,
  "inputs": {
    "gpu_report": "output/ai_pipeline/full_toolbox_20260503-151613_parallel_gpu.json"
  },
  "source_summary": {
    "kind": "agent_gpu_deep_planning_supervised",
    "passed": false,
  ...
  "json_parse_failure_count": 20,
  "model_output_schema_mismatch_count": 0,
  "valid_recommendation_output_count": 0,
  "rounds": [
    {
      "round": 1,
      "original_empty_recommendations_reason": "json_parse_failure",
      "original_json_ok": false,
      "original_parse_error": "UnboundLocalError: cannot access local variable 'raw_response' where it is not associated with a value",
      "original_response_chars": 0,
      "contract": {
        "json_ok": false,
        "schema_ok": false,
        ...
        "schema_errors": [],
        "raw_response_sha256": "c6e25da2a59cf5b3f1a40b68756b49b8fc3455a1ec155a6692691bf77f1c2a18",
    ...
    },
    {
      ...
      "contract": {
        ...
        "schema_ok": false,
        "context_echo_detected": false,
        "parse_error": "ModelJsonParseError: Unable to parse model JSON: Expecti
```

### `output/analysis/gpu_json_contract_replay_full_toolbox_20260503-151613.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `599`
- SHA-256: `27b3b6237391a101294af74e34d4f8e3f69c5b78d35da346efaf49759aec15e7`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.json`
- Size bytes: `2534`
- SHA-256: `88a5caeec0bc8bbb732de68ac8e162769a62a13a83ab0fa580bdb9d864b6f6b3`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  ...
  "manual_review_required": true,
  "inputs": {
    "orchestrator": "output/ai_pipeline/full_toolbox_20260503-151613_orchestrator.json"
  },
  "metrics": {
    "gpu_round_count": 20,
    "npu_audit_count": 6,
    "npu_audit_success_count": 6,
    "npu_audit_round_coverage": 0.3,
    "avg_gpu_round_seconds": 39.512,
    "p50_gpu_round_seconds": 39.512,
    "p90_gpu_round_seconds": 39.512,
    "avg_npu_audit_seconds": 101.667,
    "p50_npu_audit_seconds": 102.0,
    "p90_npu_audit_seconds": 102.0,
    "npu_to_gpu_avg_duration_ratio": 2.573,
    "gpu_elapsed_seconds": 790.242,
...
### `output/analysis/gpu_npu_run_sync_full_toolbox_20260503-151613.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1497`
- SHA-256: `ca5eefc31d6468be02151a3289edb1baaa41c3de0146f2dfa785304ab2debe23`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.json`
- Size bytes: `484321`
- SHA-256: `cf056c4eecfccf10924a0742aab4c49e9037110aaad6e8c5f3d6e77edcc3102d`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  ...
  "remaining_gaps": [
    {
      "path": "output/validation/shared_toolbox_python_syntax_20260503-151613.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/analysis/shared_toolbox_code_interpreter_20260503-151613.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/shared_toolbox_gpu_contract_smoke_20260503-151613.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/shared_toolbox_gpu_routing_20260503-151613.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/shared_toolbox_npu_execution_20260503-151613.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/shared_toolbox_npu_contract_20260503-151613.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/npu_provider_environment_shared_toolbox_20260503-151613.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-151613_orchestrator.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-151613_gpu.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/analysis/shared_toolbox_gpu_npu_sync_20260503-151613.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/analysis/shared_toolbox_gpu_contract_replay_20260503-151613.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/analysis/shared_toolbox_code_interpreter_20260503-151613.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-151613_orchestrator.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-151613_gpu.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/analysis/shared_toolbox_gpu_npu_sync_20260503-151613.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/analysis/shared_toolbox_gpu_contract_replay_20260503-151613.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-151613.md",
      "reason": "optional artifact missing"
    },
    {
  ...
  "compact_bundle_paths": [
    "docs/LOCAL_VALIDATION_EVIDENCE/shared_toolbox_ai_to_ai_bundle_20260503-151613.json",
    "docs/LOCAL_VALIDATION_EVIDENCE/shared_toolbox_ai_to_ai_bundle_20260503-151613.md"
  ],
  "provider_execution_performed": false,
  "patch_application_performed": false,
  "source_writes_performed": false,
  ...
  "recursive_defaults": {
    ...
    "discovered_reports": [
      ...
      "output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agnostic_tool_inventory.json",
      "output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_transient_request_context.json",
      "output/ai_pipeline/full_toolbox_20260503-151613_agent_review_decisi
```
...
- Suffix: `.json`
- Size bytes: `14596`
- SHA-256: `b502463ae53bfab1791dde048d576260f3a815e37cbbeec7eed9cd2381a26dc0`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  ...
  "sqlite": {
    ...
    "indexes": [
      ...
      {
        "name": "idx_memory_records_kind",
        "table": "memory_records"
      },
      {
        "name": "idx_memory_records_scope",
        "table": "memory_records"
      },
      {
        "name": "idx_memory_records_source",
        "table": "memory_records"
      },
      {
  ...
  "records": {
    ...
    "top_sources": {
      "indexAI/code_chunks/semantic_code_chunks_manifest.json": 14,
      "output/ai_context_packs/full_context_golden_core_ai_backend.json": 11,
      "output/ai_context_packs/full_context_golden_core_ai_backend.md": 11,
      "output/ai_context_packs/full_context_golden_selected_chunks.json": 11,
      "output/ai_context_packs/full_context_golden_selected_chunks.md": 11,
      "output/ai_pipeline/full_context_golden_enrichment_plan.json": 10,
      "cli_note_1": 3,
      "docs/LOCAL_AI_WORKFLOW.md": 2,
      "output/ai_pipeline/full_context_golden_enrichment_plan.md": 1,
      "docs/LOCAL_AI_TASKS/full-context-ai-npu-golden-path.md": 1,
      "output/local_ai_runs/20260501_131227_full-context-ai-npu-golden-path/local_ai_prompt.md": 1,
      "output/ai_context_packs/selected_chunks_real_core_ai_backend.json": 1,
      "output/ai_context_packs/selected_chunks_real_core_ai_backend.md": 1,
      "output/ai_context_packs/selected_chunks_real_focus.json": 1,
      "output/ai_context_packs/selected_chunks_real_focus.md": 1,
      "docs/LOCAL_AI_TASKS/enrich-local-ai-memory-chunks-context-wrapper.md": 1,
      "output/ai_context_packs/enrichment_real_core_ai_backend.json": 1,
      "output/ai_context_packs/enrichment_real_core_ai_backend.md": 1,
      "output/ai_context_packs/selected_review_core_ai_backend.md": 1,
      "docs/LOCAL_AI_RUN_BOOTSTRAP.md": 1,
      "docs/LOCAL_AI_TASKS/selected-review-workflow-ai-tools-patch-specs.md": 1,
      "AGENTS.md": 1,
      "docs/AI_SMART_POLICY.md": 1
    },
    "tag_counts": {
      "source_file": 85,
      "json": 49,
  ...
  "selected_memory_preview": [
    {
      "record_id": "6ab1d912e8b95a61aea4",
      "kind": "source_file",
      "scope": "project",
      "source": "output/local_ai_runs/20260501_131227_full-context-ai-npu-golden-path/local_ai_prompt.md",
      "tags": [
        "source_file",
        "md"
      ],
      "confidence": 1.0,
      "rank_score": 22.0,
      "summary": "﻿# Local AI Non-Interactive Run Packet This packet was generated by Tools/workflow/run_local_ai_markdown_task.ps1. The AI runner must obey the repository contract below before planning, editing or validating. ## Invocation metadata - Repository root: $repoRoot - Branch: $branch - HEAD: $headSha - Task file: $taskRelative - Provider execution requested by wrapper: alse - Runner command supplied: $([bool](-not [string]::IsNullOrWhiteSpace())) ## Primary instruction Read and obey the following sections in order: 1. AGENTS.md 2. docs/LOCAL_AI_RUN_BOOTSTRAP.md 3. task file $taskRelative If any section conflicts, preserve hard guardrails from AGENTS.md and stop with a conflict report. --- # AGENTS.md `markdown # AGENTS.md This file provides operating context for AI assistants and automated code-review systems working on this repository. ## Mandatory agent contract Every AI assistant, local..."
    },
    {
      "record_id": "fa3d7a3f553570e36c29",
      "kind": "source_file",
      "scope": "project",
      ...
      "confidence": 1.0,
      "rank_score": 18.0,
      "summary": "{ \"schema_version\": 1, \"kind\": \"local_ai_enrichment_plan\", \"generated_at\": \"2026-05-01T15:18:00.974958+00:00\", \"repo_root\": \"C:/Users/carmi/blender/blender-audio-project\", \"objective\": \"Activate the app-agnostic IA-Carmine local AI core/tool pipeline, generate concrete repository artifacts, validate NPU knowledge-broker context and prepare manual-review macro patch drafts when explicitly requested.\", \"task_file\": \"docs/LOCAL_AI_TASKS/full-context-ai-npu-golden-path.md\", \"profile\": \"npu\", \"basename\": \"full_context_golden_enrichment_plan\", \"apply_mode\": \"report_only\", \"provider_execution_performed\": false, \"source_writes_performed\": false, \"patch_application_performed\": false, \"complexity\": { \"level\": \"high\", \"score\": 20, \"matched_terms\": [ \"architecture\", \"broker\", \"context\", \"full-context\", \"gpu\", \"knowledge\", \"multistep\", \"npu\", \"ollama\", \"oracle\", \"patch\", \"provider\", \"validator\", \"..."
    },
    {
      "record_id": "dd5fe9a009f9571ebe2c",
      "kind": "source_file",
      "scope": "project",
      "source": "output/ai_pipeline/full_context_golden_enrichment_plan.md",
      "tags": [
        "source_file",
        "md"
      ],
      "confidence": 1.0,
      "rank_score": 18.0,
      "summary": "# Local AI Enrichment Plan - Objective: Activate the app-agnostic IA-Carmine local AI core/tool pipeline, generate concrete repository artifacts, validate NPU knowledge-broker context and prepare manual-review macro patch drafts when explicitly requested. - Profile: `npu` - Complexity: `high` / score `20` - Apply mode: `report_only` - Provider execution performed: `False` - Step count: `11` ## Lane policy - `primary_advisory_provider`: `ollama_gpu` - `npu_role`: `knowledge_broker_context_oracle` - `npu_promoted_to_advisory`: `False` - `openvino_gpu_primary_lane`: `False` - `complex_task_policy`: `ollama_gpu_advisory_first_then_npu_broker_after_gpu_result` - `simple_task_policy`: `npu_broker_can_run_after_selected_chunks_without_blocking_optional_gpu_advisory` ## Steps ### read_contracts: Read AGENTS and local AI run bootstrap contracts - Lane: `control` - Timing: `immediate` - Tool: `..."
    },
    {
      "record_id": "0bb86756c6301d571f2e",
      "kind": "source_file",
      "scope": "project",
      "source": "docs/LOCAL_AI_TASKS/full-context-ai-npu-golden-path.md",
      "tags": [
        "source_file",
        "md"
      ],
      "confidence": 1.0,
      "rank_score": 18.0,
      "summary": "# Local AI Entrypoint: Full-Context AI/NPU Golden Path This is a non-interactive task file for a local AI runner. The task exercises the complete local AI/NPU full-context workflow and asks the local AI to generate richer repository proposals while remaining report-only and manual-review-only. ## Absolute first instruction Before planning, validating, proposing changes or producing patch specs, read and obey these files in order: ```text AGENTS.md docs/LOCAL_AI_RUN_BOOTSTRAP.md ``` Then read this file again and continue from the task contract below. If either required file is missing, stop and report the missing file. Do not infer their contents. ## Task classification ```text full-context local AI/NPU golden path + complexity escalation proposals ``` Default behavior: ```text report-only proposal-only manual-review-only no automatic patch apply ``` Provider execution is allowed only..."
    },
    {
      "record_id": "ff0a579d24317f5a7d77",
      "kind": "source_file",
      "scope": "project",
      "source": "output/ai_pipeline/full_context_golden_enrichment_plan.json",
      "tags": [
      ...
      "confidence": 1.0,
      "rank_score": 18.0,
      "summary": "{ \"schema_version\": 1, \"kind\": \"local_ai_enrichment_plan\", \"generated_at\": \"2026-05-01T15:11:03.661286+00:00\", \"repo_root\": \"C:/Users/carmi/blender/blender-audio-project\", \"objective\": \"Activate the app-agnostic IA-Carmine local AI core/tool pipeline, generate concrete repository artifacts, validate NPU knowledge-broker context and prepare manual-review macro patch drafts when explicitly requested.\", \"task_file\": \"docs/LOCAL_AI_TASKS/full-context-ai-npu-golden-path.md\", \"profile\": \"npu\", \"basename\": \"full_context_golden_enrichment_plan\", \"apply_mode\": \"report_only\", \"provider_execution_performed\": false, \"source_writes_performed\": false, \"patch_application_performed\": false, \"complexity\": { \"level\": \"high\", \"score\": 20, \"matched_terms\": [ \"architecture\", \"broker\", \"context\", \"full-context\", \"gpu\", \"knowledge\", \"multistep\", \"npu\", \"ollama\", \"oracle\", \"patch\", \"provider\", \"validator\", \"..."
    },
    {
    ...
    {
      "record_id": "4754000d16761be2f6e8",
      "kind": "operator_note",
      "scope": "task",
      "source": "cli_note_1",
      "tags": [
      ...
      "confidence": 1.0,
      "rank_score": 2.0,
      "summary": "Keep persistent memory generic and avoid Blender-only schema decisions."
    },
    {
      "record_id": "323ca405ff52321dec3c",
      "kind": "operator_note",
      "scope": "task",
      "source": "cli_note_1",
      "tags": [
      ...
      "confidence": 1.0,
      "rank_score": 2.0,
      "summary": "SQLite memory is local generated data and should stay untracked."
    }
  ],
  "integration": {
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agent_memory_inventory.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `6917`
- SHA-256: `4e7061932cf77cde95eb95a2e8eb234291513bc7174c18953d3fae666619bbf3`
- Content included: `True`
- Content truncated: `False`
...
- `memory_records` rows=`88` columns=`12`
...
### 6ab1d912e8b95a61aea4 - output/local_ai_runs/20260501_131227_full-context-ai-npu-golden-path/local_ai_prompt.md

- Kind: `source_file`
- Scope: `project`
- Score: `22.0`

﻿# Local AI Non-Interactive Run Packet This packet was generated by Tools/workflow/run_local_ai_markdown_task.ps1. The AI runner must obey the repository contract below before planning, editing or validating. ## Invocation metadata - Repository root: $repoRoot - Branch: $branch - HEAD: $headSha - Task file: $taskRelative - Provider execution requested by wrapper: alse - Runner command supplied: $([bool](-not [string]::IsNullOrWhiteSpace())) ## Primary instruction Read and obey the following sections in order: 1. AGENTS.md 2. docs/LOCAL_AI_RUN_BOOTSTRAP.md 3. task file $taskRelative If any section conflicts, preserve hard guardrails from AGENTS.md and stop with a conflict report. --- # AGENTS.md `markdown # AGENTS.md This file provides operating context for AI assistants and automated code-review systems working on this repository. ## Mandatory agent contract Every AI assistant, local...

### fa3d7a3f553570e36c29 - output/ai_pipeline/full_context_golden_enrichment_plan.json

- Kind: `source_file`
- Scope: `project`
- Score: `18.0`

{ "schema_version": 1, "kind": "local_ai_enrichment_plan", "generated_at": "2026-05-01T15:18:00.974958+00:00", "repo_root": "C:/Users/carmi/blender/blender-audio-project", "objective": "Activate the app-agnostic IA-Carmine local AI core/tool pipeline, generate concrete repository artifacts, validate NPU knowledge-broker context and prepare manual-review macro patch drafts when explicitly requested.", "task_file": "docs/LOCAL_AI_TASKS/full-context-ai-npu-golden-path.md", "profile": "npu", "basename": "full_context_golden_enrichment_plan", "apply_mode": "report_only", "provider_execution_performed": false, "source_writes_performed": false, "patch_application_performed": false, "complexity": { "level": "high", "score": 20, "matched_terms": [ "architecture", "broker", "context", "full-context", "gpu", "knowledge", "multistep", "npu", "ollama", "oracle", "patch", "provider", "validator", "...

### dd5fe9a009f9571ebe2c - output/ai_pipeline/full_context_golden_enrichment_plan.md

- Kind: `source_file`
- Scope: `project`
- Score: `18.0`

# Local AI Enrichment Plan - Objective: Activate the app-agnostic IA-Carmine local AI core/tool pipeline, generate concrete repository artifacts, validate NPU knowledge-broker context and prepare manual-review macro patch drafts when explicitly requested. - Profile: `npu` - Complexity: `high` / score `20` - Apply mode: `report_only` - Provider execution performed: `False` - Step count: `11` ## Lane policy - `primary_advisory_provider`: `ollama_gpu` - `npu_role`: `knowledge_broker_context_oracle` - `npu_promoted_to_advisory`: `False` - `openvino_gpu_primary_lane`: `False` - `complex_task_policy`: `ollama_gpu_advisory_first_then_npu_broker_after_gpu_result` - `simple_task_policy`: `npu_broker_can_run_after_selected_chunks_without_blocking_optional_gpu_advisory` ## Steps ### read_contracts: Read AGENTS and local AI run bootstrap contracts - Lane: `control` - Timing: `immediate` - Tool: `...

### 0bb86756c6301d571f2e - docs/LOCAL_AI_TASKS/full-context-ai-npu-golden-path.md

- Kind: `source_file`
- Scope: `project`
- Score: `18.0`

# Local AI Entrypoint: Full-Context AI/NPU Golden Path This is a non-interactive task file for a local AI runner. The task exercises the complete local AI/NPU full-context workflow and asks the local AI to generate richer repository proposals while remaining report-only and manual-review-only. ## Absolute first instruction Before planning, validating, proposing changes or producing patch specs, read and obey these files in order: ```text AGENTS.md docs/LOCAL_AI_RUN_BOOTSTRAP.md ``` Then read this file again and continue from the task contract below. If either required file is missing, stop and report the missing file. Do not infer their contents. ## Task classification ```text full-context local AI/NPU golden path + complexity escalation proposals ``` Default behavior: ```text report-only proposal-only manual-review-only no automatic patch apply ``` Provider execution is allowed only...

### ff0a579d24317f5a7d77 - output/ai_pipeline/full_context_golden_enrichment_plan.json

- Kind: `source_file`
- Scope: `project`
- Score: `18.0`

{ "schema_version": 1, "kind": "local_ai_enrichment_plan", "generated_at": "2026-05-01T15:11:03.661286+00:00", "repo_root": "C:/Users/carmi/blender/blender-audio-project", "objective": "Activate the app-agnostic IA-Carmine local AI core/tool pipeline, generate concrete repository artifacts, validate NPU knowledge-broker context and prepare manual-review macro patch drafts when explicitly requested.", "task_file": "docs/LOCAL_AI_TASKS/full-context-ai-npu-golden-path.md", "profile": "npu", "basename": "full_context_golden_enrichment_plan", "apply_mode": "report_only", "provider_execution_performed": false, "source_writes_performed": false, "patch_application_performed": false, "complexity": { "level": "high", "score": 20, "matched_terms": [ "architecture", "broker", "context", "full-context", "gpu", "knowledge", "multistep", "npu", "ollama", "oracle", "patch", "provider", "validator", "...
...
### 4754000d16761be2f6e8 - cli_note_1

- Kind: `operator_note`
- Scope: `task`
- Score: `2.0`

Keep persistent memory generic and avoid Blender-only schema decisions.

### 323ca405ff52321dec3c - cli_note_1

- Kind: `operator_note`
- Scope: `task`
- Score: `2.0`

SQLite memory is local generated data and should stay untracked.
...
- Suffix: `.json`
- Size bytes: `492183`
- SHA-256: `2288f5107dfd6e0f80ae5cfacc3ae23e7146ea05758a27f29fe545b03e20bc06`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "agent_agnostic_tool_inventory",
  "generated_at": "2026-05-03T15:16:14",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "summary": {
    ...
    "owner_lane_counts": {
      "npu_explicit_provider_tool": 82,
      "gpu_cuda_explicit_provider_tool": 51,
      "cpu_validation": 39,
      "cpu_support": 34,
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agnostic_tool_inventory.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `15346`
- SHA-256: `e98905f2231dde69a7f3546872877ea6f0f5445f1f2f480c844d1dc3fad5f871`
- Content included: `True`
- Content truncated: `True`
...
- `Tools/workflow/gui/workflow_gui_with_push.py` lane=`cpu_o
```
...
- Suffix: `.json`
- Size bytes: `9176`
- SHA-256: `3e720e89e230ad6ddcec0e4441f653c2ac32be7e4fb7675b0e0b3609177f5e34`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  "schema_version": 1,
  "kind": "agent_transient_request_context",
  "generated_at": "2026-05-03T15:16:19",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "report_context": {
    ...
    "reports": [
      {
        "path": "output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agent_memory_inventory.json",
        "exists": true,
        "kind": "agent_memory_inventory",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agnostic_tool_inventory.json",
        "exists": true,
        "kind": "agent_agnostic_tool_inventory",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/full_memory_tool_regeneration_20260503-151613_persistent_memory_status.json",
        "exists": true,
        "kind": "agent_runtime_sqlite_memory",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/full_memory_tool_regeneration_20260503-151613_operational_memory_status.json",
        "exists": true,
        "kind": "agent_runtime_sqlite_memory",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy.json",
        "exists": true,
        "kind": "agent_memory_routing_policy",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json",
        "exists": true,
        "kind": "agent_runtime_tool_broker",
        "passed": true,
        "error": "",
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_transient_request_context.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1754`
- SHA-256: `9ac380b1417908a48d4f17b3f56db42395abb9988fce706978f7231761908a3e`
- Content included: `True`
- Content truncated: `False`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agent_memory_inventory.json` kind=`agent_memory_inventory` passed=`True` error=``
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-151613_agnostic_tool_inventory.json` kind=`agent_agnostic_tool_inventory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-151613_persistent_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-151613_operational_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy.json` kind=`agent_memory_routing_policy` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.json` kind=`agent_runtime_tool_broker` passed=`True` error=``
...
- Suffix: `.json`
- Size bytes: `2597`
- SHA-256: `a07b0e339341db7341e87a3199a495af7cb33191d9a287c0514c42a17bd7eaeb`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  ...
  "outputs": {
    "recommendations": {
      "path": "output/ai_pipeline/full_toolbox_20260503-151613_deterministic_recommendations.json",
      "exists": true,
      "size_bytes": 103104
    },
    "recommendations_markdown": {
      "path": "output/ai_pipeline/full_toolbox_20260503-151613_deterministic_recommendations.md",
      "exists": true,
      "size_bytes": 6900
    },
    "bridge_orchestrator": {
      "path": "output/ai_pipeline/full_toolbox_20260503-151613_bridge_orchestrator.json",
      "exists": true,
      "size_bytes": 25455
    },
    "patch_plan": {
      "path": "output/patch_specs/full_toolbox_20260503-151613_agent_review_patch_plan.json",
      "exists": true,
      "size_bytes": 169735
    },
    "patch_plan_markdown": {
      "path": "output/patch_specs/full_toolbox_20260503-151613_agent_review_patch_plan.md",
      "exists": true,
      "size_bytes": 6742
    }
  },
...
### `output/ai_pipeline/full_toolbox_20260503-151613_agent_review_decision_loop.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1060`
- SHA-256: `8fd9e9a02dbb3018deddf9c606c755e67b32bf41b2d4afc9bb041bda04b1bc69`
- Content included: `True`
- Content truncated: `False`
...
- `recommendations`: `output/ai_pipeline/full_toolbox_20260503-151613_deterministic_recommendations.json` exists=`True` size=`103104`
- `recommendations_markdown`: `output/ai_pipeline/full_toolbox_20260503-151613_deterministic_recommendations.md` exists=`True` size=`6900`
- `bridge_orchestrator`: `output/ai_pipeline/full_toolbox_20260503-151613_bridge_orchestrator.json` exists=`True` size=`25455`
- `patch_plan`: `output/patch_specs/full_toolbox_20260503-151613_agent_review_patch_plan.json` exists=`True` size=`169735`
- `patch_plan_markdown`: `output/patch_specs/full_toolbox_20260503-151613_agent_review_patch_plan.md` exists=`True` size=`6742`
...
- Suffix: `.json`
- Size bytes: `25455`
- SHA-256: `8998b5a514d0e97458cb18cf311f06b8589a15e4045a28f0a5a4f286db89978d`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  ...
  "patch_application_performed": false,
  "source_writes_performed": false,
  "gpu_output": "output/ai_pipeline/full_toolbox_20260503-151613_deterministic_recommendations.json",
  ...
  "npu_audits": [
    {
      "round": 1,
      "checkpoint": "output/ai_pipeline/full_toolbox_20260503-151613_checkpoints/round_001.json",
      "audit_output": "output/ai_pipeline/full_toolbox_20260503-151613_checkpoints/round_001_npu_async_audit.json",
      "started_at": "2026-05-03T15:17:12",
      "status": "finished",
      "command": [
        ...
        ".",
        "--gpu-review",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_001.json",
        "--output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_001_npu_async_audit.json",
        "--markdown-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_001_npu_async_audit.md",
        "--context-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_001_npu_async_audit_context.md",
        "--npu-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_001_npu_async_audit_npu.md",
        "--npu-notes-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_001_npu_async_audit_npu_notes.md",
        "--npu-metadata-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_001_npu_async_audit_metadata.json",
        "--timeout-seconds",
        "420",
        "--max-context-chars",
        "8000",
    ...
    {
      "round": 4,
      "checkpoint": "output/ai_pipeline/full_toolbox_20260503-151613_checkpoints/round_004.json",
      "audit_output": "output/ai_pipeline/full_toolbox_20260503-151613_checkpoints/round_004_npu_async_audit.json",
      "started_at": "2026-05-03T15:18:56",
      "status": "finished",
      "command": [
        "C:\\Python314\\python.exe",
        "Tools/ai/run_npu_gpu_deep_review_auditor.py",
        ...
        ".",
        "--gpu-review",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_004.json",
        "--output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_004_npu_async_audit.json",
        "--markdown-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_004_npu_async_audit.md",
        "--context-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_004_npu_async_audit_context.md",
        "--npu-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_004_npu_async_audit_npu.md",
        "--npu-notes-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_004_npu_async_audit_npu_notes.md",
        "--npu-metadata-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_004_npu_async_audit_metadata.json",
        "--timeout-seconds",
        "420",
        "--max-context-chars",
        "8000",
      ...
      "finished_at": "2026-05-03T15:20:38",
      "returncode": 0,
      "stdout_tail": "{\n  \"passed\": true,\n  \"output\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_pipeline\\\\full_toolbox_20260503-151613_checkpoints\\\\round_004_npu_async_audit.json\",\n  \"markdown\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_pipeline\\\\full_toolbox_20260503-151613_checkpoints\\\\round_004_npu_async_audit.md\",\n  \"npu_python\": \"C:\\\\Users\\\\carmi\\\\blender\\\\venvs\\\\blender-npu-ai\\\\Scripts\\\\python.exe\",\n  \"npu_python_exists\": true,\n  \"provider_execution_requested\": true,\n  \"provider_load_attempted\": true,\n  \"provider_execution_succeeded\": true,\n  \"provider_empty_response\": false,\n  \"dependency_missing\": false,\n  \"patch_application_performed\": false,\n  \"non_blocking\": true,\n  \"classification\": \"usable_audit_text\",\n  \"runtime_tool_context_seen\": false,\n  \"runtime_tool_context_report_count\": 0,\n  \"tool_request_count\": 0,\n  \"valid_tool_request_count\": 0,\n  \"invalid_tool_request_count\": 0,\n  \"npu_deterministic_tool_fallback_used\": false,\n  \"npu_deterministic_tool_fallback_count\": 0,\n  \"gpu_review_blocked\": false\n}\n",
      "stderr_tail": "",
      "classification": "usable_audit_text",
      "provider_execution_requested": true,
      "provider_load_attempted": true,
    ...
    {
      "round": 8,
      "checkpoint": "output/ai_pipeline/full_toolbox_20260503-151613_checkpoints/round_008.json",
      "audit_output": "output/ai_pipeline/full_toolbox_20260503-151613_checkpoints/round_008_npu_async_audit.json",
      "started_at": "2026-05-03T15:20:40",
      "status": "finished",
      "command": [
        "C:\\Python314\\python.exe",
        "Tools/ai/run_npu_gpu_deep_review_auditor.py",
        ...
        ".",
        "--gpu-review",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_008.json",
        "--output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_008_npu_async_audit.json",
        "--markdown-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_008_npu_async_audit.md",
        "--context-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_008_npu_async_audit_context.md",
        "--npu-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_008_npu_async_audit_npu.md",
        "--npu-notes-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_008_npu_async_audit_npu_notes.md",
        "--npu-metadata-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_008_npu_async_audit_metadata.json",
        "--timeout-seconds",
        "420",
        "--max-context-chars",
        "8000",
      ...
      "npu_lane_mode_at_launch": "slow",
      "npu_effective_auditor_every_rounds_at_launch": 4,
      "finished_at": "2026-05-03T15:22:24",
      "returncode": 0,
      "stdout_tail": "{\n  \"passed\": true,\n  \"output\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_pipeline\\\\full_toolbox_20260503-151613_checkpoints\\\\round_008_npu_async_audit.json\",\n  \"markdown\": \"C:\\\\Users\\\\carmi\\\\blender\\\\blender-audio-project\\\\output\\\\ai_pipeline\\\\full_toolbox_20260503-151613_checkpoints\\\\round_008_npu_async_audit.md\",\n  \"npu_python\": \"C:\\\\Users\\\\carmi\\\\blender\\\\venvs\\\\blender-npu-ai\\\\Scripts\\\\python.exe\",\n  \"npu_python_exists\": true,\n  \"provider_execution_requested\": true,\n  \"provider_load_attempted\": true,\n  \"provider_execution_succeeded\": true,\n  \"provider_empty_response\": false,\n  \"dependency_missing\": false,\n  \"patch_application_performed\": false,\n  \"non_blocking\": true,\n  \"classification\": \"usable_audit_text\",\n  \"runtime_tool_context_seen\": false,\n  \"runtime_tool_context_report_count\": 0,\n  \"tool_request_count\": 0,\n  \"valid_tool_request_count\": 0,\n  \"invalid_tool_request_count\": 0,\n  \"npu_deterministic_tool_fallback_used\": false,\n  \"npu_deterministic_tool_fallback_count\": 0,\n  \"gpu_review_blocked\": false\n}\n",
      "stderr_tail": "",
      "classification": "usable_audit_text",
      "provider_execution_requested": true,
      "provider_load_attempted": true,
    ...
    {
      "round": 12,
      "checkpoint": "output/ai_pipeline/full_toolbox_20260503-151613_checkpoints/round_012.json",
      "audit_output": "output/ai_pipeline/full_toolbox_20260503-151613_checkpoints/round_012_npu_async_audit.json",
      "started_at": "2026-05-03T15:22:26",
      "status": "finished",
      "command": [
        "C:\\Python314\\python.exe",
        "Tools/ai/run_npu_gpu_deep_review_auditor.py",
        ...
        ".",
        "--gpu-review",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_012.json",
        "--output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_012_npu_async_audit.json",
        "--markdown-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_012_npu_async_audit.md",
        "--context-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_012_npu_async_audit_context.md",
        "--npu-output",
        "C:\\Users\\carmi\\blender\\blender-audio-project\\output\\ai_pipeline\\full_toolbox_20260503-151613_checkpoints\\round_012_npu_async_audit_npu.md",
        "--npu-notes-output",
        "C:\\Users\\carmi\\blender\\blender-
```
...
- Suffix: `.json`
- Size bytes: `103104`
- SHA-256: `015b555fe9aae022df346cdeb5d0f11996baa6b5c8570f820e86f79c634ca0d5`
- Content included: `True`
- Content truncated: `True`
  ...
  "recommendations": [
    {
      ...
      "tool_evidence": [
        {
          "path": "output/analysis/code_interpreter_full_toolbox_20260503-151613.json",
          "kind": "code_interpreter_report",
          "passed": true,
        ...
        {
          "path": "output/validation/python_line_count_full_toolbox_20260503-151613.json",
          "kind": "python_line_count_csv",
          "passed": true,
          "tool_request_count": null,
          "tool_execution_count": null,
        ...
        {
          "path": "output/validation/python_syntax_full_toolbox_20260503-151613.json",
          "kind": "python_syntax",
          "passed": true,
          "tool_request_count": null,
          "tool_execution_count": null,
        ...
        {
          "path": "output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-151613.json",
          "kind": "gpu_planner_json_contract_smoke",
          "passed": true,
          "tool_request_count": null,
          "tool_execution_count": null,
        ...
        {
          "path": "output/validation/deterministic_recommendation_synthesizer_smoke_full_toolbox_20260503-151613.json",
          "kind": "deterministic_recommendation_synthesizer_smoke",
          "passed": true,
          "tool_request_count": null,
          "tool_execution_count": null,
        ...
        {
          "path": "output/validation/agent_review_decision_loop_smoke_full_toolbox_20260503-151613.json",
          "kind": "agent_review_decision_loop_smoke",
          "passed": true,
          "tool_request_count": null,
          "tool_execution_count": null,
        ...
        {
          "path": "output/validation/npu_provider_environment_full_toolbox_20260503-151613.json",
          "kind": "npu_provider_environment",
          "passed": true,
          "tool_request_count": null,
          "tool_execution_count": null,
        ...
        {
          "path": "output/analysis/gpu_json_contract_replay_full_toolbox_20260503-151613.json",
          "kind": "gpu_planner_json_contract_replay",
          "passed": true,
          "tool_request_count": null,
          "tool_execution_count": null,
        ...
        {
          "path": "output/analysis/gpu_npu_run_sync_full_toolbox_20260503-151613.json",
          "kind": "gpu_npu_run_sync_analysis",
          "passed": true,
          "tool_request_count": null,
          "tool_execution_count": null,
        ...
        {
          "path": "output/validation/full_memory_tool_regeneration_20260503-151613_workflow.json",
          "kind": "full_memory_tool_regeneration_workflow",
          "passed": true,
          "tool_request_count": null,
          "tool_execution_count": null,
...
### `output/ai_pipeline/full_toolbox_20260503-151613_deterministic_recommendations.md`
...
- Suffix: `.json`
- Size bytes: `34787`
- SHA-256: `7829319ee68f5105f376eeae10a51ad5df2689df37051637faaef5f1b432fbc0`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  ...
  "gpu_runtime_tool_request_count": 80,
  ...
  "runtime_tool_provider_request_count": 80,
  ...
  "checkpoint_dir": "output/ai_pipeline/full_toolbox_20260503-151613_checkpoints",
  "npu_audit_count": 6,
  "npu_audit_success_count": 6,
...
### `output/ai_pipeline/full_toolbox_20260503-151613_orchestrator.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `2674`
- SHA-256: `09f2c97c30b065f76c56fc3a3f78725281a5a66239dbf9ecbf22e924b1d01461`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.json`
- Size bytes: `93490`
- SHA-256: `278cc42cc6bf5583c775a3301c480e50a7c1dc6ee6f0a1faea9429d09d99df90`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "agent_gpu_deep_planning_supervised",
  "generated_at": "2026-05-03T15:28:01",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": false,
  "errors": [
  ...
  "rounds": [
    ...
    },
    {
      ...
      "provider_tool_request_c
```

### `output/ai_pipeline/full_toolbox_20260503-151613_parallel_gpu.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1053`
- SHA-256: `2e47d556910c739f76f68b51d3e1f7daaf62d8a5831b340c794b717db2edbc7b`
- Content included: `True`
- Content truncated: `False`
...
### `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_20260503-151613.csv`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.csv`
- Size bytes: `14752`
- SHA-256: `4f613ed90c255adf76e18ecee2b13685eb6d760df7f40e29c87a7ee5d4b806d5`
- Content included: `True`
- Content truncated: `True`
...
### `docs/LOCAL_VALIDATION_EVIDENCE/python_line_count_20260503-151627.csv`
...
- Suffix: `.sqlite`
- Size bytes: `536576`
- SHA-256: `a8742011315b5f81a3d2106bd90faa727ea260e9affffceb78bdaa221d12bb25`
...
### `output/validation/agent_review_decision_loop_smoke_full_toolbox_20260503-151613.md`
...
### `output/validation/deterministic_recommendation_synthesizer_smoke_full_toolbox_20260503-151613.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `3661`
- SHA-256: `ddda08cf43020e735fc18963ad12fcf2f261133e63d485365c0470754692424e`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- profile: `full_refactor`
- broker_request_written: `output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613_tool_requests.json`
- provider_execution_performed: `False`
- patch_application_performed: `False`
- sqlite_write_performed: `False`
- persistent_memory_write_performed: `False`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_memory_routing_policy_smoke.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_operational_memory_status.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1334`
- SHA-256: `9eae2d3700183d3716dcee3b907d810e232846e607ba0253747f0d4daf945239`
- Content included: `True`
- Content truncated: `False`
...
```json
{
  "record_count": 51,
  "kind_counts": {
    "operational_context": 51
  },
  "role_counts": {
    "runtime_planner_note": 31,
    "doctor_tool": 19,
    "post_pr156_provider_runner": 1
  }
}
```
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_persistent_memory_status.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1362`
- SHA-256: `3d4289b9b8088d3de07e5983da333093e60dad581c39f219adf91ca87745af22`
- Content included: `True`
- Content truncated: `False`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_python_line_count.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1771`
- SHA-256: `7bb62ab0a4166f5f31e0fb1a758b182d33519485a493cd9203d06ef4f3c63d16`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- CSV: `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_20260503-151613.csv`
- File count: `307`
- Total lines: `88645`
- Provider execution performed: `False`
- Patch application performed: `False`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `8262`
- SHA-256: `70b7abb4e6b3be5c1768b0da228b91fa5ead901a3bd97f1ecf8c9eae23ce105a`
- Content included: `True`
- Content truncated: `False`
...
- persistent_memory_write_performed: `False`
- operational_sqlite_write_performed: `True`
- operational_sqlite_write_count: `2`
- operational_memory_clear_count: `0`
- blender_runtime_execution_performed: `False`

## Tool results

### `persistent_memory_status` — `runtime_sqlite_memory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/persistent_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/persistent_memory_status_runtime_sqlite_memory.md'}`

### `operational_memory_status` — `runtime_sqlite_memory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_status_runtime_sqlite_memory.md'}`

### `persistent_memory_search_01` — `runtime_sqlite_memory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/persistent_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/persistent_memory_search_01_runtime_sqlite_memory.md'}`

### `persistent_memory_search_02` — `runtime_sqlite_memory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/persistent_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/persistent_memory_search_02_runtime_sqlite_memory.md'}`

### `operational_memory_search_01` — `runtime_sqlite_memory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_search_01_runtime_sqlite_memory.md'}`

### `operational_memory_search_02` — `runtime_sqlite_memory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_search_02_runtime_sqlite_memory.md'}`

### `operational_memory_remember_01` — `runtime_sqlite_memory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_remember_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_remember_01_runtime_sqlite_memory.md'}`

### `operational_memory_remember_02` — `runtime_sqlite_memory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_remember_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/operational_memory_remember_02_runtime_sqlite_memory.md'}`

### `agent_memory_inventory` — `build_agent_memory_inventory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/agent_memory_inventory_agent_memory_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/agent_memory_inventory_agent_memory_inventory.md'}`

### `agnostic_tool_inventory` — `build_agent_agnostic_tool_inventory`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/agnostic_tool_inventory_agent_agnostic_tool_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/agnostic_tool_inventory_agent_agnostic_tool_inventory.md'}`

### `transient_request_context` — `build_agent_transient_request_context`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/transient_request_context_agent_transient_request_context.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/transient_request_context_agent_transient_request_context.md'}`

### `python_line_count_inventory` — `build_python_line_count_csv`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/python_line_count_inventory_python_line_count.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/python_line_count_inventory_python_line_count.md', 'csv_output': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/python_line_count_inventory_python_line_count.csv'}`

### `code_interpreter_report` — `build_code_interpreter_report`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/code_interpreter_report_code_interpreter_report.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/code_interpreter_report_code_interpreter_report.md'}`

### `refactor_duplication_audit` — `build_refactor_duplication_audit`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/refactor_duplication_audit_refactor_duplication_audit.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/refactor_duplication_audit_refactor_duplication_audit.md'}`

### `python_syntax_check` — `check_python_syntax`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/python_syntax_check_python_syntax.json'}`

### `gpu_contract_smoke` — `run_gpu_planner_json_contract_smoke`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/gpu_contract_smoke_gpu_planner_json_contract_smoke.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/gpu_contract_smoke_gpu_planner_json_contract_smoke.md'}`

### `validation_report_contract` — `check_validation_report_contract`

- Executed: `True`
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-151613/validation_report_contract_validation_report_contract.json'}`
...
### `output/validation/full_memory_tool_regeneration_20260503-151613_runtime_tool_broker_smoke.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `224`
- SHA-256: `9991df240334539cad8abacefa03a838e43aefe74e136c44aad4cfb9c6779c0a`
- Content included: `True`
- Content truncated: `False`
