...
- source: `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_capability_manifest_20260503-223900.md`
- source_sha256: `f14c2e596af21f9cde191c8b61b0489b2a8d55927bd7cff19391fd05e806c216`
- line_start: `1`
- line_end: `191`
...
Chunk deterministico. Sezioni: Runtime Tool Capability Manifest; Cloud handoff policy; Caller modes; Tools; `build_agent_agnostic_tool_inventory`. Preview: # Runtime Tool Capability Manifest - Passed: `True` - Tool count: `10` - Provider execution performed: `False` - Patch application performed: `False` ## Cloud handoff policy - `include_with_evidence_chunks`: `True` - `include_runtime_usage_telemetry`: `True` -...
