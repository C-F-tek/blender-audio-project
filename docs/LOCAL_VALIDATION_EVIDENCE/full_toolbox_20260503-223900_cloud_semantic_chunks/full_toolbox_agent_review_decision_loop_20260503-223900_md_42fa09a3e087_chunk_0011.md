...
- previous_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-223900_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-223900_md_42fa09a3e087_chunk_0010.md`
- next_chunk_file: `docs/LOCAL_VALIDATION_EVIDENCE/full_toolbox_20260503-223900_cloud_semantic_chunks/full_toolbox_agent_review_decision_loop_20260503-223900_md_42fa09a3e087_chunk_0012.md`
- summary_source: `ollama`

## Local chunk summary

**Scopo**: Eseguire un smoke‑test del wrapper `agent_review_decision_loop`, verificando che l’evidenza di sufficienza e i risultati GPU/NPU siano correttamente elaborati e che il ciclo di decisione generi un piano di patch manuale.  

**Segnali principali**: creazione di fixture JSON (`evidence.json`, `gpu.json`, `orchestrator.json`), esecuzione di comandi con timeout, raccolta di stdout/stderr, scrittura di
