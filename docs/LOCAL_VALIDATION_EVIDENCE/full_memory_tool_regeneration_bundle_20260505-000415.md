...
- Generated at: `2026-05-05T00:04:40`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_agent_memory_inventory.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_agnostic_tool_inventory.json`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_persistent_memory_status.json`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_operational_memory_status.json`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_memory_routing_policy.json`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_runtime_tool_broker.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_transient_request_context.json`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_python_line_count.json`
...
### `output/analysis/full_memory_tool_regeneration_20260505-000415_code_interpreter.json`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_python_syntax.json`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_validation_report_contract.json`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_runtime_tool_broker_smoke.json`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_memory_routing_policy_smoke.json`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_agent_memory_inventory.json` exists=`True` size=`13163` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_agnostic_tool_inventory.json` exists=`True` size=`560183` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_persistent_memory_status.json` exists=`True` size=`1779` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_operational_memory_status.json` exists=`True` size=`1702` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_memory_routing_policy.json` exists=`True` size=`8925` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_runtime_tool_broker.json` exists=`True` size=`98106` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_transient_request_context.json` exists=`True` size=`9178` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_python_line_count.json` exists=`True` size=`3181` suffix=`.json` preview_chars=`1500`
- `output/analysis/full_memory_tool_regeneration_20260505-000415_code_interpreter.json` exists=`True` size=`1280610` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_python_syntax.json` exists=`True` size=`38308` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_validation_report_contract.json` exists=`True` size=`3417` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260505-000415_workflow.json` exists=`True` size=`4743` suffix=`.json` preview_chars=`1500`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_agent_memory_inventory.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `6707`
- SHA-256: `e3ee4640f0a4cee465e89d6ed2507c84cbb1d3434917171f8d834bc883f47a8d`
- Content included: `True`
- Content truncated: `False`
...
- `memory_records` rows=`28` columns=`12`
...
### 7ade06355c6c56d9c850 - output/ai_pipeline/full_context_golden_enrichment_plan.json

- Kind: `source_file`
- Scope: `project`
- Score: `18.0`

{ "schema_version": 1, "kind": "local_ai_enrichment_plan", "generated_at": "2026-05-04T18:48:43.803672+00:00", "repo_root": "C:/Users/carmi/blender/blender-audio-project", "objective": "Run full-context local AI/NPU golden path and plan controlled complexity escalation while preserving Ollama/GPU as primary advisory and NPU as knowledge broker.", "task_file": "docs/LOCAL_AI_TASKS/shared-runtime-toolbox-ai-to-ai-next-task-2026-05-03.md", "profile": "npu", "basename": "full_context_golden_enrichment_plan", "apply_mode": "report_only", "provider_execution_performed": false, "source_writes_performed": false, "patch_application_performed": false, "complexity": { "level": "high", "score": 16, "matched_terms": [ "architecture", "broker", "context", "full-context", "gpu", "knowledge", "npu", "ollama", "patch", "provider" ], "task_text_chars_sampled": 8000 }, "lane_policy": { "primary_advisory...
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_agnostic_tool_inventory.md`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_persistent_memory_status.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1362`
- SHA-256: `a77bea806c59b9fde64c2365be8a5de0f33c23f9ed80f22f81908a7df52e3bde`
- Content included: `True`
- Content truncated: `False`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_operational_memory_status.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1295`
- SHA-256: `f33dd8eee6ba543baf3ca8451e7c841a3f1446c0a37e35cd6760317e59f4df75`
- Content included: `True`
- Content truncated: `False`
...
```json
{
  "record_count": 16,
  "kind_counts": {
    "operational_context": 16
  },
  "role_counts": {
    "runtime_planner_note": 12,
    "doctor_tool": 4
  }
}
```
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_memory_routing_policy.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `3669`
- SHA-256: `74b3239d2636b8df061af51463a992ddf0c15c546bacedaa5b58bc5f6ad63932`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- profile: `full_refactor`
- broker_request_written: `output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415_tool_requests.json`
- provider_execution_performed: `False`
- patch_application_performed: `False`
- sqlite_write_performed: `False`
- persistent_memory_write_performed: `False`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_runtime_tool_broker.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `8262`
- SHA-256: `aeebb8c60d728aa756faad828fa32426771b67bf66f3da7a16575b813b97cca2`
- Content included: `True`
- Content truncated: `False`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/persistent_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/persistent_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/persistent_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/persistent_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/persistent_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/persistent_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_remember_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_remember_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_remember_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/operational_memory_remember_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/agent_memory_inventory_agent_memory_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/agent_memory_inventory_agent_memory_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/agnostic_tool_inventory_agent_agnostic_tool_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/agnostic_tool_inventory_agent_agnostic_tool_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/transient_request_context_agent_transient_request_context.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/transient_request_context_agent_transient_request_context.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/python_line_count_inventory_python_line_count.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/python_line_count_inventory_python_line_count.md', 'csv_output': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/python_line_count_inventory_python_line_count.csv'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/code_interpreter_report_code_interpreter_report.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/code_interpreter_report_code_interpreter_report.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/refactor_duplication_audit_refactor_duplication_audit.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/refactor_duplication_audit_refactor_duplication_audit.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/python_syntax_check_python_syntax.json'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/gpu_contract_smoke_gpu_planner_json_contract_smoke.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/gpu_contract_smoke_gpu_planner_json_contract_smoke.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260505-000415/validation_report_contract_validation_report_contract.json'}`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_transient_request_context.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1754`
- SHA-256: `8857f178d6832c821889ae3b1c97892c157169936ecd50dd519f58c30517ab00`
- Content included: `True`
- Content truncated: `False`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_agent_memory_inventory.json` kind=`agent_memory_inventory` passed=`True` error=``
- `output/ai_pipeline/full_memory_tool_regeneration_20260505-000415_agnostic_tool_inventory.json` kind=`agent_agnostic_tool_inventory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260505-000415_persistent_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260505-000415_operational_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260505-000415_memory_routing_policy.json` kind=`agent_memory_routing_policy` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260505-000415_runtime_tool_broker.json` kind=`agent_runtime_tool_broker` passed=`True` error=``
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_python_line_count.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1781`
- SHA-256: `92695867753e75ab7208a2acddbc06d9a0a75068a11aafe13e1a8f748c529a0f`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- CSV: `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_20260505-000415.csv`
- File count: `325`
- Total lines: `95377`
- Provider execution performed: `False`
- Patch application performed: `False`
...
### `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_20260505-000415.csv`
...
### `output/analysis/full_memory_tool_regeneration_20260505-000415_code_interpreter.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `7327`
- SHA-256: `e94b3d8c24deec28060985ec93aa443af87d637676ed3dae74ff1c7ecb74ecc0`
- Content included: `True`
- Content truncated: `False`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_runtime_tool_broker_smoke.md`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_memory_routing_policy_smoke.md`
...
### `output/validation/full_memory_tool_regeneration_20260505-000415_workflow.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `2956`
- SHA-256: `3fbb9a13cfb828df9379b18cef88db8a754385032cfe80d3e6502bcd5134acfc`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.sqlite`
- Size bytes: `180224`
- SHA-256: `f2021f1b24001df19caaf08fa15312d5a36ce175abebef4c0300739e1fe64203`
