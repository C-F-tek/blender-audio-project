...
- Generated at: `2026-05-02T14:19:22`
...
### `output/validation/agent_review_code_patch_plan_smoke_built_pr109.json`
...
- `output/validation/agent_review_code_patch_plan_smoke_built_pr109.json` exists=`True` size=`1203` suffix=`.json` preview_chars=`1164`
...
### `output/patch_specs/agent_review_code_patch_plan_fixture_built.md`

- Role: `explicit_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1292`
- SHA-256: `d369eb445cd9b03cf2ded5815d45ce35a0f0a9dc7c7c6ad2797dbf453177dfc2`
- Content included: `True`
- Content truncated: `False`
...
### `output/patch_specs/agent_review_code_docs_followup_pr109.md`

- Role: `explicit_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1078`
- SHA-256: `a050d24a403503b5226fbe5ac72e4a5f68d612f26cb8a944e6a7f4ba3a557311`
- Content included: `True`
- Content truncated: `False`

```text
# Agent Review Code Docs Follow-up

- Passed: `True`
- Apply mode: `report_only_manual_review_docs_followup`
- Manual review required: `True`
- Provider execution performed: `False`
- Patch application performed: `False`
- Source writes performed: `False`
...
### `docs_followup_001` from `code_contract_001`

- Status: `candidate_for_manual_review`
- Target docs: `Tools/validation/README.md, docs/JSON_SCHEMAS.md`
- Missing candidate docs: `docs/CONTRACT_DRIFT_VALIDATION.md`
...
- Strategy: After the code patch is reviewed, update only the affected docs with a narrow cross-reference, schema note, validator command or workflow note. Do not duplicate full contracts and do not apply documentation edits automatically.
...
### `docs/LOCAL_AI_TASKS/build-analysis-input-bundle.md`

- Role: `explicit_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `5370`
- SHA-256: `aa47974a223335e1899d37b3add00b64dbe29d27d9e2aafef36131bb8ce81cbc`
- Content included: `True`
- Content truncated: `False`
