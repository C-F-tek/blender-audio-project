...
- Broker runtime tool executions: `11`
...
- Usage observed: `{'count': 6, 'executed': 6, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.0}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- `Tools/ai/build_runtime_tool_usage_telemetry.py` role=`runtime_tool_usage_telemetry_builder` exists=`True` sha256=`6fe5635044e9859c3fd6d01f748699a8ac1d60352c04451eb6871a64e135463e`
...
- `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_usage_telemetry_wrapper_mesh_probe_20260507-022831.json` role=`observed_runtime_tool_usage_report` exists=`True` sha256=`7736f1b8906443e7fac3258f94ce3da1c7ed7312ed99be491b32708a98a2b3d8`
