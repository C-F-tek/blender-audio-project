...
- Allowed args: `[]`
- Usage observed: `{'count': 8, 'executed': 8, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.0}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Usage observed: `{'count': 10, 'executed': 10, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.0}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_usage_telemetry_patch_notes_full0to10_provider2_20260507-141000.json` role=`observed_runtime_tool_usage_report` exists=`True` sha256=`4bacbb061400243bb96d83d4dc1b4807913cb9d67714696907d9aeccb5e9459c`
