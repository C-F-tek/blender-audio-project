...
- Generated at: `2026-05-02T14:26:30`
...
### `output/validation/code_edit_proposal_smoke_pr109.json`
...
- Patch application performed: `False`
- Source writes performed: `False`
- Warnings: `['target_metadata.sha256 is null; regenerate proposal from local filesystem for stronger review evidence', 'target_metadata.line_count is null; regenerate proposal from local filesystem for stronger review evidence']`
...
- `output/analysis/code_interpreter_report_pr109.json` exists=`True` size=`616554` suffix=`.json` preview_chars=`1500`
- `output/validation/artifact_domain_registry_pr109.json` exists=`True` size=`11762` suffix=`.json` preview_chars=`1500`
- `output/validation/code_edit_proposal_smoke_pr109.json` exists=`True` size=`2516` suffix=`.json` preview_chars=`1500`
- `output/validation/agent_review_code_patch_plan_with_static_smoke_pr109.json` exists=`True` size=`7649` suffix=`.json` preview_chars=`1500`
...
- Suffix: `.md`
- Size bytes: `6916`
- SHA-256: `6ae0bcd98d2044f6cdd399d3e22bb499b0f89c9117991392336fc047b80bac42`
...
- `Tools/validation/check_ai_context_pack_contract.py` — `425` lines, risk `medium`

## Recommendations

- `code_static_001` `Tools/ai/agent_memory_policy.py` risk `medium`: complex functions detected
- `code_static_002` `Tools/ai/agent_state.py` risk `medium`: 
- `code_static_003` `Tools/ai/artifact_domain_registry.py` risk `medium`: complex functions detected
- `code_static_004` `Tools/ai/build_agent_agnostic_tool_inventory.py` risk `medium`: complex functions detected
- `code_static_005` `Tools/ai/build_agent_memory_inventory.py` risk `medium`: large functions detected
- `code_static_006` `Tools/ai/build_agent_review_patch_plan.py` risk `medium`: large functions detected, complex functions detected
- `code_static_007` `Tools/ai/build_ai_context_pack.py` risk `medium`: complex functions detected
- `code_static_008` `Tools/ai/build_code_interpreter_report.py` risk `medium`: TODO/FIXME markers detected
...
- `code_static_011` `Tools/ai/build_github_evidence_bundle.py` risk `medium`: complex functions detected
- `code_static_012` `Tools/ai/build_local_ai_enrichment_plan.py` risk `medium`: large functions detected
- `code_static_013` `Tools/ai/build_music_intermediates.py` risk `medium`: large functions detected, complex functions detected
- `code_static_014` `Tools/ai/build_patch_specs_from_proposals.py` risk `medium`: large functions detected, complex functions detected
- `code_static_015` `Tools/ai/build_repository_change_proposals.py` risk `medium`: large functions detected, complex functions detected
- `code_static_016` `Tools/ai/build_selective_execution_plan.py` risk `medium`: large functions detected, complex functions detected
- `code_static_017` `Tools/ai/build_workload_quality_lane_routing.py` risk `medium`: complex functions detected
- `code_static_018` `Tools/ai/check_local_resource_lanes.py` risk `medium`: complex functions detected
- `code_static_019` `Tools/ai/check_npu_provider_environment.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_020` `Tools/ai/code_patch_plan_common.py` risk `medium`: complex functions detected
- `code_static_021` `Tools/ai/model_json.py` risk `medium`: complex functions detected
- `code_static_022` `Tools/ai/pipeline/preflight.py` risk `medium`: complex functions detected
- `code_static_023` `Tools/ai/pipeline/remediation.py` risk `medium`: large functions detected, complex functions detected, TODO/FIXME markers detected
- `code_static_024` `Tools/ai/pipeline/steps.py` risk `medium`: large functions detected
- `code_static_025` `Tools/ai/promote_patch_spec_draft.py` risk `medium`: large functions detected, complex functions detected
- `code_static_026` `Tools/ai/refine_megalithic_review_signals.py` risk `medium`: 
- `code_static_027` `Tools/ai/review_wave_entrypoints.py` risk `medium`: large functions detected, complex functions detected
- `code_static_028` `Tools/ai/run_agent_gpu_deep_planning_review.py` risk `medium`: large functions detected, complex functions detected
- `code_static_029` `Tools/ai/run_agent_gpu_deep_planning_supervised.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_030` `Tools/ai/run_agent_gpu_npu_parallel_orchestrator.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_031` `Tools/ai/run_local_provider_probe.py` risk `medium`: complex functions detected
- `code_static_032` `Tools/ai/run_megalithic_repo_review.py` risk `medium`: complex functions detected
- `code_static_033` `Tools/ai/run_npu_decode_smoke_diagnostic.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_034` `Tools/ai/run_npu_gpu_deep_review_auditor.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_035` `Tools/ai/run_pipeline_dry_run_matrix.py` risk `medium`: large functions detected, static risk calls detected
- `code_static_036` `Tools/ai/select_semantic_code_chunks.py` risk `medium`: large functions detected, complex functions detected
- `code_static_037` `Tools/ai/smart_ai_gatekeeper.py` risk `medium`: complex functions detected, TODO/FIXME markers detected
- `code_static_038` `Tools/ai/suggest_repository_updates.py` risk `medium`: complex functions detected
- `code_static_039` `Tools/ai/validate_ai_artifacts.py` risk `medium`: complex functions detected
- `code_static_040` `Tools/validation/ai_pipeline_report_contracts.py` risk `medium`: large functions detected, complex functions detected
...
- Suffix: `.md`
- Size bytes: `23134`
- SHA-256: `e291a239abf2d230e4a0ae17ab959113aac6e374061b9b1d6fbee40c5d67f2fb`
- Content included: `True`
...
- Rationale: Static code interpreter recommendation `code_static_002` flagged `Tools/ai/agent_state.py` for manual review: static interpreter review signal.
...
- Rationale: Static code interpreter recommendation `code_static_004` flagged `Tools/ai/build_agent_agnostic_tool_inventory.py` for manual review: complex functions detected.
...
- Rationale: Static code interpreter recommendation `code_static_006` flagged `Tools/ai/build_agent_review_patch_plan.py` for manual review: large functions detected, complex functions detected.
...
- Rationale: Static code interpreter recommendation `code_static_007` flagged `Tools/ai/build_ai_context_pack.py` for manual review: complex functions detected.
...
- Rationale: Static code interpreter recommendation `code_static_008` flagged `Tools/ai/build_code_interpreter_report.py` for manual review: TODO/FIXME markers detected.
...
- Rationale: Static code interpreter recommendation `code_static_009` flagged `Tools/ai/build_dry_run_matrix_evidence_bundle.py` for manual review: complex functions detected.
...
- Rationale: Static code interpreter recommendation `code_static_010` flagged `Tools/ai/build_full_context_golden_proposals.py` for manual review: large functions detected.
...
- Rationale: Static code interpreter recommendation `code_static_011` flagged `Tools/ai/build_github_evidence_bundle.py` for manual review: complex functions detected.
...
- Rationale: Static code interpreter recommendation `code_static_012` flagged `Tools/ai/build_local_ai_enrichment_plan.py` for manual review: large functions detected.
...
- Rationale: Static code interpreter recommendation `code_static_013` flagged `Tools/ai/build_music_intermediates.py` for manual review: large functions detected, complex functions detected.
...
- Rationale: Static code interpreter recommendation `code_static_014` flagged `Tools/ai/build_patch_specs_from_proposals.py` for manual review: large functions detected, complex functions detected.
...
- Rationale: Static code interpreter recommendation `code_static_015` flagged `Tools/ai/build_repository_change_proposals.py` for manual review: large functions detected, complex functions detected.
