...
### `output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-160523.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy_smoke.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_operational_memory_status.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_persistent_memory_status.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_python_line_count.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker_smoke.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_validation_report_contract.json`
...
### `output/analysis/full_memory_tool_regeneration_20260503-160523_code_interpreter.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agent_memory_inventory.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agnostic_tool_inventory.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_transient_request_context.json`
...
- `output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-160523.json` exists=`True` size=`477752` suffix=`.json` preview_chars=`1500`
...
- `output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy.json` exists=`True` size=`8925` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-160523_operational_memory_status.json` exists=`True` size=`1743` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-160523_persistent_memory_status.json` exists=`True` size=`1779` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-160523_python_line_count.json` exists=`True` size=`3171` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json` exists=`True` size=`36413` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json` exists=`True` size=`98107` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-160523_validation_report_contract.json` exists=`True` size=`3417` suffix=`.json` preview_chars=`1500`
...
- `output/analysis/full_memory_tool_regeneration_20260503-160523_code_interpreter.json` exists=`True` size=`1180077` suffix=`.json` preview_chars=`1500`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agent_memory_inventory.json` exists=`True` size=`14604` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agnostic_tool_inventory.json` exists=`True` size=`506279` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_transient_request_context.json` exists=`True` size=`9176` suffix=`.json` preview_chars=`1500`
...
### `output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-160523.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `133095`
- SHA-256: `4fd35a3bc9245a7c05e3d9ef0f25eae2817873d752709cd376e67e2d31570661`
- Content included: `True`
- Content truncated: `True`
...
- output/validation/shared_toolbox_python_syntax_20260503-160523.json: optional report missing
- output/analysis/shared_toolbox_code_interpreter_20260503-160523.json: optional report missing
- output/validation/shared_toolbox_gpu_contract_smoke_20260503-160523.json: optional report missing
- output/validation/shared_toolbox_gpu_routing_20260503-160523.json: optional report missing
- output/validation/shared_toolbox_npu_execution_20260503-160523.json: optional report missing
- output/validation/shared_toolbox_npu_contract_20260503-160523.json: optional report missing
- output/validation/npu_provider_environment_shared_toolbox_20260503-160523.json: optional report missing
- output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-160523_orchestrator.json: optional report missing
- output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-160523_gpu.json: optional report missing
- output/analysis/shared_toolbox_gpu_npu_sync_20260503-160523.json: optional report missing
- output/analysis/shared_toolbox_gpu_contract_replay_20260503-160523.json: optional report missing
- output/analysis/shared_toolbox_code_interpreter_20260503-160523.md: optional artifact missing
- output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-160523_orchestrator.md: optional artifact missing
- output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-160523_gpu.md: optional artifact missing
- output/analysis/shared_toolbox_gpu_npu_sync_20260503-160523.md: optional artifact missing
- output/analysis/shared_toolbox_gpu_contract_replay_20260503-160523.md: optional artifact missing
- output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-160523.md: optional artifact missing
...
- Enabled: `True`
- Discovered reports: `27`
- Discovered artifacts: `21`

## Chunked large JSON/Markdown files

- output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-160523.json lines=345 chunks=2 chunk_size=200
  - output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-160523.json#L1-L200 -> next: output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-160523.json#L201-L345
  - output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-160523.json#L201-L345 -> next: END
- output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy.json lines=244 chunks=2 chunk_size=200
  - output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy.json#L1-L200 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy.json#L201-L244
  - output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy.json#L201-L244 -> next: END
- output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json lines=1572 chunks=8 chunk_size=200
  - output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L1-L200 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L201-L400
  - output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L201-L400 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L401-L600
  - output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L401-L600 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L601-L800
  - output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L601-L800 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L801-L1000
  - output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L801-L1000 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L1001-L1200
  - output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L1001-L1200 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L1201-L1400
  - output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L1201-L1400 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L1401-L1572
  - output/validation/full_memory_tool_regeneration_20260503-160523_python_syntax.json#L1401-L1572 -> next: END
- output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json lines=1195 chunks=6 chunk_size=200
  - output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L1-L200 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L201-L400
  - output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L201-L400 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L401-L600
  - output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L401-L600 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L601-L800
  - output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L601-L800 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L801-L1000
  - output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L801-L1000 -> next: output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L1001-L1195
  - output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json#L1001-L1195 -> next: END
- output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-160523.json lines=214 chunks=2 chunk_size=200
  - output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-160523.json#L1-L200 -> next: output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-160523.json#L201-L214
  - output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-160523.json#L201-L214 -> next: END
- output/validation/python_syntax_full_toolbox_20260503-160523.json lines=1572 chunks=8 chunk_size=200
  - output/validation/python_syntax_full_toolbox_20260503-160523.json#L1-L200 -> next: output/validation/python_syntax_full_toolbox_20260503-160523.json#L201-L400
  - output/validation/python_syntax_full_toolbox_20260503-160523.json#L201-L400 -> next: output/validation/python_syntax_full_toolbox_20260503-160523.json#L401-L600
  - output/validation/python_syntax_full_toolbox_20260503-160523.json#L401-L600 -> next: output/validation/python_syntax_full_toolbox_20260503-160523.json#L601-L800
  - output/validation/python_syntax_full_toolbox_20260503-160523.json#L601-L800 -> next: output/validation/python_syntax_full_toolbox_20260503-160523.json#L801-L1000
  - output/validation/python_syntax_full_toolbox_20260503-160523.json#L801-L1000 -> next: output/validation/python_syntax_full_toolbox_20260503-160523.json#L1001-L1200
  - output/validation/python_syntax_full_toolbox_20260503-160523.json#L1001-L1200 -> next: output/validation/python_syntax_full_toolbox_20260503-160523.json#L1201-L1400
  - output/validation/python_syntax_full_toolbox_20260503-160523.json#L1201-L1400 -> next: output/validation/python_syntax_full_toolbox_20260503-160523.json#L1401-L1572
  - output/validation/python_syntax_full_toolbox_20260503-160523.json#L1401-L1572 -> next: END
- output/analysis/code_interpreter_full_toolbox_20260503-160523.json lines=52413 chunks=263 chunk_size=200
  - output/analysis/code_interpreter_full_toolbox_20260503-160523.json#L1-L200 -> next: output/analysis/code_interpreter_full_toolbox_20260503-160523.json#L201-L400
  - output/analysis/code_interpreter_full_toolbox_20260503-160523.json#L201-L400 -> next: output/analysis/code_interpreter_full_toolbox_20260503-160523.json#L401-L600
  - output/analysis/code_interpreter_full_toolbox_20260503-160523.json#L401-L600 -> next: output/analysis/code_interpreter_full_toolbox_20260503-160523.json#L601-L800
  - output/analysis/code_interpreter_full_toolbox_20260503-160523.json#L601-L800 -> next: output/analysis/code_interpreter_full_toolbox_20260503-160523.json#L801-L1000
  - output/analysis/code_interpreter_full_toolbox_20260503-160523.json#L801-L1000
```
...
- Suffix: `.json`
- Size bytes: `1362332`
- SHA-256: `5a2acc72d149d263695bbad53d4378650d2d27a08ba24748b4a022feaa5c9c27`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "code_interpreter_report",
  "generated_at": "2026-05-03T16:05:40",
  ...
  "file_count": 264,
  "parsed_file_count": 264,
  "total_lines": 73064,
  "total_functions": 2567,
  "total_classes": 92,
  "total_risk_signals": 54,
  "total_todos": 21,
  "top_imports": [
    {
      "module": "Tools",
...
- Suffix: `.json`
- Size bytes: `1180077`
- SHA-256: `ee9d830d4abb46bf645691dd6ad0745ab074e2884dcf9479dd34bf09c162d5e4`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "code_interpreter_report",
  "generated_at": "2026-05-03T16:05:30",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "apply_mode": "report_only_static_code_interpreter",
  "file_count": 222,
  "parsed_file_count": 222,
  "total_lines": 62459,
  "total_functions": 2286,
  "total_classes": 70,
  "total_risk_signals": 42,
  "total_todos": 21,
  "top_imports": [
    {
      "module": "Tools",
...
### `output/analysis/full_memory_tool_regeneration_20260503-160523_code_interpreter.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `7364`
- SHA-256: `97ba0c5a766476e3ba0087f97ebc5908f10417abeec69b62a5f1a3cea4c34aaf`
- Content included: `True`
- Content truncated: `False`
...
- `code_static_007` `Tools/ai/analyze_gpu_npu_run_sync.py` risk `medium`: complex functions detected
...
- `code_static_012` `Tools/ai/build_agent_review_patch_plan.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_013` `Tools/ai/build_ai_context_pack.py` risk `medium`: medium-size Python module, complex functions detected
- `code_static_014` `Tools/ai/build_code_interpreter_report.py` risk `medium`: medium-size Python module, TODO/FIXME markers detected
- `code_static_015` `Tools/ai/build_deterministic_recommendations.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_016` `Tools/ai/build_dry_run_matrix_evidence_bundle.py` risk `medium`: complex functions detected
- `code_static_017` `Tools/ai/build_full_context_golden_proposals.py` risk `medium`: large functions detected
- `code_static_018` `Tools/ai/build_github_evidence_bundle.py` risk `medium`: large functions detected
- `code_static_019` `Tools/ai/build_local_ai_enrichment_plan.py` risk `medium`: large functions detected
- `code_static_020` `Tools/ai/build_music_intermediates.py` risk `medium`: large functions detected, complex functions detected
- `code_static_021` `Tools/ai/build_patch_specs_from_proposals.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_022` `Tools/ai/build_refactor_duplication_audit.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_023` `Tools/ai/build_repository_change_proposals.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_024` `Tools/ai/build_selective_execution_plan.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_025` `Tools/ai/build_shared_toolbox_ai_to_ai_bundle.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_026` `Tools/ai/build_workload_quality_lane_routing.py` risk `medium`: complex functions detected
- `code_static_027` `Tools/ai/check_local_resource_lanes.py` risk `medium`: complex functions detected
- `code_static_028` `Tools/ai/check_npu_provider_environment.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_029` `Tools/ai/github_evidence_bundle_artifacts.py` risk `medium`: complex functions detected
- `code_static_030` `Tools/ai/gpu_planner_json_contract.py` risk `medium`: complex functions detected
- `code_static_031` `Tools/ai/model_json.py` risk `medium`: complex functions detected
- `code_static_032` `Tools/ai/pipeline/preflight.py` risk `medium`: complex functions detected
- `code_static_033` `Tools/ai/pipeline/remediation.py` risk `medium`: large functions detected, complex functions detected, TODO/FIXME markers detected
- `code_static_034` `Tools/ai/pipeline/steps.py` risk `medium`: large functions detected
- `code_static_035` `Tools/ai/promote_patch_spec_draft.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_036` `Tools/ai/refine_megalithic_review_signals.py` risk `medium`: medium-size Python module
- `code_static_037` `Tools/ai/review_wave_entrypoints.py` risk `medium`: large functions detected, complex functions detected
- `code_static_038` `Tools/ai/run_agent_gpu_deep_planning_review.py` risk `high`: large Python module, large functions detected, complex functions detected
- `code_static_039` `Tools/ai/run_agent_gpu_deep_planning_supervised.py` risk `high`: large Python module, large functions detected, complex functions detected, static risk calls detected
- `code_static_040` `Tools/ai/run_agent_gpu_npu_parallel_orchestrator.py` risk `high`: large Python module, large functions detected, complex functions detected, static risk calls detected
...
- Suffix: `.json`
- Size bytes: `9118`
- SHA-256: `7e759fa0f16fdadee96c4d950565547a3bfcba268361788ffc65cb29b26918e3`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  "schema_version": 1,
  "kind": "gpu_planner_json_contract_replay",
  "generated_at": "2026-05-03T16:05:41",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "manual_review_required": true,
  "inputs": {
    "gpu_report": "output/ai_pipeline/post_pr167_retry_pass_20260503-143243_parallel_gpu.json"
  },
  "source_summary": {
...
- Suffix: `.json`
- Size bytes: `2422`
- SHA-256: `a6f3cc950360efea94e103ac38c103e7c8348548d995a686a96087895862a082`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  ...
  "manual_review_required": true,
  "inputs": {
    "orchestrator": "output/ai_pipeline/post_pr167_retry_pass_20260503-143243_orchestrator.json"
  },
  "metrics": {
    "gpu_round_count": 7,
    "npu_audit_count": 1,
...
- Suffix: `.json`
- Size bytes: `477752`
- SHA-256: `4341e3ff925ec8bdc968359ef12ea6107a01483bc97988b629f35e359c486b07`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  ...
  "remaining_gaps": [
    {
      "path": "output/validation/shared_toolbox_python_syntax_20260503-160523.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/analysis/shared_toolbox_code_interpreter_20260503-160523.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/shared_toolbox_gpu_contract_smoke_20260503-160523.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/shared_toolbox_gpu_routing_20260503-160523.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/shared_toolbox_npu_execution_20260503-160523.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/shared_toolbox_npu_contract_20260503-160523.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/validation/npu_provider_environment_shared_toolbox_20260503-160523.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-160523_orchestrator.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-160523_gpu.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/analysis/shared_toolbox_gpu_npu_sync_20260503-160523.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/analysis/shared_toolbox_gpu_contract_replay_20260503-160523.json",
      "reason": "optional report missing"
    },
    {
      "path": "output/analysis/shared_toolbox_code_interpreter_20260503-160523.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-160523_orchestrator.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/ai_pipeline/shared_toolbox_ai_to_ai_20260503-160523_gpu.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/analysis/shared_toolbox_gpu_npu_sync_20260503-160523.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/analysis/shared_toolbox_gpu_contract_replay_20260503-160523.md",
      "reason": "optional artifact missing"
    },
    {
      "path": "output/analysis/shared_toolbox_ai_to_ai_final_summary_20260503-160523.md",
      "reason": "optional artifact missing"
    },
    {
  ...
  "compact_bundle_paths": [
    "docs/LOCAL_VALIDATION_EVIDENCE/shared_toolbox_ai_to_ai_bundle_20260503-160523.json",
    "docs/LOCAL_VALIDATION_EVIDENCE/shared_toolbox_ai_to_ai_bundle_20260503-160523.md"
  ],
  "provider_execution_performed": false,
  "patch_application_performed": false,
  "source_writes_performed": false,
  ...
  "recursive_defaults": {
    ...
    "discovered_reports": [
      ...
      "output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agnostic_tool_inventory.json",
      "output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_transient_request_context.json",
      "output/ai_pipeline/full_toolbox_20260503-160523_agent_review_decisi
```
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agent_memory_inventory.md`
...
- Suffix: `.json`
- Size bytes: `506279`
- SHA-256: `bc0a09c5b3fae94cd3c0cf734171c6a9c6677d398f9b6c298304fc19b1457359`
- Content included: `True`
- Content truncated: `True`
...
```text
{
  "schema_version": 1,
  "kind": "agent_agnostic_tool_inventory",
  "generated_at": "2026-05-03T16:05:24",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "summary": {
    ...
    "owner_lane_counts": {
      ...
      "gpu_cuda_explicit_provider_tool": 56,
      "cpu_validation": 39,
      "cpu_support": 34,
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agnostic_tool_inventory.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `15515`
- SHA-256: `5e6b6dff8a65a5b9d9c8b696fb3af2c553c41a06299c8b72002f15c78543acb8`
- Content included: `True`
- Content truncated: `True`
...
- `Tools/workflow/gui/workflow_gui_modern.py` lane=`gpu_cuda_ex
```
...
- Suffix: `.json`
- Size bytes: `9176`
- SHA-256: `5b39216f6bbf0fb26415c08c167d619013f83b4a2204fd5fe9dd57179b5def5f`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  "schema_version": 1,
  "kind": "agent_transient_request_context",
  "generated_at": "2026-05-03T16:05:29",
  "repo_root": "C:\\Users\\carmi\\blender\\blender-audio-project",
  "passed": true,
  "errors": [],
  "warnings": [],
  ...
  "report_context": {
    ...
    "reports": [
      {
        "path": "output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agent_memory_inventory.json",
        "exists": true,
        "kind": "agent_memory_inventory",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agnostic_tool_inventory.json",
        "exists": true,
        "kind": "agent_agnostic_tool_inventory",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/full_memory_tool_regeneration_20260503-160523_persistent_memory_status.json",
        "exists": true,
        "kind": "agent_runtime_sqlite_memory",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/full_memory_tool_regeneration_20260503-160523_operational_memory_status.json",
        "exists": true,
        "kind": "agent_runtime_sqlite_memory",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy.json",
        "exists": true,
        "kind": "agent_memory_routing_policy",
        "passed": true,
        "error": "",
      ...
      {
        "path": "output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json",
        "exists": true,
        "kind": "agent_runtime_tool_broker",
        "passed": true,
        "error": "",
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_transient_request_context.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1754`
- SHA-256: `5447ffb647208cd10da39da72765cd26509bed7b190da24c7b35852e37be117c`
- Content included: `True`
- Content truncated: `False`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agent_memory_inventory.json` kind=`agent_memory_inventory` passed=`True` error=``
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-160523_agnostic_tool_inventory.json` kind=`agent_agnostic_tool_inventory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-160523_persistent_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-160523_operational_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy.json` kind=`agent_memory_routing_policy` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.json` kind=`agent_runtime_tool_broker` passed=`True` error=``
...
- Suffix: `.json`
- Size bytes: `2614`
- SHA-256: `eb2caebbb9d578183fd589ae61145b17f3cd683456ce19b4ec32fc5975e84754`
- Content included: `True`
- Content truncated: `False`
...
```text
{
  ...
  "outputs": {
    "recommendations": {
      "path": "output/ai_pipeline/full_toolbox_20260503-160523_deterministic_recommendations.json",
      "exists": true,
      "size_bytes": 80934
    },
    "recommendations_markdown": {
      "path": "output/ai_pipeline/full_toolbox_20260503-160523_deterministic_recommendations.md",
      "exists": true,
      "size_bytes": 6900
    },
    "bridge_orchestrator": {
      "path": "output/ai_pipeline/full_toolbox_20260503-160523_bridge_orchestrator.json",
      "exists": true,
      "size_bytes": 39207
    },
    "patch_plan": {
      "path": "output/patch_specs/full_toolbox_20260503-160523_agent_review_patch_plan.json",
      "exists": true,
      "size_bytes": 112579
    },
    "patch_plan_markdown": {
      "path": "output/patch_specs/full_toolbox_20260503-160523_agent_review_patch_plan.md",
      "exists": true,
      "size_bytes": 6742
    }
  },
...
### `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_20260503-160523.csv`
    ...
    "tool_results": [
      ...
      },
      {
        ...
        "outputs": {
          ...
          "markdown_report": "output/ai_runtime_tools/post_pr167_retry_pass_2026050
```
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `3669`
- SHA-256: `599d3d8942481563f77dcbec960f58941c795cae118c118d2562eb32aef836ca`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- profile: `full_refactor`
- broker_request_written: `output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523_tool_requests.json`
- provider_execution_performed: `False`
- patch_application_performed: `False`
- sqlite_write_performed: `False`
- persistent_memory_write_performed: `False`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_memory_routing_policy_smoke.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_operational_memory_status.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1334`
- SHA-256: `fb64212a2c615b75e6bf71457763be57d9b70ea653328df27567369c21265e6a`
- Content included: `True`
- Content truncated: `False`
...
```json
{
  "record_count": 67,
  "kind_counts": {
    "operational_context": 67
  },
  "role_counts": {
    "runtime_planner_note": 43,
    "doctor_tool": 23,
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_persistent_memory_status.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_python_line_count.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1771`
- SHA-256: `bb6ce2f56ea15a289da11ceefa64ec67a2e5be3df3cd17d58e600769febb43d4`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- CSV: `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_20260503-160523.csv`
- File count: `310`
- Total lines: `89457`
- Provider execution performed: `False`
- Patch application performed: `False`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `8262`
- SHA-256: `fc25187eb1c03081027dd3b1a80e50315eea8a6c0deeaaf354384373aeb43799`
- Content included: `True`
- Content truncated: `False`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/persistent_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/persistent_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/persistent_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/persistent_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/persistent_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/persistent_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_remember_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_remember_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_remember_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/operational_memory_remember_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/agent_memory_inventory_agent_memory_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/agent_memory_inventory_agent_memory_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/agnostic_tool_inventory_agent_agnostic_tool_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/agnostic_tool_inventory_agent_agnostic_tool_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/transient_request_context_agent_transient_request_context.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/transient_request_context_agent_transient_request_context.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/python_line_count_inventory_python_line_count.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/python_line_count_inventory_python_line_count.md', 'csv_output': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/python_line_count_inventory_python_line_count.csv'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/code_interpreter_report_code_interpreter_report.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/code_interpreter_report_code_interpreter_report.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/refactor_duplication_audit_refactor_duplication_audit.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/refactor_duplication_audit_refactor_duplication_audit.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/python_syntax_check_python_syntax.json'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/gpu_contract_smoke_gpu_planner_json_contract_smoke.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/gpu_contract_smoke_gpu_planner_json_contract_smoke.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-160523/validation_report_contract_validation_report_contract.json'}`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_runtime_tool_broker_smoke.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-160523_workflow.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `2956`
- SHA-256: `1a8b27eeae2ba25715a4272ffaaf6e40c7d6690614e2649ce15c05bf13c8a7ca`
- Content included: `True`
- Content truncated: `False`
...
### `output/validation/gpu_planner_json_contract_smoke_full_toolbox_20260503-160523.md`
