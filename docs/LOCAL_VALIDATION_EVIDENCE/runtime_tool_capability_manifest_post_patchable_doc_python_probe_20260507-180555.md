...
- Broker runtime tool executions: `18`
...
- Usage observed: `{'count': 6, 'executed': 6, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.285}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Allowed args: `['input']`
- Usage observed: `{'count': 2, 'executed': 2, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 2.141}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Usage observed: `{'count': 2, 'executed': 2, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 1.0}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Usage observed: `{'count': 2, 'executed': 2, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 1.669}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Allowed args: `[]`
- Usage observed: `{'count': 8, 'executed': 8, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 5.948}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Usage observed: `{'count': 10, 'executed': 10, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.522}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- Allowed args: `[]`
- Usage observed: `{'count': 4, 'executed': 4, 'failed': 0, 'blocked': 0, 'elapsed_seconds': 0.204}`
- Guardrails:
  - no free shell exposure
  - broker allowlist required
  - no provider execution
...
- `Tools/ai/agent_runtime_tool_broker.py` role=`runtime_tool_broker_allowlist_source` exists=`True` sha256=`ed7c1c06e65a795a8434a9c2815187c9ae98939b1bcd5f5fb6250809dafd682d`
- `Tools/ai/build_runtime_tool_usage_telemetry.py` role=`runtime_tool_usage_telemetry_builder` exists=`True` sha256=`3cb327dc333ad461b266fb44b299827a20b924f71b346bb104c5ce53eaf127a6`
...
- `docs/LOCAL_VALIDATION_EVIDENCE/runtime_tool_usage_telemetry_post_patchable_doc_python_probe_20260507-180555.json` role=`observed_runtime_tool_usage_report` exists=`True` sha256=`99aede563ffa1cfb9b75501bbfa39322bd18efc45017107cfdc98e345765ba66`
