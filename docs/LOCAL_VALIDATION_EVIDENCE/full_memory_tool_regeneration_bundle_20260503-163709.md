...
- Generated at: `2026-05-03T16:37:24`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-163709_agent_memory_inventory.json` exists=`True` size=`14512` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-163709_agnostic_tool_inventory.json` exists=`True` size=`511516` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_persistent_memory_status.json` exists=`True` size=`1779` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_operational_memory_status.json` exists=`True` size=`1743` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_memory_routing_policy.json` exists=`True` size=`8989` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_runtime_tool_broker.json` exists=`True` size=`98154` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-163709_transient_request_context.json` exists=`True` size=`9177` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_python_line_count.json` exists=`True` size=`3171` suffix=`.json` preview_chars=`1500`
- `output/analysis/full_memory_tool_regeneration_20260503-163709_code_interpreter.json` exists=`True` size=`1193358` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_python_syntax.json` exists=`True` size=`36667` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_validation_report_contract.json` exists=`True` size=`3417` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-163709_workflow.json` exists=`True` size=`4759` suffix=`.json` preview_chars=`1500`
...
- Suffix: `.md`
- Size bytes: `6894`
- SHA-256: `1c750f8873c673913833a408660e92a83af18c20c672fd2fef2452fccb0025e7`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.md`
- Size bytes: `15640`
- SHA-256: `fdc16a93cf452b631a57c47d12b6157f1a735b4caf2488831bb969f10079bc9d`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.md`
- Size bytes: `1334`
- SHA-256: `69dd9e5ff4eedffbc46cdded14322546ec0ae2ad0ab6f74cff83a594cbd2ccef`
- Content included: `True`
- Content truncated: `False`
...
```json
{
  "record_count": 71,
  "kind_counts": {
    "operational_context": 71
  },
  "role_counts": {
    "runtime_planner_note": 46,
    "doctor_tool": 24,
...
- Suffix: `.md`
- Size bytes: `3685`
- SHA-256: `ae013679935252402948bf65f4f4ecc40213ec2332df3548f515b146a6c1f58b`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- profile: `full_refactor`
- broker_request_written: `output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709_tool_requests.json`
- provider_execution_performed: `False`
- patch_application_performed: `False`
- sqlite_write_performed: `False`
- persistent_memory_write_performed: `False`
...
- Objective: `Reload IA-Carmine full toolbox context before MD-vs-Python, MD-vs-MD and Python-vs-Python consistency run.`
...
- Suffix: `.md`
- Size bytes: `8262`
- SHA-256: `514b6af3eb2f70b18b23f3c46c141cfc628f1631e10ee58cdc9e613ea7ac5a26`
- Content included: `True`
- Content truncated: `False`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/persistent_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/persistent_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/persistent_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/persistent_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/persistent_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/persistent_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_remember_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_remember_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_remember_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/operational_memory_remember_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/agent_memory_inventory_agent_memory_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/agent_memory_inventory_agent_memory_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/agnostic_tool_inventory_agent_agnostic_tool_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/agnostic_tool_inventory_agent_agnostic_tool_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/transient_request_context_agent_transient_request_context.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/transient_request_context_agent_transient_request_context.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/python_line_count_inventory_python_line_count.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/python_line_count_inventory_python_line_count.md', 'csv_output': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/python_line_count_inventory_python_line_count.csv'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/code_interpreter_report_code_interpreter_report.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/code_interpreter_report_code_interpreter_report.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/refactor_duplication_audit_refactor_duplication_audit.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/refactor_duplication_audit_refactor_duplication_audit.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/python_syntax_check_python_syntax.json'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/gpu_contract_smoke_gpu_planner_json_contract_smoke.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/gpu_contract_smoke_gpu_planner_json_contract_smoke.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-163709/validation_report_contract_validation_report_contract.json'}`
...
- Suffix: `.md`
- Size bytes: `1754`
- SHA-256: `8082145271950dc37f846c63fcf96db9df41b92268435858273c602821f6e931`
- Content included: `True`
- Content truncated: `False`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-163709_agent_memory_inventory.json` kind=`agent_memory_inventory` passed=`True` error=``
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-163709_agnostic_tool_inventory.json` kind=`agent_agnostic_tool_inventory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-163709_persistent_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-163709_operational_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-163709_memory_routing_policy.json` kind=`agent_memory_routing_policy` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-163709_runtime_tool_broker.json` kind=`agent_runtime_tool_broker` passed=`True` error=``
...
- Suffix: `.md`
- Size bytes: `1771`
- SHA-256: `c498beeb0f3558e4aee42da194fb6c51b807bbe3e4989a32615bce5fee0a99bd`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- CSV: `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_20260503-163709.csv`
- File count: `312`
- Total lines: `90309`
- Provider execution performed: `False`
- Patch application performed: `False`
...
- Suffix: `.md`
- Size bytes: `7338`
- SHA-256: `68b544eb79a4d01cda4d25b562f150f87a624e64ade2f45c719b00c00638bf76`
- Content included: `True`
- Content truncated: `False`
...
- `code_static_016` `Tools/ai/build_deterministic_recommendations.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
...
- `code_static_025` `Tools/ai/build_selective_execution_plan.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_026` `Tools/ai/build_shared_toolbox_ai_to_ai_bundle.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_027` `Tools/ai/build_workload_quality_lane_routing.py` risk `medium`: complex functions detected
- `code_static_028` `Tools/ai/check_local_resource_lanes.py` risk `medium`: complex functions detected
- `code_static_029` `Tools/ai/check_npu_provider_environment.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_030` `Tools/ai/github_evidence_bundle_artifacts.py` risk `medium`: complex functions detected
- `code_static_031` `Tools/ai/gpu_planner_json_contract.py` risk `medium`: complex functions detected
- `code_static_032` `Tools/ai/model_json.py` risk `medium`: complex functions detected
- `code_static_033` `Tools/ai/pipeline/preflight.py` risk `medium`: complex functions detected
- `code_static_034` `Tools/ai/pipeline/remediation.py` risk `medium`: large functions detected, complex functions detected, TODO/FIXME markers detected
- `code_static_035` `Tools/ai/pipeline/steps.py` risk `medium`: large functions detected
- `code_static_036` `Tools/ai/promote_patch_spec_draft.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_037` `Tools/ai/refine_megalithic_review_signals.py` risk `medium`: medium-size Python module
- `code_static_038` `Tools/ai/review_wave_entrypoints.py` risk `medium`: large functions detected, complex functions detected
- `code_static_039` `Tools/ai/run_agent_gpu_deep_planning_review.py` risk `high`: large Python module, large functions detected, complex functions detected
- `code_static_040` `Tools/ai/run_agent_gpu_deep_planning_supervised.py` risk `high`: large Python module, large functions detected, complex functions detected, static risk calls detected
