...
- Generated at: `2026-05-07T09:34:07`
...
- `output/ai_pipeline/full_memory_tool_regeneration_py_live_seed_20260507-094320_agent_memory_inventory.json` exists=`True` size=`13528` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_py_live_seed_20260507-094320_agnostic_tool_inventory.json` exists=`True` size=`905058` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_persistent_memory_status.json` exists=`True` size=`1779` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_operational_memory_status.json` exists=`True` size=`1705` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_memory_routing_policy.json` exists=`True` size=`8938` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_runtime_tool_broker.json` exists=`True` size=`97023` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_py_live_seed_20260507-094320_transient_request_context.json` exists=`True` size=`9264` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_python_line_count.json` exists=`True` size=`3205` suffix=`.json` preview_chars=`1500`
- `output/analysis/full_memory_tool_regeneration_py_live_seed_20260507-094320_code_interpreter.json` exists=`True` size=`1909852` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_python_syntax.json` exists=`True` size=`76770` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_validation_report_contract.json` exists=`True` size=`3547` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_workflow.json` exists=`True` size=`5081` suffix=`.json` preview_chars=`1500`
...
- Suffix: `.md`
- Size bytes: `16480`
- SHA-256: `da130ffafc209bdc9f298096c0bfe6b9da2162046e2e31d6bc4ce295c781c120`
- Content included: `True`
...
- `cpu_support`: 193
- `npu_explicit_provider_tool`: 152
...
- `Tools/workflow/run_agent_review_full_toolbox_decision_loop/py_engine.py` lane=`gpu_cuda_explicit_provider_tool` apply=`not_declared` provider=`none_or_reported`
- `Tools/workflow/run_agent_review_full_toolbox_decision_loop/py_mesh.py` lane=`npu_explicit_provider_tool` apply=`report_only` provider=`explicit_onl
```
...
- Suffix: `.md`
- Size bytes: `1298`
- SHA-256: `4c7b09a873e0647d237df868540e2bea6cff268da344d9ab23709deff4e42b06`
- Content included: `True`
- Content truncated: `False`
...
```json
{
  "record_count": 108,
  "kind_counts": {
    "operational_context": 108
  },
  "role_counts": {
    "runtime_planner_note": 81,
    "doctor_tool": 27
  }
}
```
...
- Suffix: `.md`
- Size bytes: `3682`
- SHA-256: `9ec9a8d8e8fcec8b4fb38bc57d1e26d34cb6f56a75f0dc6bf660cce3d0b4fa67`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- profile: `full_refactor`
- broker_request_written: `output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320_tool_requests.json`
- provider_execution_performed: `False`
- patch_application_performed: `False`
- sqlite_write_performed: `False`
- persistent_memory_write_performed: `False`
...
- Suffix: `.md`
- Size bytes: `8974`
- SHA-256: `e826c6e52e8845f08beb1610ce679cbbcec8c0e6311039267785954717770a0b`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- dry_run: `False`
- request_file: `output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320_tool_requests.json`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/persistent_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/persistent_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/persistent_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/persistent_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/persistent_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/persistent_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_remember_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_remember_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_remember_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/operational_memory_remember_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/agent_memory_inventory_agent_memory_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/agent_memory_inventory_agent_memory_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/agnostic_tool_inventory_agent_agnostic_tool_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/agnostic_tool_inventory_agent_agnostic_tool_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/transient_request_context_agent_transient_request_context.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/transient_request_context_agent_transient_request_context.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/python_line_count_inventory_python_line_count.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/python_line_count_inventory_python_line_count.md', 'csv_output': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/python_line_count_inventory_python_line_count.csv'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/code_interpreter_report_code_interpreter_report.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/code_interpreter_report_code_interpreter_report.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/refactor_duplication_audit_refactor_duplication_audit.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/refactor_duplication_audit_refactor_duplication_audit.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/python_syntax_check_python_syntax.json'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/gpu_contract_smoke_gpu_planner_json_contract_smoke.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/gpu_contract_smoke_gpu_planner_json_contract_smoke.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_py_live_seed_20260507-094320/validation_report_contract_validation_report_contract.json'}`
...
- Suffix: `.md`
- Size bytes: `1832`
- SHA-256: `8cf4e9fca7772d1a02650e6b307cf3ed8f9a97f0a06fd191c05faec65394738d`
- Content included: `True`
- Content truncated: `False`
...
- `output/ai_pipeline/full_memory_tool_regeneration_py_live_seed_20260507-094320_agent_memory_inventory.json` kind=`agent_memory_inventory` passed=`True` error=``
- `output/ai_pipeline/full_memory_tool_regeneration_py_live_seed_20260507-094320_agnostic_tool_inventory.json` kind=`agent_agnostic_tool_inventory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_persistent_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_operational_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_memory_routing_policy.json` kind=`agent_memory_routing_policy` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_py_live_seed_20260507-094320_runtime_tool_broker.json` kind=`agent_runtime_tool_broker` passed=`True` error=``
...
- Suffix: `.md`
- Size bytes: `1805`
- SHA-256: `4967394756f2d74f5a601888a74cf22c42e1184bdb8a1a5f31f147d3e8c1e714`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- CSV: `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_py_live_seed_20260507-094320.csv`
- File count: `637`
- Total lines: `118322`
- Provider execution performed: `False`
- Patch application performed: `False`
...
- Suffix: `.md`
- Size bytes: `7350`
- SHA-256: `de6555d1a14addd899c8ef05a883aa06e37fe1b4530785ee5d61edd4398d527b`
- Content included: `True`
- Content truncated: `False`
