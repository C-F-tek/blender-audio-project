...
- Generated at: `2026-05-03T22:39:19`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_runtime_tool_broker.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-223900_transient_request_context.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_python_line_count.json`
...
### `output/analysis/full_memory_tool_regeneration_20260503-223900_code_interpreter.json`
...
- Patch application performed: `False`
- Source writes performed: `False`
- Recommendation count: `135`

### `output/validation/full_memory_tool_regeneration_20260503-223900_python_syntax.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_validation_report_contract.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_runtime_tool_broker_smoke.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_memory_routing_policy_smoke.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_workflow.json`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-223900_agent_memory_inventory.json` exists=`True` size=`14604` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-223900_agnostic_tool_inventory.json` exists=`True` size=`535510` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_persistent_memory_status.json` exists=`True` size=`1779` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_operational_memory_status.json` exists=`True` size=`1743` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_memory_routing_policy.json` exists=`True` size=`8925` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_runtime_tool_broker.json` exists=`True` size=`98115` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-223900_transient_request_context.json` exists=`True` size=`9177` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_python_line_count.json` exists=`True` size=`3181` suffix=`.json` preview_chars=`1500`
- `output/analysis/full_memory_tool_regeneration_20260503-223900_code_interpreter.json` exists=`True` size=`1257352` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_python_syntax.json` exists=`True` size=`37654` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_validation_report_contract.json` exists=`True` size=`3417` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-223900_workflow.json` exists=`True` size=`4743` suffix=`.json` preview_chars=`1500`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-223900_agent_memory_inventory.md`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-223900_agnostic_tool_inventory.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `15818`
- SHA-256: `dfdc58d8598dd9a061c4ba21a158f82a04dd6ab3689c059e9481672fa31eb0f7`
- Content included: `True`
- Content truncated: `False`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_persistent_memory_status.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_operational_memory_status.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1334`
- SHA-256: `4bfc30712b95daa71ecfa527498871610d28e1ec39c02f44f041439d8fc6c2a4`
- Content included: `True`
- Content truncated: `False`
...
```json
{
  "record_count": 87,
  "kind_counts": {
    "operational_context": 87
  },
  "role_counts": {
    "runtime_planner_note": 58,
    "doctor_tool": 28,
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_memory_routing_policy.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `3669`
- SHA-256: `9748cb60860c93a1586bcf0563553b114d35325c073749b06a2edc3f9d0bf29e`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- profile: `full_refactor`
- broker_request_written: `output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900_tool_requests.json`
- provider_execution_performed: `False`
- patch_application_performed: `False`
- sqlite_write_performed: `False`
- persistent_memory_write_performed: `False`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_runtime_tool_broker.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `8262`
- SHA-256: `ffb00a909b1b68d6414c85162887f9cb7509434eab38f960dac5e172fd1b3506`
- Content included: `True`
- Content truncated: `False`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/persistent_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/persistent_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/persistent_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/persistent_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/persistent_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/persistent_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_remember_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_remember_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_remember_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/operational_memory_remember_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/agent_memory_inventory_agent_memory_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/agent_memory_inventory_agent_memory_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/agnostic_tool_inventory_agent_agnostic_tool_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/agnostic_tool_inventory_agent_agnostic_tool_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/transient_request_context_agent_transient_request_context.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/transient_request_context_agent_transient_request_context.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/python_line_count_inventory_python_line_count.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/python_line_count_inventory_python_line_count.md', 'csv_output': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/python_line_count_inventory_python_line_count.csv'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/code_interpreter_report_code_interpreter_report.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/code_interpreter_report_code_interpreter_report.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/refactor_duplication_audit_refactor_duplication_audit.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/refactor_duplication_audit_refactor_duplication_audit.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/python_syntax_check_python_syntax.json'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/gpu_contract_smoke_gpu_planner_json_contract_smoke.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/gpu_contract_smoke_gpu_planner_json_contract_smoke.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-223900/validation_report_contract_validation_report_contract.json'}`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-223900_transient_request_context.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1754`
- SHA-256: `e8d7dce643b36237e0cad348117cff1c27383566575366bc45f4c2e1c5918b51`
- Content included: `True`
- Content truncated: `False`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-223900_agent_memory_inventory.json` kind=`agent_memory_inventory` passed=`True` error=``
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-223900_agnostic_tool_inventory.json` kind=`agent_agnostic_tool_inventory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-223900_persistent_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-223900_operational_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-223900_memory_routing_policy.json` kind=`agent_memory_routing_policy` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-223900_runtime_tool_broker.json` kind=`agent_runtime_tool_broker` passed=`True` error=``
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_python_line_count.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1781`
- SHA-256: `03dfd2943ccdb554b5c2e1cd77fca72ae53287404d9918167c0eecfc97dbe60d`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- CSV: `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_20260503-223900.csv`
- File count: `320`
- Total lines: `93919`
- Provider execution performed: `False`
- Patch application performed: `False`
...
### `output/analysis/full_memory_tool_regeneration_20260503-223900_code_interpreter.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `7326`
- SHA-256: `d61c8cac8dff52cdb986a931bf130d4137cf19ca76f14dfa92a9aa538028a751`
- Content included: `True`
- Content truncated: `False`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_runtime_tool_broker_smoke.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_memory_routing_policy_smoke.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-223900_workflow.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `2956`
- SHA-256: `243dbeac191de7ce2e9f3862a6f732b2e8da7fe0913114cd4b367a1f3be2d5da`
- Content included: `True`
- Content truncated: `False`
