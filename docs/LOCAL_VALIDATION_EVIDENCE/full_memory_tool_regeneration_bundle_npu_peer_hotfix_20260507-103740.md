...
- Generated at: `2026-05-07T10:38:03`
...
- `output/ai_pipeline/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_agent_memory_inventory.json` exists=`True` size=`13528` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_agnostic_tool_inventory.json` exists=`True` size=`906552` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_persistent_memory_status.json` exists=`True` size=`1779` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_operational_memory_status.json` exists=`True` size=`1705` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_memory_routing_policy.json` exists=`True` size=`8941` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_runtime_tool_broker.json` exists=`True` size=`97362` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_transient_request_context.json` exists=`True` size=`9282` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_python_line_count.json` exists=`True` size=`3208` suffix=`.json` preview_chars=`1500`
- `output/analysis/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_code_interpreter.json` exists=`True` size=`1914109` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_python_syntax.json` exists=`True` size=`76897` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_validation_report_contract.json` exists=`True` size=`3577` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_workflow.json` exists=`True` size=`5159` suffix=`.json` preview_chars=`1500`
...
- Suffix: `.md`
- Size bytes: `16468`
- SHA-256: `67db27ae48f6def5031f804e9076d05d168d91aee2635fb2b32dc0f4df03f55d`
- Content included: `True`
...
- Suffix: `.md`
- Size bytes: `1362`
- SHA-256: `d83ab1ac5a2c8f559b00eed4708c0b5bcaaed35b50b44b818f2e9038c47a4ec8`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.md`
- Size bytes: `1298`
- SHA-256: `2bb36e302e9bf9fe096da3b7bed306eed8bc1404376251d3d3319ef40dbaeb73`
- Content included: `True`
- Content truncated: `False`
...
```json
{
  "record_count": 116,
  "kind_counts": {
    "operational_context": 116
  },
  "role_counts": {
    "runtime_planner_note": 87,
    "doctor_tool": 29
  }
}
```
...
- Suffix: `.md`
- Size bytes: `3685`
- SHA-256: `29ce553895bf68835441135d02f7669689c99464585dc3ae647f31ae4a1c01ae`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- profile: `full_refactor`
- broker_request_written: `output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_tool_requests.json`
- provider_execution_performed: `False`
- patch_application_performed: `False`
- sqlite_write_performed: `False`
- persistent_memory_write_performed: `False`
...
- Suffix: `.md`
- Size bytes: `9076`
- SHA-256: `6edf301b3a05c8ff0cc5724d55343c3db87a3cc5328912382bca59703cdb4821`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- dry_run: `False`
- request_file: `output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_tool_requests.json`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/persistent_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/persistent_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/persistent_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/persistent_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/persistent_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/persistent_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_remember_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_remember_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_remember_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/operational_memory_remember_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/agent_memory_inventory_agent_memory_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/agent_memory_inventory_agent_memory_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/agnostic_tool_inventory_agent_agnostic_tool_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/agnostic_tool_inventory_agent_agnostic_tool_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/transient_request_context_agent_transient_request_context.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/transient_request_context_agent_transient_request_context.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/python_line_count_inventory_python_line_count.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/python_line_count_inventory_python_line_count.md', 'csv_output': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/python_line_count_inventory_python_line_count.csv'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/code_interpreter_report_code_interpreter_report.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/code_interpreter_report_code_interpreter_report.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/refactor_duplication_audit_refactor_duplication_audit.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/refactor_duplication_audit_refactor_duplication_audit.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/python_syntax_check_python_syntax.json'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/gpu_contract_smoke_gpu_planner_json_contract_smoke.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/gpu_contract_smoke_gpu_planner_json_contract_smoke.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740/validation_report_contract_validation_report_contract.json'}`
...
- Suffix: `.md`
- Size bytes: `1850`
- SHA-256: `ffb6f16aca78598966f1e8bfe74b3c8d6eb87170627137563e1aac75d7021053`
- Content included: `True`
- Content truncated: `False`
...
- `output/ai_pipeline/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_agent_memory_inventory.json` kind=`agent_memory_inventory` passed=`True` error=``
- `output/ai_pipeline/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_agnostic_tool_inventory.json` kind=`agent_agnostic_tool_inventory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_persistent_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_operational_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_memory_routing_policy.json` kind=`agent_memory_routing_policy` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_npu_peer_hotfix_20260507-103740_runtime_tool_broker.json` kind=`agent_runtime_tool_broker` passed=`True` error=``
...
- Suffix: `.md`
- Size bytes: `1808`
- SHA-256: `e23734cf7ecad9082e7d0d63c9482fc5c554049b48d5b2deee98e4be0c74460c`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- CSV: `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_npu_peer_hotfix_20260507-103740.csv`
- File count: `638`
- Total lines: `118629`
- Provider execution performed: `False`
- Patch application performed: `False`
...
- `Tools/ai/run_agent_gpu_npu_parallel_orchestrator.py` — `2434` lines
...
- Suffix: `.md`
- Size bytes: `7350`
- SHA-256: `530f44cf19876ef590c32274b35a1677fff928c958a91caef0851b8445e90f43`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.sqlite`
- Size bytes: `565248`
- SHA-256: `4cf5ef54c4c63f29704d9f58d16e5e5cf28ffa3fb68867082eb2045580ff180e`
