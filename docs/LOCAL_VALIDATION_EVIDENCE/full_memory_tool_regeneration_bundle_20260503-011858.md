...
- Generated at: `2026-05-03T01:19:12`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_agent_memory_inventory.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_agnostic_tool_inventory.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_persistent_memory_status.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_operational_memory_status.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_memory_routing_policy.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_runtime_tool_broker.json`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_transient_request_context.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_python_line_count.json`
...
### `output/analysis/full_memory_tool_regeneration_20260503-011858_code_interpreter.json`
...
- Patch application performed: `False`
- Source writes performed: `False`
- Recommendation count: `105`

### `output/validation/full_memory_tool_regeneration_20260503-011858_python_syntax.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_validation_report_contract.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_runtime_tool_broker_smoke.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_memory_routing_policy_smoke.json`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_workflow.json`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_agent_memory_inventory.json` exists=`True` size=`14252` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_agnostic_tool_inventory.json` exists=`True` size=`445807` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_persistent_memory_status.json` exists=`True` size=`1779` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_operational_memory_status.json` exists=`True` size=`1702` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_memory_routing_policy.json` exists=`True` size=`8480` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_runtime_tool_broker.json` exists=`True` size=`93458` suffix=`.json` preview_chars=`1500`
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_transient_request_context.json` exists=`True` size=`9176` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_python_line_count.json` exists=`True` size=`3168` suffix=`.json` preview_chars=`1500`
- `output/analysis/full_memory_tool_regeneration_20260503-011858_code_interpreter.json` exists=`True` size=`1047012` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_python_syntax.json` exists=`True` size=`33755` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_validation_report_contract.json` exists=`True` size=`3417` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_runtime_tool_broker_smoke.json` exists=`True` size=`2001` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_memory_routing_policy_smoke.json` exists=`True` size=`2972` suffix=`.json` preview_chars=`1500`
- `output/validation/full_memory_tool_regeneration_20260503-011858_workflow.json` exists=`True` size=`4739` suffix=`.json` preview_chars=`1500`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_agent_memory_inventory.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `6877`
- SHA-256: `b1e69268060eb2a60dbbf0a517fe58054bee70f71fc4737d4e1bd68eaff1baba`
- Content included: `True`
- Content truncated: `False`
...
### 1b52848c29da16cc925c - docs/LOCAL_AI_RUN_BOOTSTRAP.md

- Kind: `source_file`
- Scope: `project`
- Score: `18.0`

# Local AI Run Bootstrap This file is the first local-run bootstrap for AI assistants working inside a checked-out copy of this repository. Use it before changing files during local runs. It is intentionally operational and conservative. ## Purpose The local AI should autonomously read the current task context and repository guardrails before planning or editing. The bootstrap prevents these common failures: ```text starting from stale context editing runtime files during documentation/backend tasks running providers implicitly forgetting active execution plans forgetting compact evidence bundles mixing GitHub-only review with local workstation evidence ``` ## Hybrid master-AI / local-pipeline model The current operating model is hybrid. ```text Chat / GitHub-only AI / Codex-style control plane -> strategic planning, review, issue/PR orchestration, small edits, human-facing summaries...

### 6db62b054806383ea0ad - output/ai_context_packs/full_context_golden_core_ai_backend.md

- Kind: `source_file`
- Scope: `project`
- Score: `14.0`

# AI Context Pack: core_ai_backend - Generated at: `2026-05-01T17:18:01` - Passed: `True` - Provider execution performed: `False` - Included files: `11/11` - Included chars: `43093` ## Validation Commands - `python .\Tools\validation\check_python_syntax.py --repo-root . --output .\output\validation\python_syntax.json` - `python .\Tools\validation\check_json_artifacts.py --repo-root . --output .\output\validation\json_artifacts.json` - `python .\Tools\validation\check_validation_report_contract.py --repo-root . --output .\output\validation\validation_report_contract.json` ## Stop Conditions - Do not execute providers implicitly. - Do not apply patch specs or write patch_specs/inbox/ without explicit approval. - Do not touch Blender runtime, Ready To Jazz, blender_compat.py, full analysis JSON or generated indexes. - Do not change provider model, temperature, prompt prose or execution p...

### a044cb8d9fff9bba9246 - output/ai_context_packs/full_context_golden_selected_chunks.json

- Kind: `source_file`
- Scope: `project`
- Score: `14.0`

{ "schema_version": 1, "kind": "semantic_code_chunk_selection", "generated_at": "2026-05-01T15:18:01.709972+00:00", "query": "workflow adapter local ai full context enrichment selected chunks sqlite memory provider multistep proposals validators npu knowledge broker context oracle retrieval ranking", "source_chunks": "indexAI/code_chunks/semantic_code_chunks.json", "max_chunks": 24, "max_total_chars": 32000, "max_excerpt_chars": 2500, "include_code": true, "path_boosts": [ "Tools/workflow", "Tools/ai", "Tools/validation", "Tools/npu" ], "total_scored_chunks": 1682, "selected_count": 24, "total_selected_chars": 31285, "source_writes_performed": false, "provider_execution_performed": false, "passed": true, "errors": [], "warnings": [], "selected_chunks": [ { "chunk_id": "Tools/npu/ai_memory_context.py::build_ai_memory_context", "path": "Tools/npu/ai_memory_context.py", "symbol": "build_...

### 7d4aff8181b7d29af85a - output/ai_context_packs/full_context_golden_selected_chunks.md

- Kind: `source_file`
- Scope: `project`
- Score: `14.0`

# Selected Semantic Code Chunks - Generated at: `2026-05-01T15:18:01.709972+00:00` - Query: `workflow adapter local ai full context enrichment selected chunks sqlite memory provider multistep proposals validators npu knowledge broker context oracle retrieval ranking` - Selected chunks: `24` - Total selected chars: `31285` - Source writes performed: `False` ## Tools/npu/ai_memory_context.py::build_ai_memory_context - Path: `Tools/npu/ai_memory_context.py` - Symbol: `build_ai_memory_context` - Lines: `76-111` - Score: `36` - Domain: `audio, render, config, ai_context` - Risk: `low` - Do not change: `False` - Matched terms: `ai, context, memory, npu, path:Tools/npu` - Summary: function build_ai_memory_context in Tools/npu/ai_memory_context.py ```python def build_ai_memory_context( *, track_stem: str, output_dir: Path | None = None, scene_brief_path: Path | None = None, asset_inventory_pa...
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_agnostic_tool_inventory.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `15315`
- SHA-256: `600ba141cfe5bf42a45129427edd3dc3671a2409d0a1bc883f39be44c7ece0ce`
- Content included: `True`
- Content truncated: `False`
...
- `gpu_cuda_explicit_provider_tool`: 38
- `cpu_validation`: 37
- `cpu_support`: 34
...
- `Tools/ai/pipeline/markdown_report.py` lane=`gpu_cuda_explicit_provider_tool` apply=`not_declared` provider=`none_or_reported`
...
- `Tools/workflow/run_local_validation_after_refactor.ps1` lane=`cpu_orchestration` apply=`explicit_git_operation` provider=`none_or_reported`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_persistent_memory_status.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_operational_memory_status.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1295`
- SHA-256: `f5bb6c28209034c32128ce5bca39c8f841db799af7332748e7e9a581dc6af66b`
- Content included: `True`
- Content truncated: `False`
...
```json
{
  "record_count": 27,
  "kind_counts": {
    "operational_context": 27
  },
  "role_counts": {
    "runtime_planner_note": 19,
    "doctor_tool": 8
  }
}
```
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_memory_routing_policy.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `3482`
- SHA-256: `084513ab6134efbe15a102c9d277bdb2a3b2cb1fefe4ba456c454a0babcdc8e9`
- Content included: `True`
- Content truncated: `False`
...
- passed: `True`
- profile: `full_refactor`
- broker_request_written: `output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858_tool_requests.json`
- provider_execution_performed: `False`
- patch_application_performed: `False`
- sqlite_write_performed: `False`
- persistent_memory_write_performed: `False`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_runtime_tool_broker.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `7814`
- SHA-256: `a542fb4671f0da17119a1147d8c7bc7d5ea0993b697b6b62a983d1f8f981fc19`
- Content included: `True`
- Content truncated: `False`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/persistent_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/persistent_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_status_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_status_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/persistent_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/persistent_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/persistent_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/persistent_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_search_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_search_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_search_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_search_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_remember_01_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_remember_01_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_remember_02_runtime_sqlite_memory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/operational_memory_remember_02_runtime_sqlite_memory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/agent_memory_inventory_agent_memory_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/agent_memory_inventory_agent_memory_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/agnostic_tool_inventory_agent_agnostic_tool_inventory.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/agnostic_tool_inventory_agent_agnostic_tool_inventory.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/transient_request_context_agent_transient_request_context.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/transient_request_context_agent_transient_request_context.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/python_line_count_inventory_python_line_count.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/python_line_count_inventory_python_line_count.md', 'csv_output': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/python_line_count_inventory_python_line_count.csv'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/code_interpreter_report_code_interpreter_report.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/code_interpreter_report_code_interpreter_report.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/python_syntax_check_python_syntax.json'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/gpu_contract_smoke_gpu_planner_json_contract_smoke.json', 'markdown_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/gpu_contract_smoke_gpu_planner_json_contract_smoke.md'}`
...
- Blocked: `False`
- Return code: `0`
- Outputs: `{'json_report': 'output/ai_runtime_tools/full_memory_tool_regeneration_20260503-011858/validation_report_contract_validation_report_contract.json'}`
...
### `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_transient_request_context.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1754`
- SHA-256: `2e774ebaaee37c42f3f13062255b2c177fc8a3e07e09e1bb3c2e9b1353f5204d`
- Content included: `True`
- Content truncated: `False`
...
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_agent_memory_inventory.json` kind=`agent_memory_inventory` passed=`True` error=``
- `output/ai_pipeline/full_memory_tool_regeneration_20260503-011858_agnostic_tool_inventory.json` kind=`agent_agnostic_tool_inventory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-011858_persistent_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-011858_operational_memory_status.json` kind=`agent_runtime_sqlite_memory` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-011858_memory_routing_policy.json` kind=`agent_memory_routing_policy` passed=`True` error=``
- `output/validation/full_memory_tool_regeneration_20260503-011858_runtime_tool_broker.json` kind=`agent_runtime_tool_broker` passed=`True` error=``
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_python_line_count.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `1768`
- SHA-256: `ea872f053137cb77c62916c3a4bb6f1afb52ca93755ce0c6240c11a28441749a`
- Content included: `True`
- Content truncated: `False`
...
- Passed: `True`
- CSV: `docs/LOCAL_VALIDATION_EVIDENCE/full_memory_tool_regeneration_python_line_count_20260503-011858.csv`
- File count: `289`
- Total lines: `82106`
- Provider execution performed: `False`
- Patch application performed: `False`
...
- Suffix: `.csv`
- Size bytes: `13705`
- SHA-256: `04b54faf291a1aef5022314f79402b095ac41aed92133d736b8d736e982a26db`
- Content included: `True`
- Content truncated: `False`
...
### `output/analysis/full_memory_tool_regeneration_20260503-011858_code_interpreter.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `7340`
- SHA-256: `f7fa38d2c38090006c396060408d7519fba6e0cf5c10cf36c010959cd93c94ae`
- Content included: `True`
- Content truncated: `False`
...
- `Tools/ai/agent_runtime_sqlite_memory.py` — `527` lines, risk `medium`
...
- `code_static_015` `Tools/ai/build_local_ai_enrichment_plan.py` risk `medium`: large functions detected
- `code_static_016` `Tools/ai/build_music_intermediates.py` risk `medium`: large functions detected, complex functions detected
- `code_static_017` `Tools/ai/build_patch_specs_from_proposals.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_018` `Tools/ai/build_repository_change_proposals.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_019` `Tools/ai/build_selective_execution_plan.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_020` `Tools/ai/build_workload_quality_lane_routing.py` risk `medium`: complex functions detected
- `code_static_021` `Tools/ai/check_local_resource_lanes.py` risk `medium`: complex functions detected
- `code_static_022` `Tools/ai/check_npu_provider_environment.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_023` `Tools/ai/gpu_planner_json_contract.py` risk `medium`: complex functions detected
- `code_static_024` `Tools/ai/model_json.py` risk `medium`: complex functions detected
- `code_static_025` `Tools/ai/pipeline/preflight.py` risk `medium`: complex functions detected
- `code_static_026` `Tools/ai/pipeline/remediation.py` risk `medium`: large functions detected, complex functions detected, TODO/FIXME markers detected
- `code_static_027` `Tools/ai/pipeline/steps.py` risk `medium`: large functions detected
- `code_static_028` `Tools/ai/promote_patch_spec_draft.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected
- `code_static_029` `Tools/ai/refine_megalithic_review_signals.py` risk `medium`: medium-size Python module
- `code_static_030` `Tools/ai/review_wave_entrypoints.py` risk `medium`: large functions detected, complex functions detected
- `code_static_031` `Tools/ai/run_agent_gpu_deep_planning_review.py` risk `high`: large Python module, large functions detected, complex functions detected
- `code_static_032` `Tools/ai/run_agent_gpu_deep_planning_supervised.py` risk `high`: large Python module, large functions detected, complex functions detected, static risk calls detected
- `code_static_033` `Tools/ai/run_agent_gpu_npu_parallel_orchestrator.py` risk `high`: large Python module, large functions detected, complex functions detected, static risk calls detected
- `code_static_034` `Tools/ai/run_local_provider_probe.py` risk `medium`: complex functions detected
- `code_static_035` `Tools/ai/run_megalithic_repo_review.py` risk `medium`: medium-size Python module, complex functions detected
- `code_static_036` `Tools/ai/run_npu_decode_smoke_diagnostic.py` risk `medium`: large functions detected, complex functions detected, static risk calls detected
- `code_static_037` `Tools/ai/run_npu_gpu_deep_review_auditor.py` risk `medium`: medium-size Python module, large functions detected, complex functions detected, static risk calls detected
- `code_static_038` `Tools/ai/run_pipeline_dry_run_matrix.py` risk `medium`: medium-size Python module, large functions detected, static risk calls detected
- `code_static_039` `Tools/ai/select_semantic_code_chunks.py` risk `medium`: large functions detected, complex functions detected
- `code_static_040` `Tools/ai/smart_ai_gatekeeper.py` risk `medium`: complex functions detected, TODO/FIXME markers detected
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_runtime_tool_broker_smoke.md`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_memory_routing_policy_smoke.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `375`
- SHA-256: `62ad3d92534d0724e73748b9b5653bf076c2111b8f3a9066117c2a4c144c1ac9`
- Content included: `True`
- Content truncated: `False`
...
- Policy tool requests: `14`
- Broker tool executions: `14`
...
### `output/validation/full_memory_tool_regeneration_20260503-011858_workflow.md`

- Role: `auto_related_artifact`
- Exists: `True`
- Suffix: `.md`
- Size bytes: `2956`
- SHA-256: `f148550c9940e4a1c5b2ce92580c652ba9444121adcfb862eaa12e89251004af`
- Content included: `True`
- Content truncated: `False`
...
- Suffix: `.sqlite`
- Size bytes: `516096`
- SHA-256: `70788e6e1f68dafbdc18739e38e1ab07461f28cf5c9374be64872d420733ecad`
