...
1. New core/helper function proposal
   Example: extract reusable context-enrichment planning logic from the wrapper into ia_carmine or a small helper module.
