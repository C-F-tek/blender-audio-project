...
| Runtime tool broker | `Tools/ai/runtime_tool/agent_broker.py` | Direct provider tool execution bypassing broker. |
| AI peer exchange packet | `Tools/ai/provider_mesh/peer_exchange_packet/cli.py` | Manual GPU1/GPU0/NPU exchange summaries. |
...
| AI context pack | `Tools/ai/agent_context/ai_context_pack/cli.py` | New context-pack builders. |
