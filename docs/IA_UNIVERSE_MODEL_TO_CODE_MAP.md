...
NPU / OpenVINO = micro-lane/microtask auditor
...
2. Read all Universo IA model docs.
3. Pick the relevant model.
4. Open the listed code family TOOL_CONTEXT.md files.
5. Inspect the listed dispatcher command in dispatch.py.
6. Inspect target source.
7. Run or reference the listed validators.
8. Publish only compact evidence or a real code/patch product.
```
