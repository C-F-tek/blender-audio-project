...
| TD-006 | Formal JSON schemas | P2 | in_progress | JSON contracts are documented but not fully enforced. | AI artifacts can drift. | AI pipeline matrix, per-case reports and GitHub evidence bundle summaries now have focused contract docs/validators; continue with direct raw report validators, scene specs and music summaries after report contracts remain stable. | 2026-05-01 |
