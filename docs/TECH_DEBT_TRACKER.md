...
| TD-003 | Blender shared compatibility | P2 | open | `Scripting/shared/blender_compat.py` exists but is not runtime-validated inside Blender yet. | Premature adoption could break audio strips or node creation. | Create manual Blender smoke test before package migration. | 2026-04-29 |
