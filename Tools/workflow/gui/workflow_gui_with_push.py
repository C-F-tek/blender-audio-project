...
class WorkflowGuiWithPush(BaseWorkflowGui):
    ...
    This wrapper avoids invasive edits to the main GUI file. It injects the
    push button after the structured-data generation steps, below the AI scene
    script draft operation.
    """
