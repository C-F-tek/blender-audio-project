...
.DESCRIPTION
  This helper schedules python -m Tools.workflow run_unified_local_ai_refactor in reset mode.
...
$Launcher = Join-Path $RepoRoot "Tools/workflow/_powershell/run_unified_local_ai_refactor.ps1"
