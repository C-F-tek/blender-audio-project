...
$MemoryPythonExe = Use-WorkflowPython -RepoRoot $RepoRootPath
...
$ContractArgs = @(
    "-m", "Tools.validation", "check_validation_report_contract",
    "--repo-root", ".",
...
Invoke-RepoPython -Label "Runtime broker smoke" -ArgsList @(
    "-m", "Tools.validation", "run_agent_runtime_tool_broker_smoke",
    "--repo-root", ".",
...
Invoke-RepoPython -Label "Memory routing policy smoke" -ArgsList @(
    "-m", "Tools.validation", "run_agent_memory_routing_policy_smoke",
    "--repo-root", ".",
