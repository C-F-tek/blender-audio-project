...
COMPILE_TARGETS = [
    ...
    "ia_carmine/providers/provider_mesh/gpu_planner_json_contract_replay/cli.py",
    "ia_carmine/providers/provider_mesh/gpu_npu_run_sync_analysis/cli.py",
    "ia_carmine/product/deterministic_recommendations/cli.py",
    "ia_carmine/product/agent_review/patch_plan/cli.py",
    "ia_carmine/product/patch_product/patch_notes_quality_product/cli.py",
    "ia_carmine/_shared/agent_runtime_tool_broker_execution.py",
    "ia_carmine/runtime/runtime_tool/capability_manifest/cli.py",
    ...
    "ia_carmine/product/repository_product/megalithic_repo_review/cli.py",
    "ia_carmine/product/repository_product/megalithic_review_refinement/cli.py",
    "ia_carmine/providers/provider_mesh/openvino_hardware_governance_report/cli.py",
    "ia_carmine/providers/provider_mesh/peer_exchange_packet/cli.py",
    "ia_carmine/runtime/provider_runtime_blackboard/cli.py",
    "ia_carmine/runtime/provider_runtime_blackboard/live_signals/cli.py",
    "ia_carmine/runtime/provider_runtime_blackboard/peer_reports/cli.py",
    "ia_carmine/runtime/provider_runtime_blackboard/gpu_peer_smoke/cli.py",
    "ia_carmine/providers/provider_mesh/gpu0_peer_companion_worker/cli.py",
    ...
    "ia_carmine/product/repository_product/repository_consistency_map/cli.py",
    "Tools/validation/ai_peer_exchange_contract/cli.py",
    "Tools/validation/repository_product/repository_consistency_map_smoke/cli.py",
    "Tools/validation/provider_mesh/gpu_planner_json_contract_smoke/cli.py",
    "Tools/validation/deterministic_recommendations/run_deterministic_recommendation_synthesizer_smoke/cli.py",
    "Tools/validation/agent_review/decision_loop_smoke/cli.py",
    "Tools/validation/patch_product/patch_notes_quality_product_smoke/cli.py",
