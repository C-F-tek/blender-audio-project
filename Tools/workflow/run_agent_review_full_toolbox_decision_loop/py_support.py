...
def build_paths(stamp: str, evidence_dir: str) -> dict[str, str]:
    ...
    p: dict[str, str] = {
        ...
        "megalithic_review_json": f"output/ai_pipeline/local_ai_core_tool_activation_megalithic_repo_review_{s}.json",
        "megalithic_review_md": f"output/ai_pipeline/local_ai_core_tool_activation_megalithic_repo_review_{s}.md",
        "megalithic_proposals_json": f"output/ai_pipeline/local_ai_core_tool_activation_megalithic_repo_review_proposals_{s}.json",
        "refined_review": "output/ai_pipeline/local_ai_core_tool_activation_megalithic_refined_review_v3.json",
        "refined_review_md": "output/ai_pipeline/local_ai_core_tool_activation_megalithic_refined_review_v3.md",
    ...
    p.update(
        {
            ...
            "runtime_flow_json": f"{evidence_dir}/runtime_flow_{s}.json",
            "runtime_flow_jsonl": f"{evidence_dir}/runtime_flow_{s}.jsonl",
            "runtime_flow_md": f"{evidence_dir}/runtime_flow_{s}.md",
            "runtime_flow_mmd": f"{evidence_dir}/runtime_flow_{s}.mmd",
