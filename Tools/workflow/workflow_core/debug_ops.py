...
def run_advanced_debug_check(probe_write: bool = True) -> str:
    from Tools.workflow.workflow_debug_core.formatting import format_debug_report
    from Tools.workflow.workflow_debug_core.report import build_debug_report
...
def run_startup_service_check() -> str:
    from Tools.workflow.startup_check_core.report import build_report, format_report, save_report
...
def mark_active_operation_interrupted(reason: str = "manual interrupt") -> OperationResult:
    from Tools.workflow.workflow_debug_core.status import detect_active_operation, read_events
