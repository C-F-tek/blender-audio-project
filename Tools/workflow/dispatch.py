...
TOOL_MAIN_TARGETS: dict[str, str] = {
    "analyze_audio": "Tools.workflow.audio_analysis.analyze_cli:main",
    "audio_summary": "Tools.workflow.audio_analysis.summary_cli:main",
    ...
    "scene_spec": "Tools.workflow.scene_spec.cli:main",
    "smart_ai_context": "Tools.workflow.smart_ai_context_core.cli:main",
    "start_workflow": "ps1:_powershell/start_workflow.ps1",
    "startup_check": "Tools.workflow.startup_check_core.cli:main",
    ...
    "workflow_debug": "Tools.workflow.workflow_debug_core.cli:main",
    "workflow_gui": "Tools.workflow.gui.workflow_gui:main",
    "gui": "Tools.workflow.gui.workflow_gui:main",
    "workflow_shell": "Tools.workflow.workflow_shell.cli:main",
    "workflow_shell_with_push": "Tools.workflow.workflow_shell_with_push.cli:main",
}
