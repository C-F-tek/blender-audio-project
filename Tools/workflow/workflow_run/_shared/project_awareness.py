...
def build_project_awareness(
    *,
    ...
    key_paths = {
        ...
        "npu_music_context_md": NPU_DIR / "context_artifacts" / "npu_music_context.md",
        "npu_music_manifest": NPU_DIR / "context_artifacts" / "npu_music_manifest.json",
        "npu_code_index": NPU_DIR / "context_artifacts" / "npu_code_index.md",
