...
from Tools.workflow.workflow_run._shared.artifact_consult import collect_artifacts, format_artifact_table, open_artifact
from Tools.workflow.workflow_run.git_auto_push import run_auto_push_generated_data
from Tools.workflow.workflow_run.workflow_core import (
    DEFAULT_WAV,
    EVENT_LOG_PATH,
    LAST_RESULT_PATH,
    SESSION_PATH,
...
def main() -> None:
    if any(arg in {"-h", "--help"} for arg in sys.argv[1:]):
        print("Interactive workflow shell. Run without arguments to start the menu.")
        return
