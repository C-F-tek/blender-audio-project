...
.EXAMPLE
  python -m Tools.git auto_push_generated_data -Message "chore: update app-generated technical data"

.EXAMPLE
  python -m Tools.git auto_push_generated_data -FullProject -Message "chore: update full project"
