...
def _default_npu_python(repo_root: Path) -> Path:
    ...
    try:
        from Tools.npu._shared.npu_runtime import DEFAULT_NPU_PYTHON  # noqa: PLC0415
...
def main() -> int:
    ...
    parser.add_argument(
        "--python-exe",
        default="",
        help="Optional dedicated NPU Python executable. Defaults to Tools.npu._shared.npu_runtime.DEFAULT_NPU_PYTHON.",
    )
