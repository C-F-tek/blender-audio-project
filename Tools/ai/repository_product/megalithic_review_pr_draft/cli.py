    ...
    *,
    ...
    return {
        ...
        "commands": {
            ...
            "validate_python": "python -m Tools.validation check_python_syntax --repo-root . --output .\\output\\validation\\python_syntax.json",
            "validate_reports": "python -m Tools.validation check_validation_report_contract --repo-root . --output .\\output\\validation\\validation_report_contract.json",
