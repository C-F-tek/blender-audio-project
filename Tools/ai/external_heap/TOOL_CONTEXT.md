# Tools/ai/external_heap context

## Role

`Tools/ai/external_heap` owns external heap artifacts used to carry context between runs, chats and revision cycles.
...
```powershell
python -m Tools.ai external_heap_revision_context ...
...
python -m Tools.ai run_external_heap_postrun_package ...
