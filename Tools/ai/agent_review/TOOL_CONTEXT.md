# Tools/ai/agent_review context

## Role

`Tools/ai/agent_review` contains review-oriented tools for evidence sufficiency, warning policy, patch plans, patch bundles, code patch plans, decision loops and review preparation.
...
```powershell
python -m Tools.ai agent_review_evidence_sufficiency ...
python -m Tools.ai agent_review_patch_plan ...
python -m Tools.ai agent_review_code_patch_plan ...
python -m Tools.ai agent_review_patch_bundle ...
python -m Tools.ai agent_review_warning_policy ...
python -m Tools.ai run_agent_review_decision_loop ...
