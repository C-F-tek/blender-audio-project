...
DEFAULT_OUTPUT = "output/validation/provider_runtime_validation_bridge_{stamp}.json"
DEFAULT_MARKDOWN = "output/validation/provider_runtime_validation_bridge_{stamp}.md"
...
def build_report(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        "schema_version": 1,
        "kind": "provider_runtime_validation_bridge",
