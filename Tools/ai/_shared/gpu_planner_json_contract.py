...
try:
    ...
    from Tools.ai._shared.runtime_tool_guidance import ALLOWED_RUNTIME_TOOLS  # type: ignore

try:
    from Tools.ai._shared.gpu_planner_json_contract_report import json_dumps_report, result_to_dict
