# Tools/ai/runtime_universe/unified context

## Role

`Tools/ai/runtime_universe/unified` contains unified-run feed, observer, contract-argument and debug-information helpers.
...
python -m Tools.ai patch_unified_chain_contract_wiring ...
python -m Tools.ai patch_unified_launcher_error_policy ...
```
