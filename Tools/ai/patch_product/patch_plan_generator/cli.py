...
LANE_FILES = {
    "gpu0": ["Tools/ai/provider_mesh/runtime/gpu0_peer.py"],
    "npu": ["Tools/ai/provider_mesh/runtime/npu_micro.py"],
    "gpu1": ["Tools/ai/provider_mesh/gpu_deep_planning_supervised/cli.py"],
    "orchestrator": ["Tools/ai/provider_mesh/gpu_npu_parallel_orchestrator/cli.py"],
}
COMMON_FILES = [
