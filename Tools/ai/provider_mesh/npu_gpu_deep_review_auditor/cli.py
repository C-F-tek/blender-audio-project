...
def main() -> int:
    ...
    parser.add_argument(
        "--npu-python",
        default=None,
        help="Python executable for the NPU/OpenVINO GenAI environment. Defaults to SPAZIOTEMPO_NPU_PYTHON or Tools.npu.provider_mesh._shared.npu_runtime.DEFAULT_NPU_PYTHON.",
    )
