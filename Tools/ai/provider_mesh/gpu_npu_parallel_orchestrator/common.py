...
try:
    ...
    from Tools.ai.provider_mesh.runtime.npu_micro import (
        build_npu_micro_support_command,
        collect_runtime_tool_context_reports,
        npu_micro_support_output_path,
    )
    from Tools.ai.provider_mesh.runtime.python_runtime import (
        command_env,
        resolve_child_python,
    )
    from Tools.ai.provider_mesh.runtime.runtime_heap import (
    ...
    if str(repo_root_for_import) not in sys.path:
        sys.path.insert(0, str(repo_root_for_import))
    from Tools.ai.provider_mesh.runtime.gpu0_peer import (  # type: ignore
        build_gpu0_peer_support_command,
        gpu0_peer_support_output_path,
        should_launch_gpu0_peer_support,
    )
    from Tools.ai.provider_mesh.runtime.npu_micro import (  # type: ignore
        build_npu_micro_support_command,
        collect_runtime_tool_context_reports,
        npu_micro_support_output_path,
    )
    ...
    from Tools.ai.provider_mesh.runtime.runtime_heap import (  # type: ignore
        append_runtime_heap_event,
        record_runtime_lane_diagnostic,
        write_runtime_heap_snapshot,
    )
