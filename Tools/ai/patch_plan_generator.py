...
LANE_FILES = {
    ...
    "gpu1": ["Tools/ai/run_agent_gpu_deep_planning_supervised.py"],
    "orchestrator": ["Tools/ai/run_agent_gpu_npu_parallel_orchestrator.py"],
}
COMMON_FILES = [
...
def build_patch_plan(snapshot: dict[str, Any]) -> dict[str, Any]:
    ...
    if action == "repair_degraded_lane":
        ...
        command = ["python", "Tools/ai/provider_runtime_heap.py", "--help"]
