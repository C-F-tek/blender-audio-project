...
_MODULE_DIR = Path(__file__).resolve().with_suffix("")
if str(_MODULE_DIR) not in sys.path:
    sys.path.insert(0, str(_MODULE_DIR))

from reporting import render_markdown, write_reports  # type: ignore
from runner import run_request  # type: ignore
