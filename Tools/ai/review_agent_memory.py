...
from agent_memory_policy import evaluate_memory_records, load_records, write_memory_policy_markdown
...
def main() -> int:
    ...
    parser.add_argument("--markdown-output", default="output/ai_memory/agent_memory_policy_report.md")
    ...
    records = load_records(memory_jsonl=memory_jsonl, memory_db=memory_db, limit=args.memory_db_limit)
