# Tools/ai/heap_context_memory_reload context

## Role

`Tools/ai/heap_context_memory_reload` prepares the startup context that makes a heap run tool-owned and file-backed instead of chat-memory-backed.
