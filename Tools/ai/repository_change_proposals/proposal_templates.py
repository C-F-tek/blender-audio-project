...
def ai_workload_quality_remediation_proposal(
    ...
    return proposal(
        ...
        target_files=[
            "Tools/validation/check_ai_workload_report_quality/cli.py",
            "Tools/npu/npu_review_runner/cli.py",
...
def provider_report_adoption_proposal() -> dict[str, Any]:
    return proposal(
        ...
        target_files=[
            ...
            "Tools/validation/check_npu_pipeline_modules/cli.py",
...
def default_npu_observability_proposal() -> dict[str, Any]:
    return proposal(
        ...
        target_files=[
            "Tools/npu/build_runtime_output_manifest/cli.py",
