...
from agent_memory_policy import evaluate_memory_records, load_records  # noqa: E402
from agent_state import MemoryRecord, keywords, select_memory  # noqa: E402
...
def render_markdown(report: dict[str, Any]) -> str:
    """Render a compact Markdown companion."""
    lines = [
