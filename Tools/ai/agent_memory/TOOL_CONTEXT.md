# Tools/ai/agent_memory context

## Role

`Tools/ai/agent_memory` owns policy and access logic for memory used by IA-Carmine runs. It must keep a hard separation between runtime scratch memory and persistent project memory.
...
Use through `Tools.ai` dispatcher:
...
python -m Tools.ai review_agent_memory ...
```
