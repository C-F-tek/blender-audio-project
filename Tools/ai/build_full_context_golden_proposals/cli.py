...
def build_proposals() -> list[dict[str, Any]]:
    return [
        base_proposal(
            ...
            suggestion_outputs=[
                suggestion("Tools/validation/check_local_ai_adapter_manifest/cli.py"),
        ...
        base_proposal(
            ...
            target_files=[
                "Tools/ai/build_local_ai_enrichment_plan/cli.py",
                "Tools/validation/check_local_ai_enrichment_plan/cli.py",
            ],
            ...
            validation_commands=[
                "python -m Tools.ai build_local_ai_enrichment_plan --repo-root . --task docs/LOCAL_AI_TASKS/full-context-ai-npu-golden-path.md --output output/ai_pipeline/full_context_enrichment_plan.json",
            ...
            suggestion_outputs=[
                suggestion("Tools/ai/build_local_ai_enrichment_plan/cli.py"),
                suggestion("Tools/validation/check_local_ai_enrichment_plan/cli.py"),
            ],
        ),
        base_proposal(
        ...
        base_proposal(
            ...
            validation_commands=[
                "python -m Tools.ai build_github_evidence_bundle --repo-root . --basename selected_chunks_standard_block_smoke",
...
def main() -> int:
    try:
        from Tools.ai._shared.full_context_golden_proposals_cli import main as cli_main
