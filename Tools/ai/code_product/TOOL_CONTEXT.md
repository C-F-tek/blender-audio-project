...
`Tools/ai/code_product` owns code-product artifact handling: interpreter reports, edit proposals, patch artifact packs, docs follow-up, full-run bundle ZIPs and `CODE_PRODUCT_FULL_PATCH.md` intake.
