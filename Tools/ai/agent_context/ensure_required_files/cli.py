...
This tool reads required files from Tools.ai.agent_context.ai_context_pack and creates
...
try:
    from Tools.ai._shared.ensure_ai_context_templates import KNOWN_MARKDOWN_TEMPLATES
...
def load_profiles(repo_root: Path) -> dict[str, Any]:
    ...
    module = importlib.import_module("Tools.ai.agent_context.ai_context_pack")
