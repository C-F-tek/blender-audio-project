...
from full0to10_final_product.builder import build_final_tool_product  # noqa: E402
from full0to10_final_product.constants import DEFAULT_REQUEST  # noqa: E402
...
def main() -> int:
    args = parse_args()
    manifest = build_final_tool_product(
        Path(args.repo_root),
