...
DOMAINS: tuple[ArtifactDomain, ...] = (
    ...
    ArtifactDomain(
        ...
        evidence_kinds=("docs_contract_drift", "docs_links", "markdown_command_hygiene"),
    ...
    ArtifactDomain(
        ...
        evidence_kinds=("agnostic_context_stack_smoke", "core_activation_agnostic_contract"),
        pack_kinds=("github_evidence_bundle",),
        blocked_target_prefixes=COMMON_BLOCKED_PREFIXES,
        blocked_target_suffixes=COMMON_BLOCKED_SUFFIXES,
        blocked_target_fragments=COMMON_BLOCKED_FRAGMENTS,
    ...
    ArtifactDomain(
        ...
        evidence_kinds=("text_corpus_summary", "text_analysis_summary"),
    ...
    ArtifactDomain(
        ...
        evidence_kinds=("audio_analysis_summary", "audio_feature_summary"),
    ...
    ArtifactDomain(
        ...
        evidence_kinds=("scene_spec_summary", "render_plan_summary"),
    ...
    ArtifactDomain(
        ...
        evidence_kinds=("provider_result_report", "provider_result_summary"),
