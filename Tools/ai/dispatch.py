...
TOOL_MAIN_TARGETS: dict[str, str] = {
    ...
    "ai_context_pack": "Tools.ai.agent_context.ai_context_pack.cli:main",
    "peer_exchange_packet": "Tools.ai.provider_mesh.peer_exchange_packet.cli:main",
    ...
    "full_toolbox_telemetry_summary": "Tools.ai.runtime_universe.full_toolbox_telemetry_summary.cli:main",
    ...
    "refactor_duplication_audit": "Tools.ai.repository_product.refactor_duplication_audit.cli:main",
    "repository_change_proposals": "Tools.ai.repository_product.repository_change_proposals.cli:main",
    "runtime_flow_map": "Tools.ai.runtime_universe.flow_map.cli:main",
    ...
    "selective_execution_plan": "Tools.ai.runtime_universe.selective_execution_plan.cli:main",
    "semantic_evidence_chunks": "Tools.ai.agent_context.semantic_evidence_chunks.cli:main",
    "shared_toolbox_bundle": "Tools.ai.agent_context.shared_toolbox_bundle.cli:main",
    ...
    "operator_product_gui": "Tools.ai.operator_product_core.view.cli:main",
    ...
    "build_music_intermediates": "Tools.ai.agent_context.music_intermediates.cli:main",
    "build_workload_quality_lane_routing": "Tools.ai.ai_workload.quality_lane_routing.cli:main",
    "check_local_resource_lanes": "Tools.ai.provider_mesh.local_resource_lanes_check.cli:main",
    "compose_external_heap_block_response": "Tools.ai.external_heap.block_response.cli:main",
    "ensure_ai_context_required_files": "Tools.ai.agent_context.ensure_required_files.cli:main",
    "evidence_to_recommendation": "Tools.ai.deterministic_recommendations.evidence_to_recommendation.cli:main",
    "heap_event_pointers": "Tools.ai.heap_runtime.event_pointers.cli:main",
    "heap_provider_budget_governor": "Tools.ai.heap_provider.budget_governor.cli:main",
    "heap_provider_invocation_contract": "Tools.ai.heap_provider.invocation_contract.cli:main",
    "merge_ai_candidates": "Tools.ai.agent_context.merge_candidates.cli:main",
    "normalize_heap_final_causality": "Tools.ai.heap_final_proposals.normalize_final_causality.cli:main",
    "operator_product_view": "Tools.ai.operator_product_core.view.cli:main",
    "patch_unified_heap_exchange_lifecycle_wiring": "Tools.ai.heap_exchange.unified_lifecycle_wiring_patch.cli:main",
    "reconcile_heap_report_with_startup_reload": "Tools.ai.heap_context_memory_reload.reconcile_report.cli:main",
    "review_agent_memory": "Tools.ai.agent_memory.review.cli:main",
    "review_wave_entrypoints": "Tools.ai.agent_review.wave_entrypoints.cli:main",
    "run_agent_review_decision_loop": "Tools.ai.agent_review.decision_loop_runner.cli:main",
    "run_provider_runtime_heap_gpu_peer_smoke": "Tools.ai.provider_runtime_blackboard.gpu_peer_smoke.cli:main",
    "select_semantic_code_chunks": "Tools.ai.agent_context.semantic_evidence_chunks.select_code_chunks.cli:main",
    "smart_ai_gatekeeper": "Tools.ai.runtime_universe.smart_gatekeeper.cli:main",
    "synthesize_patch_candidates": "Tools.ai.patch_product.candidate_synthesis.cli:main",
    "validate_ai_artifacts": "Tools.ai.pipeline.validate_ai_artifacts.cli:main",
    "validation_step": "Tools.ai.pipeline.validation_step.cli:main",
    "agent_runtime_debug_lab": "Tools.ai.runtime_tool.agent_runtime_debug_lab.cli:main",
    "full_run_bundle_zip": "Tools.ai.code_product.full_run_bundle_zip.cli:main",
    "runtime_file_refs": "Tools.ai.runtime_tool.file_refs.cli:main",
    "runtime_hardware_capability": "Tools.ai.provider_mesh.hardware_capability.cli:main",
}
