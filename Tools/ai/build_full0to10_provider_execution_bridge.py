...
from full0to10_provider_execution_bridge.builder import build_provider_execution_bridge  # noqa: E402
from full0to10_provider_execution_bridge.constants import DEFAULT_REQUEST  # noqa: E402
...
def main() -> int:
    args = parse_args()
    bridge = build_provider_execution_bridge(
        Path(args.repo_root),
    ...
    text = json.dumps(bridge, indent=2, ensure_ascii=False) + "\n"
    if args.output:
        ...
        print(text, end="")
    return 0 if bridge["passed"] else 1
