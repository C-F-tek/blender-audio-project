...
def default_legacy_output_paths(repo_root: Path, track_stem: str) -> list[Path]:
    ...
    return [
        ...
        tools_dir / "dual_ai_blender_agent_brief.md",
        output_dir / f"{track_stem}_ollama_music_insights.json",
        tools_dir / "ollama_music_insights.md",
        tools_dir / "npu_dual_ai_technical_notes.md",
        tools_dir / "npu_preflight_report.json",
        output_dir / f"{track_stem}_ai_implementation_draft.json",
        tools_dir / "generated_blender_script_candidate.py",
        tools_dir / "generated_implementation_notes.md",
        tools_dir / "npu_dual_ai_implementation_notes.md",
    ]
...
def build_manifest(
    *,
    ...
    from Tools.npu.pipeline.artifact_paths import (  # noqa: PLC0415
        is_allowed_legacy_runtime_output_path,
        repo_relative_path,
    )
    from Tools.npu.pipeline.reports import (  # noqa: PLC0415
