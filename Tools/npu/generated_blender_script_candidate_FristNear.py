...
ANALYSIS_JSON = Path('C:\\Users\\carmi\\blender\\blender-audio-project\\output\\Ready To Jazz-Luca Vera_Master_analysis.json')
MUSIC_CONTEXT_JSON = Path('C:\\Users\\carmi\\blender\\blender-audio-project\\output\\Ready To Jazz-Luca Vera_Master_music_context.json')
AI_CONTEXT_JSON = Path('C:\\Users\\carmi\\blender\\blender-audio-project\\output\\Ready To Jazz-Luca Vera_Master_analysis_ai_context.json')
BLENDER_KEYFRAMES_JSON = Path('C:\\Users\\carmi\\blender\\blender-audio-project\\output\\Ready To Jazz-Luca Vera_Master_analysis_blender_keyframes.json')
