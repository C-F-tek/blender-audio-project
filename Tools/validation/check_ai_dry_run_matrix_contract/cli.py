...
try:
    from Tools.validation._shared.ai_pipeline_report_contracts import validate_ai_pipeline_report_file
except ImportError:  # Allows package-style imports during external checks.
    from Tools.validation._shared.ai_pipeline_report_contracts import (
