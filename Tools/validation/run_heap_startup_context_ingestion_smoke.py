...
SOURCE_FILES = {
    "launcher": "Tools/ai/run_heap_runtime_context_closure.py",
    "gate": "Tools/ai/run_heap_runtime_completeness_gate.py",
    "preload": "Tools/ai/prepare_heap_context_memory_reload.py",
    "reconciler": "Tools/ai/reconcile_heap_report_with_startup_reload.py",
    "composer": "Tools/ai/compose_heap_final_proposals.py",
}
