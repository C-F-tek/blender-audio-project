...
def build_no_worktree_diff_alias_product(work_dir: Path) -> Path:
    code_product = work_dir / "NO_WORKTREE_DIFF_ALIAS_CODE_PRODUCT_FULL_PATCH.md"
    write_text(
        code_product,
        """# CODE_PRODUCT_FULL_PATCH
...
- Git status: `clean`
- Implementation status: `already_integrated_no_worktree_diff`
- Diff hunks: `0`
...
def run_smoke(args: argparse.Namespace) -> dict[str, Any]:
    ...
    no_worktree_alias_code_product = build_no_worktree_diff_alias_product(work_dir)
    ...
    no_worktree_alias_report = work_dir / "no_worktree_alias.json"
    apply_run = run(
        [
            sys.executable,
            "-m",
    ...
    no_worktree_alias_run = run(
        [
            ...
            str(fixture),
            "--code-product",
            str(no_worktree_alias_code_product),
            "--output",
            str(no_worktree_alias_report),
            "--require-all-integrated",
        ],
        cwd=repo_root,
        timeout=max(60, int(args.timeout_seconds)),
    ...
    no_worktree_alias_data = json.loads(
        no_worktree_alias_report.read_text(encoding="utf-8-sig")
    )
    passed = (
        ...
        and no_worktree_alias_data.get("all_integrated") is True
        and no_worktree_alias_data.get("status_counts", {}).get(
    ...
    report = {
        ...
        "no_worktree_alias_code_product": str(no_worktree_alias_code_product),
        ...
        "no_worktree_alias_report": str(no_worktree_alias_report),
        "apply_run": apply_run,
        "verify_run": verify_run,
        "empty_run": empty_run,
        "empty_apply_run": empty_apply_run,
        "no_worktree_run": no_worktree_run,
        "no_worktree_alias_run": no_worktree_alias_run,
