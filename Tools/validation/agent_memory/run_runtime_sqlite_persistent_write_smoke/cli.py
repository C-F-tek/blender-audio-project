...
def main() -> int:
    ...
    parser.add_argument(
        "--output", default="output/validation/runtime_sqlite_persistent_write_smoke.json"
    )
    parser.add_argument(
        "--markdown-output", default="output/validation/runtime_sqlite_persistent_write_smoke.md"
    )
    ...
    smoke = {
        ...
        "persistent_memory_write_performed": bool(
            report_data.get("persistent_memory_write_performed")
        ),
        "persistent_memory_write_authorized": bool(
            report_data.get("guardrails", {}).get("persistent_memory_write_authorized")
        ),
