...
- Guard core/runtime coherence across dispatchers, context coverage and
  full/complete wording claims.
...
python -m Tools.validation run_runtime_heap_sqlite_sidecar_smoke ...
...
python -m Tools.validation check_ia_carmine_tools_boundary ...
python -m Tools.validation check_dispatcher_targets ...
python -m Tools.validation check_dispatcher_context_coverage ...
python -m Tools.validation check_full_complete_wording_contract ...
```
...
runtime heap SQLite sidecar smoke report
