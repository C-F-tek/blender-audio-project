...
def build_fixture(repo_root: Path, work_dir: Path) -> tuple[Path, Path]:
    ...
    write_json(
        virtual_dev_path,
        {
            ...
            "targets": [
                {
                    "target_file": "Tools/ai/assemble_heap_final_readable_product/cli.py",
                    "ast_ok": True,
                    "import_ok": True,
                    "help_ok": True,
                },
            ...
            "concrete_code_proposals": [
                {
                    ...
                    "code_or_patch_sketch": "diff --git a/Tools/ai/assemble_heap_final_readable_product/cli.py b/Tools/ai/assemble_heap_final_readable_product/cli.py\n@@\n+def build_report(...):\n+    pass\n",
                    "validation_commands": [
                        "python -m py_compile Tools/ai/assemble_heap_final_readable_product/cli.py",
