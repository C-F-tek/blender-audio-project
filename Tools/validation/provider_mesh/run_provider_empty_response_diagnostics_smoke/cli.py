...
try:
    from Tools.ai.provider_mesh.npu_gpu_deep_review_auditor import classify_npu_output
except ImportError:
    import sys
    ...
    from Tools.ai.provider_mesh.npu_gpu_deep_review_auditor import classify_npu_output  # type: ignore
