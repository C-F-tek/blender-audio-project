...
try:
    from Tools.validation._shared.generated_file_policy import PolicyRule
    from Tools.validation._shared.generated_python_policy import (
    ...
    from Tools.validation._shared.generated_file_policy import PolicyRule  # type: ignore
    from Tools.validation._shared.generated_python_policy import (  # type: ignore
        evaluate_python_paths,
        evaluate_python_text,
        generated_python_rule_dicts,
    )
