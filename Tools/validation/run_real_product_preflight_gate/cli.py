...
def main() -> int:
    ...
    steps_config = [
        ("real_product_profile", "Tools/validation/run_real_product_profile_smoke/cli.py"),
        ("core_runtime_guard_suite", "Tools/validation/run_core_runtime_guard_suite/cli.py"),
        (
            "real_product_single_entry_exit",
            "Tools/validation/run_real_product_single_entry_exit_smoke/cli.py",
        ),
        (
            "intrinsic_capability_contract",
            "Tools/validation/run_real_product_intrinsic_capability_contract_smoke/cli.py",
        ),
        (
            "runtime_mesh_contract",
            "Tools/validation/run_real_product_runtime_mesh_contract_smoke/cli.py",
        ),
        ("openvino_peer_topology", "Tools/validation/run_openvino_peer_topology_contract_smoke/cli.py"),
        ("review_pr_prepare_args", "Tools/validation/run_review_pr_prepare_args_smoke/cli.py"),
        (
            "review_pr_product_readiness",
            "Tools/validation/run_review_pr_product_readiness_smoke/cli.py",
        ),
        (
            "heap_provider_budget_governor",
            "Tools/validation/run_heap_provider_budget_governor_smoke/cli.py",
        ),
        (
            "heap_provider_invocation_contract",
            "Tools/validation/run_heap_provider_invocation_contract_smoke/cli.py",
        ),
        (
            "heap_runtime_completeness_gate",
            "Tools/validation/run_heap_runtime_completeness_gate_smoke/cli.py",
        ),
        (
        ...
        (
            ...
            "Tools/validation/run_runtime_evidence_correlation_launcher_wiring_smoke/cli.py",
        ),
        (
            "manifest_runtime_evidence_correlation_schema",
            "Tools/validation/run_unified_manifest_runtime_evidence_correlation_smoke/cli.py",
        ),
        (
            "review_pr_final_product_contract",
            "Tools/validation/run_review_pr_final_product_contract_smoke/cli.py",
        ),
    ]
