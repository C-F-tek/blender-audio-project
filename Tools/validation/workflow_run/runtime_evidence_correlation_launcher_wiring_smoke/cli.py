...
def main() -> int:
    ...
    heap_runtime_completeness_gate_smoke = read_text(
        repo_root / "Tools/validation/heap_runtime/completeness_gate_smoke/cli.py"
    )
    ...
    checks: dict[str, bool] = {
        ...
        in preflight,
        "preflight_routes_to_heap_runtime_completeness_gate": "run_heap_runtime_completeness_gate_smoke"
        in preflight,
