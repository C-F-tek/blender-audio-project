...
def main() -> int:
    ...
    require("SOURCE_PATH_ALLOWLIST_CONTRACT" in gate, "GPU1 prompt must include hard source allowlist contract", errors)
    ...
    require("Do not invent files such as Tools/data_processor/real_existing_file.py" in gate, "GPU1 prompt must explicitly forbid observed invented fixture path", errors)
