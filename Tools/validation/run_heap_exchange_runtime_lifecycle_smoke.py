...
def main() -> int:
    ...
    entry_tool = source_repo / "Tools/ai/build_heap_exchange_runtime_entry.py"
    exit_tool = source_repo / "Tools/ai/build_heap_exchange_runtime_exit.py"
    lifecycle_tool = source_repo / "Tools/validation/check_heap_exchange_runtime_lifecycle.py"
