...
def build_report(repo_root: Path) -> dict[str, Any]:
    ...
    files = {
        ...
        for rel in (
            ...
            "Tools/ai/runtime_file_refs/allowlist.py",
    ...
    allowlist = files["Tools/ai/runtime_file_refs/allowlist.py"]
    ...
    core_suite = files["Tools/validation/run_core_runtime_guard_suite/cli.py"]
    check_absent(
        core_suite,
        "CORE_STEPS",
        "Tools/validation/run_core_runtime_guard_suite/cli.py",
