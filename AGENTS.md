...
- If GPU1 requests a native broker tool, GPU1 must resume and cite the resulting `tool_result` in `CONSUMED_EVIDENCE` before GPU0/NPU may review the packet; written-but-unconsumed tool results remain pending evidence.
