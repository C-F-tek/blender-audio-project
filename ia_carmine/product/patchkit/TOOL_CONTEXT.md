# ia_carmine/product/patchkit context

## Role

`ia_carmine/product/patchkit` contains controlled PatchKit helpers used when a reviewed patch bundle/spec needs a deterministic application path.
...
```powershell
python -m ia_carmine.cli apply_patch_bundle --repo-root . --bundle .\patch_specs\<bundle>\bundle.json --dry-run
python -m ia_carmine.cli apply_patch_bundle --repo-root . --bundle .\patch_specs\<bundle>\bundle.json
```
