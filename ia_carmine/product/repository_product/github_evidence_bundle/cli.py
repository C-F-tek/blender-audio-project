...
from ia_carmine._shared.github_evidence_bundle_decisions import build_decision
...
from ia_carmine._shared.github_evidence_bundle_markdown import render_markdown
from ia_carmine._shared.github_evidence_bundle_reports import (
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="Bounded recursive root for stamped JSON reports. Repeatable or comma-separated.",
    )
    parser.add_argument(
        "--recursive-artifact-root",
        action="append",
        default=[],
        help="Bounded recursive root for stamped JSON/Markdown artifacts. Repeatable or comma-separated.",
    )
    parser.add_argument(
        "--recursive-stamp",
        default=None,
        help="Only include recursive files whose path contains this stamp unless --recursive-include-unstamped is set.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Add pointer-linked chunk metadata for JSON/Markdown artifacts above this line count. Set 0 to disable.",
    )
    parser.add_argument(
