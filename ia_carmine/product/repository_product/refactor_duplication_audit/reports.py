...
def verify_layering(repo_root: Path) -> dict[str, Any]:
    files = {
        "builder": repo_root / "ia_carmine/context/agent_context/shared_toolbox_bundle/cli.py",
    ...
    checks = {
        ...
        and "ia_carmine.product.repository_product.github_evidence_bundle" in content["builder"],
