...
HELPER_RULES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "existing_helper_available": True,
        "preferred_existing_helper_or_module": "Reuse ia_carmine._shared.github_evidence_bundle_io.split_path_values/compact_value when the semantics match.",
        "recommendation_type": "reuse_existing_helper",
        "risk": "medium",
    ...
    },
    {
        ...
        "existing_helper_available": True,
        "preferred_existing_helper_or_module": "ia_carmine._shared.github_evidence_bundle_artifacts.",
        "recommendation_type": "reuse_existing_helper",
        "risk": "medium",
