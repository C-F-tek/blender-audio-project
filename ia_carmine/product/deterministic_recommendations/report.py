...
def build_recommendation_report(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "next_best_action": (
            "python -m ia_carmine.cli agent_review_patch_plan" if recommendations else "collect_more_evidence"
        ),
...
def build_patch_plan_bridge_orchestrator(
    *,
    ...
    return {
        ...
        "gpu_recommended_next_layer": "python -m ia_carmine.cli agent_review_patch_plan",
