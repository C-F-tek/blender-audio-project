...
from ia_carmine.product.code_product.interpreter_report.constants import (
    DEFAULT_EXCLUDED_DIRS,
    DEFAULT_MARKDOWN,
    DEFAULT_OUTPUT,
)
from ia_carmine.product.code_product.interpreter_report.render import render_markdown
from ia_carmine.product.code_product.interpreter_report.scanner import resolve_roots, split_csv_values
from ia_carmine._shared.code_patch_plan_common import write_json_and_markdown
