...
from ia_carmine._shared.code_patch_plan_common import compact_text, repo_rel
from ia_carmine._shared.github_evidence_bundle_io import line_count, read_text
