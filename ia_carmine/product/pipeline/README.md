...
`ia_carmine/product/pipeline/` contains the modular implementation behind the AI artifact pipeline entrypoint:

```text
python -m ia_carmine.cli run_parallel_artifact_pipeline
```
