...
try:
    from ia_carmine._shared.heap_proposal_gate import record_operator_decision
except ImportError:  # pragma: no cover
    from ia_carmine._shared.heap_proposal_gate import record_operator_decision  # type: ignore
