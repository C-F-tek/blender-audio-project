# ia_carmine/product/heap_final_proposals context

## Role

`ia_carmine/product/heap_final_proposals` contains helpers for final heap proposal artifacts and final-causality normalization.
