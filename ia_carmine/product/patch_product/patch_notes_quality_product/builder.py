...
from ia_carmine.product.patch_product.patch_notes_quality_product.scoring import (
    build_patch_notes,
...
from ia_carmine.product.patch_product.patch_notes_quality_product.task_md import (
    build_request_summary,
    load_task_markdown,
)
from ia_carmine.product.patch_product.patch_notes_quality_product.evidence_quality import (
    build_evidence_coverage,
    build_fallback_cases,
    build_success_cases,
)
from ia_carmine.product.patch_product.patch_plan_quality_product.io_utils import (
    flatten_json,
    now_iso,
    read_json,
    repo_rel,
...
from ia_carmine.product.patch_product.patch_plan_quality_product.token_search import (
    build_search_index,
    safe_tokens,
    search_docs,
)
...
def build_report(args: Any) -> dict[str, Any]:
    ...
    validation_commands = patch_summary.get("validation_commands") or [
        "python -m py_compile tools/ai/patch_product/patch_notes_quality_product/cli.py",
