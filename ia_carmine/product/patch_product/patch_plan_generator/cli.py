...
LANE_FILES = {
    "gpu0": ["ia_carmine/providers/provider_mesh/runtime/gpu0_peer.py"],
    "npu": ["ia_carmine/providers/provider_mesh/runtime/npu_micro.py"],
    "gpu1": ["ia_carmine/providers/provider_mesh/gpu_deep_planning_supervised/cli.py"],
    "orchestrator": ["ia_carmine/providers/provider_mesh/gpu_npu_parallel_orchestrator/cli.py"],
}
COMMON_FILES = [
...
def build_patch_plan(snapshot: dict[str, Any]) -> dict[str, Any]:
    ...
    if action == "repair_degraded_lane":
        ...
        command = ["python", "-m", "ia_carmine.cli", "provider_runtime_blackboard", "--help"]
