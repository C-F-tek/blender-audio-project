...
`ia_carmine/context/agent_context` prepares the input universe consumed by heap runtime, brokered tools and provider lanes. It is responsible for context packs, tool inventory, transient request context, semantic evidence chunks and selected code chunks.
