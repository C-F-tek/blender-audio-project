...
def build_steps(profile: str, complexity: dict[str, Any], basename: str) -> list[dict[str, Any]]:
    ...
    steps: list[dict[str, Any]] = [
        ...
        make_step(
            ...
            "python -m ia_carmine.cli build_agent_state_packet",
    ...
    steps.extend(
        [
            ...
            make_step(
                ...
                "python -m Tools.validation check_npu_knowledge_broker_packet",
                (
            ...
            make_step(
                ...
                "python -m ia_carmine.cli build_full_context_golden_proposals",
                "after_validations",
