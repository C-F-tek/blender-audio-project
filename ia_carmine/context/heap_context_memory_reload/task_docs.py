...
def build_context_loaded_block(artifacts: dict[str, str]) -> list[str]:
    key_labels = (
        ...
        ("startup_context_pack_json", "active unified context pack"),
        ("startup_context_pack_markdown", "active unified context pack markdown"),
...
def build_task_markdown(
    *,
    ...
    lines: list[str] = [
        ...
        "- Static AI context-pack failures are advisory; RAG and unified startup context packs are blocking context requirements.",
        "",
