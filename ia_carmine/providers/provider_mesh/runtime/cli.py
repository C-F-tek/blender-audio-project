...
from ia_carmine.providers.provider_mesh.runtime import command_env, resolve_child_python


MODULES = (
    "ia_carmine.providers.provider_mesh.runtime.python_runtime",
    "ia_carmine.providers.provider_mesh.runtime.runtime_heap",
    "ia_carmine.providers.provider_mesh.runtime.gpu0_peer",
    "ia_carmine.providers.provider_mesh.runtime.npu_micro",
)
