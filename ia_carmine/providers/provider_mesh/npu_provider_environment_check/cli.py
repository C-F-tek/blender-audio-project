...
try:
    from ia_carmine.providers.npu.provider_mesh._shared.npu_runtime import DEFAULT_NPU_PYTHON
except ImportError:
...
try:
    ...
    result["openvino_version"] = getattr(ov, "__version__", version("openvino"))
...
try:
    ...
    result["openvino_genai_version"] = version("openvino-genai")
except Exception as exc:
...
"""
    ...
    return {
        ...
        "checks": {
            ...
            "openvino_package_version": parsed.get("openvino_version", ""),
            "openvino_genai_import": genai_ok,
            "openvino_genai_pip_package": "openvino-genai",
            "openvino_genai_package_version": parsed.get("openvino_genai_version", ""),
