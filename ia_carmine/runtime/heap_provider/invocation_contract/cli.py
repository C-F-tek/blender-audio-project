...
def build_lane_activation_contract(
    ...
    activation_contract = {
        ...
        "execution_owner": "ia_carmine.runtime.heap_gate.provider_execution.run_provider_teamwork",
        "command_spec_source": "ia_carmine/runtime/heap_gate/provider_command_specs.py",
...
def build_heap_provider_invocation_contract(
    ...
    *,
    ...
    contract = {
        ...
        "passed": bool(gate.get("passed")),
        "provider_runtime_owner": "ia_carmine.runtime.heap_gate.provider_execution.run_provider_teamwork",
        "provider_lane": PRIMARY_PROVIDER_LANE,
