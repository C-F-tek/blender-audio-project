# ia_carmine/runtime/heap_provider context

## Role

`ia_carmine/runtime/heap_provider` contains provider-side heap execution helpers such as budget governance and invocation contracts.
