# ia_carmine/runtime/runtime_universe context

## Role

`ia_carmine/runtime/runtime_universe` contains higher-level runtime universe builders, flow maps, execution plans, smart gatekeeping and unified run feed builders.
...
```powershell
python -m ia_carmine.cli runtime_flow_map ...
python -m ia_carmine.cli selective_execution_plan ...
python -m ia_carmine.cli smart_ai_gatekeeper ...
