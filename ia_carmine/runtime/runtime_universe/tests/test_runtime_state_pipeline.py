...
from ia_carmine.runtime.heap_runtime.event_pointers import source_pointer_bundle
from ia_carmine._shared.heap_source_anchors import (
...
from ia_carmine.runtime.provider_runtime_blackboard import ProviderRuntimeHeap, record_lane_diagnostic
from ia_carmine.providers.provider_mesh.gpu_npu_parallel_orchestrator import runtime_state_gate
from ia_carmine.runtime.heap_gate.runtime_common import runtime_state_lane_gate
...
class HeapProductContractHelperTests(unittest.TestCase):
    def test_source_anchor_prefers_operator_existing_files(self) -> None:
        repo_root = Path(__file__).resolve().parents[4]
        request = (
            "Use ia_carmine/runtime/provider_runtime_blackboard/cli.py and "
            "ia_carmine/product/deterministic_recommendations/evidence_to_recommendation/cli.py. "
        ...
        self.assertEqual(candidates[0], "ia_carmine/runtime/provider_runtime_blackboard/cli.py")
        self.assertIn("ia_carmine/product/deterministic_recommendations/evidence_to_recommendation/cli.py", candidates)
