# ia_carmine/runtime/heap_exchange context

## Role

`ia_carmine/runtime/heap_exchange` owns heap/exchange lifecycle support artifacts: runtime entry, runtime exit, peer runtime manifests, task ingress contracts, closure audits and lifecycle wiring support.
...
- Inspect `ia_carmine/dispatch.py` before assuming a package is public CLI surface.
