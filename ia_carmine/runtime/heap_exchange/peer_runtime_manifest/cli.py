...
PEER_CONTRACT = [
    ...
    {
        "id": "gpu0",
        "role": "companion Ollama Vulkan reviewer/refiner",
        "dynamic_peer": True,
        "required_for_provider_exchange": True,
        "description": "Companion Ollama/Vulkan peer review and refinement lane.",
    },
    {
        "id": "npu",
...
def main() -> int:
    ...
    report = {
        ...
        "gpu0_role": "companion Ollama Vulkan reviewer/refiner",
    ...
    append_jsonl(
        runtime_state_path,
        {
            ...
            "gpu0": "companion Ollama Vulkan reviewer/refiner",
