# ia_carmine/runtime/provider_runtime_blackboard context

## Role

`ia_carmine/runtime/provider_runtime_blackboard` owns the materialized runtime blackboard used to observe provider lanes, broker requests, peer reports, live signals and validation bridge state.
...
python -m ia_carmine.cli run_provider_runtime_heap_gpu_peer_smoke ...
```
