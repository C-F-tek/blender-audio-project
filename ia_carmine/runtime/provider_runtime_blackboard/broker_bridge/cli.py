    ...
    for result in broker_report.get("tool_results", []):
        ...
        event = heap.append_event(
            ...
            payload={
                ...
                "revision": request_payload.get("revision"),
                "gpu1_tool_loop_subturn": request_payload.get("gpu1_tool_loop_subturn"),
                "tool_call_id": request_payload.get("tool_call_id"),
                "tool_call_index": request_payload.get("tool_call_index"),
                "chat_history_ref": request_payload.get("chat_history_ref"),
