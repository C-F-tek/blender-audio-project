...
choose `finalize_product` or `needs_refine`. Runtime/gate logic, not GPU1,
classifies `blocked_continuation_product` or `blocked_with_reason`. GPU0 must answer `agree_close`, `veto_with_reason` or
