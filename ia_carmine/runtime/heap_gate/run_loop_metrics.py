...
from ia_carmine.runtime.heap_gate.run_loop_metric_helpers import (
    _consumed_peer_block_ids,
    _device_identity_map,
    _lane_has_model_execution,
    _lane_workload_metrics,
    _latest_one_turn_summary,
    _native_tool_loop_required,
    _one_turn_metrics,
    _pending_provider_sidecar_count,
)
...
def build_provider_lane_metrics(
    ...
    one_turn_metrics = _one_turn_metrics(
        _latest_one_turn_summary(owner, latest_gpu1_report, latest_proposal)
    )
