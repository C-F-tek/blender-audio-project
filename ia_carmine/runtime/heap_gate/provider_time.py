    ...
    return {
        ...
        NPU_LANE: {
            **contract,
            ...
            "watchdog_semantics": "hard_micro_watchdog_from_npu_micro_timeout_seconds",
            "lane_watchdog_seconds": npu_budget,
            "timeout_seconds": npu_budget,
            "native_tool_timeout_seconds": npu_tool_timeout,
            "sidecar_join_after_primary_seconds": min(10, npu_budget),
            ...
            "native_tool_calling_policy": "npu_may_call_native_tools_only_for_micro_audit",
