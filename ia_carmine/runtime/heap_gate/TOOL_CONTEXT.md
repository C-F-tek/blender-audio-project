...
- Sidecar incoherence is recoverable evidence. The runtime records `sidecar_incongruent` / `sidecar_invalid`, preserves block id/lane/target pointer, and schedules GPU1 congruence/recovery when revision budget remains.
