...
def build_provider_teamwork_leader_packet(
    ...
    packet = {
        ...
        "native_tool_calling_policy": {
            "gpu1_planner": "open_revision_drive_broker_tools_and_own_final_product_delta",
        ...
        "integrated_surface_map": {
            ...
            "product_boundary": "single FINAL_PRODUCT packaged through PLAN_PRODUCT_FULL_PATCH.md and CODE_PRODUCT_FULL_PATCH.md surfaces",
        },
        ...
        "same_heap_teamwork_contract": [
            ...
            "GPU1 produces causal FINAL_PRODUCT_DELTA turns and integrates GPU0/NPU vetoes and refinement signals in later deltas.",
            "GPU1 is the primary Ollama broker-driving lane and owns the final-product delta stream, not a separate post-run synthesis.",
            ...
            "GPU1 must consume GPU0/NPU peer evidence before that evidence can affect the composed FINAL_PRODUCT.",
        ...
        "pointer_contract": {
            ...
            "gpu1_authority": "leader may backtrack/propagate/resume and emit a causal FINAL_PRODUCT_DELTA",
        ...
        "final_product_delta_contract": {
            "final_product_is_single": True,
            "plan_product_surface": "PLAN_PRODUCT_FULL_PATCH.md",
            "code_product_surface": "CODE_PRODUCT_FULL_PATCH.md",
            "gpu1_required_fields": [
                "FINAL_PRODUCT_KIND",
