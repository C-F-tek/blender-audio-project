...
try:
    from ia_carmine._shared.heap_code_execution_tool_core import (
    ...
    from ia_carmine.product.patch_product.candidate_synthesis import (
    ...
    from ia_carmine._shared.heap_code_execution_tool_core import (  # type: ignore
        build_debug_lab_request,
        default_debug_lab_paths,
        git_diff_excerpt,
        matrix_target_items,
    ...
    from ia_carmine.product.patch_product.candidate_synthesis import (  # type: ignore
        build_report as build_patch_candidate_report,
        render_markdown as render_patch_candidate_markdown,
    )
