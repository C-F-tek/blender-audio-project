            ...
            tasks.append(
                {
                    ...
                    "can_add_pointer_information": True,
                    ...
                    "return_to_main_block_id": block.get("resume_from_block_id")
                    or block.get("block_id")
                    or "",
                    "restart_on_rejected_partial": True,
                    "rejected_partial_evidence_policy": (
                        "Attach rejected/partial answer evidence and request GPU1 to change "
                        "response typology before continuing."
                    ),
