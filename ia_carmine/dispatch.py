...
TOOL_MAIN_TARGETS: dict[str, str] = {
    ...
    "ollama_tool_gateway": "ia_carmine.providers.provider_mesh.ollama_tool_gateway.cli:main",
    ...
    "gpu_deep_planning_review": "ia_carmine.providers.provider_mesh.gpu_deep_planning_review.cli:main",
    "gpu_deep_planning_supervised": "ia_carmine.providers.provider_mesh.gpu_deep_planning_supervised.cli:main",
    "gpu_npu_parallel_orchestrator": "ia_carmine.providers.provider_mesh.gpu_npu_parallel_orchestrator.cli:main",
    ...
    "build_openvino_gpu0_workload_report": "ia_carmine.providers.provider_mesh.openvino_gpu0_workload_report.cli:main",
