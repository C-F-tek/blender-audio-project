...
try:
    ...
    from ia_carmine._shared.runtime_tool_guidance import ALLOWED_RUNTIME_TOOLS
    ...
    from ia_carmine._shared.runtime_tool_guidance import ALLOWED_RUNTIME_TOOLS  # type: ignore

try:
    from ia_carmine._shared.gpu_planner_json_contract_report import json_dumps_report, result_to_dict
...
# ALLOWED_RUNTIME_TOOLS is imported from ia_carmine._shared.runtime_tool_guidance so GPU,
