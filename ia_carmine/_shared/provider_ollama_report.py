...
def build_ollama_probe_report(ctx: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        **ctx["work_status"],
        ...
        "model_switch_allowed": bool(selection.get("model_switch_allowed")),
        "model_switch_performed": bool(selection.get("model_switch_performed")),
        "model_selection_policy": selection.get("model_selection_policy"),
        "provider_model_selection_mismatch": bool(
            selection.get("provider_model_selection_mismatch")
        ),
        ...
        **response_text_fields,
        ...
        "available_tool_names": list(ctx.get("actual_chat_tool_names") or []),
        "actual_chat_tool_names": list(ctx.get("actual_chat_tool_names") or []),
        "actual_chat_tool_schema_count": int(ctx.get("actual_chat_tool_schema_count") or 0),
        "hidden_tool_names": list(ctx.get("hidden_tool_names") or []),
        "hidden_tool_reasons": ctx.get("hidden_tool_reasons") or {},
