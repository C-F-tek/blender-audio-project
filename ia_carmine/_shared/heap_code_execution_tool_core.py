...
try:
    ...
    from ia_carmine.providers.provider_mesh.runtime.python_runtime import command_env  # type: ignore
...
def build_debug_lab_request(
    ...
    return {
        ...
        "generated_by": "python -m ia_carmine.cli run_heap_code_execution_tool",
