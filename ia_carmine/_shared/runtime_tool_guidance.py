...
TOOL_REQUEST_DECISION_GUIDE: dict[str, Any] = {
    ...
    "preferred_tool_mapping": {
        ...
        "need concrete repo text search": "repo_search_rg",
        "need tracked repo text search": "repo_search_git_grep",
        "need concrete repo file discovery": "repo_find_fd",
        "need JSON artifact query": "repo_json_query_jq",
        "need read-only PowerShell Get-ChildItem or Select-String": "repo_powershell_readonly",
        "need dotnet/msbuild/ninja/code availability": "repo_toolchain_probe",
        "need allowlisted toolchain command": "repo_toolchain_command",
