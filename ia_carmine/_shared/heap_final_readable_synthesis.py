    ...
    if has_applicable_code_product:
        ...
        lines.extend(
            [
                ...
                "- Nessun diff/code effettivo verificato dalla matrix: la superficie code del FINAL_PRODUCT non e' applicabile.",
                "- `PLAN_PRODUCT_FULL_PATCH.md` e' la superficie testo/prose del FINAL_PRODUCT unico quando esistono delta GPU1 validi.",
                "- `CODE_PRODUCT_FULL_PATCH.md` e' la superficie code/diff dello stesso FINAL_PRODUCT e dichiara NO_APPLICABLE_CODE_PRODUCT se non contiene diff verificati.",
